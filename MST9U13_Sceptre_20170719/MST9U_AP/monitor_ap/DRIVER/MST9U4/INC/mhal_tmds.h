...
#define TMDS_USE_SW_AUTO_EQ_14      0
...
typedef enum
{
    TMDS_HDCP_NO_ENCRYPTION = 0,
    TMDS_HDCP_1_4 = 1,
    TMDS_HDCP_2_2 = 2,
}TMDS_HDCP_STATE;

enum TMDS_SW_AUTO_EQ_STATE_TYPE
{
    TMDS_SW_AUTO_EQ_NONE = 0,
    TMDS_SW_AUTO_EQ_START,
    TMDS_SW_AUTO_EQ_WAIT_DONE,
    TMDS_SW_AUTO_EQ_WAIT_SIGNAL_STABLE,
    TMDS_SW_AUTO_EQ_CLEAR_ERROR_STATUS,
    TMDS_SW_AUTO_EQ_CHECK_ERROR,
    TMDS_SW_AUTO_EQ_CHANGE_SETTING,
    TMDS_SW_AUTO_EQ_FINISH,
};

enum TMDS_SW_AUTO_EQ_VALUE_TYPE
{
    TMDS_SW_AUTO_EQ_VALUE0 = 0,
    TMDS_SW_AUTO_EQ_VALUE1,
    TMDS_SW_AUTO_EQ_VALUE_MASK,
    TMDS_SW_AUTO_EQ_VALUE2,
    TMDS_SW_AUTO_EQ_VALUE3,
};
...
#define TMDS_SW_AUTO_EQ_VALUE       0x3
#define HDMI_DECORD_ERROR_THRESHOLD     0x8006
#define HDMI_SW_AUTO_WAIT_STABLE_TIME   5
#define HDMI_SW_AUTO_CHECK_ERROR_TIME   5
#define HDMI_SW_AUTO_RETRY_CHECK_ERROR  200
