...
typedef enum
{
    E_I2SRx_BITWIDTH_16                     = 0,
    E_I2SRx_BITWIDTH_24                     = 1,
    E_I2SRx_BITWIDTH_32                     = 2,
    E_I2SRx_BITWIDTH_REVERSE                  = 3,
} I2SRx_BITWIDTH_SEL;

typedef enum
{
    E_I2STx_BITWIDTH_16                     = 0,
    E_I2STx_BITWIDTH_24                     = 1,
    E_I2STx_BITWIDTH_32                     = 2,
    E_I2STx_BITWIDTH_REVERSE                  = 3,
} I2STx_BITWIDTH_SEL;

typedef enum
{
    E_I2STx_MCLK_128FS                     = 0,
    E_I2STx_MCLK_256FS                     = 1,
    E_I2STx_MCLK_192FS                     = 2,
    E_I2STx_MCLK_384FS                     = 3,
    E_I2STx_MCLK_REVERSE                   = 4,
...
{
    AUDIO_SOURCE_HDMI               = 0,
    AUDIO_SOURCE_EMPTY              = 1,
    AUDIO_SOURCE_I2S                = 2,
    AUDIO_SOURCE_SPDIF              = 3,
    AUDIO_SOURCE_DP                 = 4,
    AUDIO_SOURCE_NONE               = 5,
} AUDIO_SOURCE_SEL;
...
typedef enum
{
    I2SRx_PCM_2CH_TO_2CH_I2STx      = 0,
    I2SRx_PCM_2CH_TO_2CH_HDMITx     = 1,
    I2SRx_PCM_2CH_TO_2CH_SPDIFTx    = 2,
    SPDIFRx_PCM_2CH_TO_2CH_I2STx    = 3,
    SPDIFRx_PCM_2CH_TO_2CH_HDMITx   = 4,
    SPDIFRx_PCM_2CH_TO_2CH_SPDIFTx  = 5,
    SPDIFRx_NPCM_2CH_TO_2CH_HDMITx  = 6,
    SPDIFRx_NPCM_2CH_TO_2CH_SPDIFTx = 7,
    HDMIRx_PCM_2CH_TO_2CH_I2STx     = 8,
    HDMIRx_PCM_2CH_TO_2CH_HDMITx    = 9,
    HDMIRx_PCM_2CH_TO_2CH_SPDIFTx   = 10,
    HDMIRx_PCM_8CH_TO_2CH_I2STx     = 11,
    HDMIRx_PCM_8CH_TO_2CH_HDMITx    = 12,
    HDMIRx_PCM_8CH_TO_2CH_SPDIFTx   = 13,
    HDMIRx_PCM_8CH_TO_8CH_I2STx     = 14,
    HDMIRx_PCM_8CH_TO_8CH_HDMITx    = 15,
    HDMIRx_NPCM_2CH_TO_2CH_HDMITx   = 16,
    HDMIRx_NPCM_2CH_TO_2CH_SPDIFTx  = 17,
    HDMIRx_NPCM_8CH_TO_8CH_HDMITx   = 18, //HDMI Rx to HDMI Tx repeater mode path
    APPLICATION_PATH_SEL_RESERVED   = 19
} APPLICATION_PATH_SEL;
...
#if ENABLE_SPDIF
extern void msDrvAudioDPGA2CHSetVolume( AUDIO_CH_SEL eChSelect, signed short iVolume_Integer, AUDIO_VOLUME_FRACTION_PART Volume_Fraction );
#endif
