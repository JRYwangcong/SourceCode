...
#define COMBO_USE_INTERNAL_EDID_PORT0   1   // Use internal EDID 256
#define COMBO_USE_INTERNAL_EDID_PORT1   1   // Use internal EDID 256
#define COMBO_USE_INTERNAL_EDID_PORT2   1   // Use internal EDID 256
#define COMBO_USE_INTERNAL_EDID_PORT3   1   // Use internal EDID 256
#define COMBO_USE_INTERNAL_EDID_PORT4   1   // Use internal EDID 256
#define COMBO_USE_INTERNAL_EDID_PORT5   1   // Use internal EDID 256

#define COMBO_USE_DISPLAY_ID_PORT0      0   // Use internal EDID 384
#define COMBO_USE_DISPLAY_ID_PORT1      0   // Use internal EDID 384
#define COMBO_USE_DISPLAY_ID_PORT2      0   // Use internal EDID 384
#define COMBO_USE_DISPLAY_ID_PORT3      0   // Use internal EDID 384
#define COMBO_USE_DISPLAY_ID_PORT4      0   // Use internal EDID 384
#define COMBO_USE_DISPLAY_ID_PORT5      0   // Use internal EDID 384

#define COMBO_USE_EDID512_PORT0         0   // Use internal EDID 512
#define COMBO_USE_EDID512_PORT1         0   // Use internal EDID 512
#define COMBO_USE_EDID512_PORT2         0   // Use internal EDID 512
#define COMBO_USE_EDID512_PORT3         0   // Use internal EDID 512
#define COMBO_USE_EDID512_PORT4         0   // Use internal EDID 512
#define COMBO_USE_EDID512_PORT5         0   // Use internal EDID 512
...
#if(COMBO_USE_EDID512_PORT0)
#define COMBO_EDID_SIZE_PORT0           4
#elif(COMBO_USE_DISPLAY_ID_PORT0)
...
#if(COMBO_USE_EDID512_PORT1)
#define COMBO_EDID_SIZE_PORT1           4
#elif(COMBO_USE_DISPLAY_ID_PORT1)
...
#if(COMBO_USE_EDID512_PORT2)
#define COMBO_EDID_SIZE_PORT2           4
#elif(COMBO_USE_DISPLAY_ID_PORT2)
...
#if(COMBO_USE_EDID512_PORT3)
#define COMBO_EDID_SIZE_PORT3           4
#elif(COMBO_USE_DISPLAY_ID_PORT3)
...
#if(COMBO_USE_EDID512_PORT4)
#define COMBO_EDID_SIZE_PORT4           4
#elif(COMBO_USE_DISPLAY_ID_PORT4)
...
#if(COMBO_USE_EDID512_PORT5)
#define COMBO_EDID_SIZE_PORT5           4
#elif(COMBO_USE_DISPLAY_ID_PORT5)
...
#define COMBO_EDID_SIZE_128             128
#define COMBO_EDID_SIZE_256             256
#define COMBO_EDID_SIZE_384             384
#define COMBO_EDID_SIZE_512             512

//-------------------------------------------------------------------------------------------------
//  Combo EDID table
//-------------------------------------------------------------------------------------------------
BYTE tEDID_TABLE_COMBO_VGA[COMBO_EDID_SIZE_128] =
{
...
#if(COMBO_IP_SUPPORT_TYPE >= COMBO_IP_SUPPORT_1PORT)
#if(COMBO_USE_EDID512_PORT0)
BYTE tEDID_TABLE_COMBO_PORT0[COMBO_EDID_SIZE_512] =
{
    ...
    0x00, 0x53, 0x4F, 0x4E, 0x59, 0x20, 0x54, 0x56, 0x0A, 0x20, 0x20, 0x20, 0x20, 0x20, 0x03, 0x33,
...
#elif(COMBO_USE_DISPLAY_ID_PORT0)
BYTE tEDID_TABLE_COMBO_PORT0[COMBO_EDID_SIZE_384] =
{
    //Sony 4K2K
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x4D, 0xD9, 0x01, 0xFD, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x14, 0x01, 0x03, 0x80, 0x90, 0x51, 0x78, 0x0A, 0x0D, 0xC9, 0xA0, 0x57, 0x47, 0x98, 0x27,
...
#else
BYTE tEDID_TABLE_COMBO_PORT0[COMBO_EDID_SIZE_256] =
{
...
#else
,
...
BYTE tEDID_TABLE_COMBO_PORT0_HDMIFreeSync[COMBO_EDID_SIZE_256] =
{
...
#if(COMBO_IP_SUPPORT_TYPE >= COMBO_IP_SUPPORT_2PORT)
#if(COMBO_USE_EDID512_PORT1)
BYTE tEDID_TABLE_COMBO_PORT1[COMBO_EDID_SIZE_512] =
{
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x4D, 0xD9, 0x01, 0xFD, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x14, 0x01, 0x03, 0x80, 0x90, 0x51, 0x78, 0x0A, 0x0D, 0xC9, 0xA0, 0x57, 0x47, 0x98, 0x27,
    0x12, 0x48, 0x4C, 0x21, 0x08, 0x00, 0x81, 0x80, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
...
#elif(COMBO_USE_DISPLAY_ID_PORT1)
BYTE tEDID_TABLE_COMBO_PORT1[COMBO_EDID_SIZE_384] =
{
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x36,0x74,0x30,0x00,0x01,0x00,0x00,0x00,
    0x18,0x0F,0x01,0x03,0x80,0x73,0x41,0x78,0x0A,0xCF,0x74,0xA3,0x57,0x4C,0xB0,0x23,
    0x09,0x48,0x4C,0x00,0x00,0x00,0x01,0x01,0x01,0xFF,0x01,0xFF,0xFF,0x01,0x01,0x01,
...
#else
BYTE tEDID_TABLE_COMBO_PORT1[COMBO_EDID_SIZE_256] =
{
...
BYTE tEDID_TABLE_COMBO_PORT1_HDMIFreeSync[COMBO_EDID_SIZE_256] =
{
    // Freesync EDID FullHD 40~70Hz
	0x00  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0x00  ,0x05  ,0xA4  ,0x30  ,0x00  ,0x02  ,0x00  ,0x00  ,0x00,
	0x01  ,0x18  ,0x01  ,0x04  ,0x80  ,0x73  ,0x41  ,0x78  ,0x0B  ,0xCF  ,0x74  ,0xA7  ,0x55  ,0x46  ,0x98  ,0x24,
...
#if(COMBO_IP_SUPPORT_TYPE >= COMBO_IP_SUPPORT_3PORT)
#if(COMBO_USE_EDID512_PORT2)
BYTE tEDID_TABLE_COMBO_PORT2[COMBO_EDID_SIZE_512] =
{
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x4D, 0xD9, 0x01, 0xFD, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x14, 0x01, 0x03, 0x80, 0x90, 0x51, 0x78, 0x0A, 0x0D, 0xC9, 0xA0, 0x57, 0x47, 0x98, 0x27,
    0x12, 0x48, 0x4C, 0x21, 0x08, 0x00, 0x81, 0x80, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
...
#elif(COMBO_USE_DISPLAY_ID_PORT2)
BYTE tEDID_TABLE_COMBO_PORT2[COMBO_EDID_SIZE_384] =
{
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x36,0x74,0x30,0x00,0x01,0x00,0x00,0x00,
    0x18,0x0F,0x01,0x03,0x80,0x73,0x41,0x78,0x0A,0xCF,0x74,0xA3,0x57,0x4C,0xB0,0x23,
    0x09,0x48,0x4C,0x00,0x00,0x00,0x01,0x01,0x01,0xFF,0x01,0xFF,0xFF,0x01,0x01,0x01,
...
#else
BYTE tEDID_TABLE_COMBO_PORT2[COMBO_EDID_SIZE_256] =
{
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x36,0x74,0x30,0x00,0x01,0x00,0x00,0x00,
    0x18,0x0F,0x01,0x03,0x80,0x73,0x41,0x78,0x0A,0xCF,0x74,0xA3,0x57,0x4C,0xB0,0x23,
    0x09,0x48,0x4C,0x00,0x00,0x00,0x01,0x01,0x01,0xFF,0x01,0xFF,0xFF,0x01,0x01,0x01,
...
BYTE tEDID_TABLE_COMBO_PORT2_HDMIFreeSync[COMBO_EDID_SIZE_256] =
{
    // Freesync EDID FullHD 40~70Hz
	0x00  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0x00  ,0x05  ,0xA4  ,0x30  ,0x00  ,0x02  ,0x00  ,0x00  ,0x00,
	0x01  ,0x18  ,0x01  ,0x04  ,0x80  ,0x73  ,0x41  ,0x78  ,0x0B  ,0xCF  ,0x74  ,0xA7  ,0x55  ,0x46  ,0x98  ,0x24,
...
#if(COMBO_IP_SUPPORT_TYPE >= COMBO_IP_SUPPORT_4PORT)
#if(COMBO_USE_EDID512_PORT3)
BYTE tEDID_TABLE_COMBO_PORT3[COMBO_EDID_SIZE_512] =
{
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x4D, 0xD9, 0x01, 0xFD, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x14, 0x01, 0x03, 0x80, 0x90, 0x51, 0x78, 0x0A, 0x0D, 0xC9, 0xA0, 0x57, 0x47, 0x98, 0x27,
    0x12, 0x48, 0x4C, 0x21, 0x08, 0x00, 0x81, 0x80, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
...
#elif(COMBO_USE_DISPLAY_ID_PORT3)
BYTE tEDID_TABLE_COMBO_PORT3[COMBO_EDID_SIZE_384] =
{
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x36,0x74,0x30,0x00,0x01,0x00,0x00,0x00,
    0x18,0x0F,0x01,0x03,0x80,0x73,0x41,0x78,0x0A,0xCF,0x74,0xA3,0x57,0x4C,0xB0,0x23,
    0x09,0x48,0x4C,0x00,0x00,0x00,0x01,0x01,0x01,0xFF,0x01,0xFF,0xFF,0x01,0x01,0x01,
...
#else
BYTE tEDID_TABLE_COMBO_PORT3[COMBO_EDID_SIZE_256] =
{
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x36,0x74,0x30,0x00,0x01,0x00,0x00,0x00,
    0x18,0x0F,0x01,0x03,0x80,0x73,0x41,0x78,0x0A,0xCF,0x74,0xA3,0x57,0x4C,0xB0,0x23,
    0x09,0x48,0x4C,0x00,0x00,0x00,0x01,0x01,0x01,0xFF,0x01,0xFF,0xFF,0x01,0x01,0x01,
...
BYTE tEDID_TABLE_COMBO_PORT3_HDMIFreeSync[COMBO_EDID_SIZE_256] =
{
    // Freesync EDID FullHD 40~70Hz

	#if 0
	,
	#else
	0x00  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0x00  ,0x05  ,0xA4  ,0x30  ,0x00  ,0x02  ,0x00  ,0x00  ,0x00,
	0x01  ,0x18  ,0x01  ,0x04  ,0x80  ,0x73  ,0x41  ,0x78  ,0x0B  ,0xCF  ,0x74  ,0xA7  ,0x55  ,0x46  ,0x98  ,0x24,
	0x10  ,0x49  ,0x4B  ,0x21  ,0x08  ,0x00  ,0x81  ,0x80  ,0x95  ,0x00  ,0x90  ,0x40  ,0xA9  ,0xC0  ,0xA9  ,0x40,
...
#if(COMBO_IP_SUPPORT_TYPE >= COMBO_IP_SUPPORT_5PORT)
#if(COMBO_USE_EDID512_PORT4)
BYTE tEDID_TABLE_COMBO_PORT4[COMBO_EDID_SIZE_512] =
{
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x4D, 0xD9, 0x01, 0xFD, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x14, 0x01, 0x03, 0x80, 0x90, 0x51, 0x78, 0x0A, 0x0D, 0xC9, 0xA0, 0x57, 0x47, 0x98, 0x27,
    0x12, 0x48, 0x4C, 0x21, 0x08, 0x00, 0x81, 0x80, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
...
#elif(COMBO_USE_DISPLAY_ID_PORT4)
BYTE tEDID_TABLE_COMBO_PORT4[COMBO_EDID_SIZE_384] =
{
    //Sony 4K2K
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x4D, 0xD9, 0x01, 0xFD, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x14, 0x01, 0x03, 0x80, 0x90, 0x51, 0x78, 0x0A, 0x0D, 0xC9, 0xA0, 0x57, 0x47, 0x98, 0x27,
...
#else
BYTE tEDID_TABLE_COMBO_PORT4[COMBO_EDID_SIZE_256] =
{
    //Mstar EDID (3840x2160@60Hz Audio) Reduce Blanking
#if 0
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x36, 0x74, 0x30, 0x00, 0x01, 0x00, 0x00, 0x00,
...
BYTE tEDID_TABLE_COMBO_PORT4_HDMIFreeSync[COMBO_EDID_SIZE_256] =
{
    // Freesync EDID FullHD 40~70Hz
	0x00  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0x00  ,0x05  ,0xA4  ,0x30  ,0x00  ,0x02  ,0x00  ,0x00  ,0x00,
	0x01  ,0x18  ,0x01  ,0x04  ,0x80  ,0x73  ,0x41  ,0x78  ,0x0B  ,0xCF  ,0x74  ,0xA7  ,0x55  ,0x46  ,0x98  ,0x24,
...
#if(COMBO_IP_SUPPORT_TYPE >= COMBO_IP_SUPPORT_6PORT)
#if(COMBO_USE_EDID512_PORT5)
BYTE tEDID_TABLE_COMBO_PORT5[COMBO_EDID_SIZE_512] =
{
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x4D, 0xD9, 0x01, 0xFD, 0x01, 0x01, 0x01, 0x01,
    0x01, 0x14, 0x01, 0x03, 0x80, 0x90, 0x51, 0x78, 0x0A, 0x0D, 0xC9, 0xA0, 0x57, 0x47, 0x98, 0x27,
    0x12, 0x48, 0x4C, 0x21, 0x08, 0x00, 0x81, 0x80, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
...
#elif(COMBO_USE_DISPLAY_ID_PORT5)
BYTE tEDID_TABLE_COMBO_PORT5[COMBO_EDID_SIZE_384] =
{
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x36,0x74,0x30,0x00,0x01,0x00,0x00,0x00,
    0x18,0x0F,0x01,0x03,0x80,0x73,0x41,0x78,0x0A,0xCF,0x74,0xA3,0x57,0x4C,0xB0,0x23,
    0x09,0x48,0x4C,0x00,0x00,0x00,0x01,0x01,0x01,0xFF,0x01,0xFF,0xFF,0x01,0x01,0x01,
...
#else
BYTE tEDID_TABLE_COMBO_PORT5[COMBO_EDID_SIZE_256] =
{
    0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x36,0x74,0x30,0x00,0x01,0x00,0x00,0x00,
...
BYTE tEDID_TABLE_COMBO_PORT5_HDMIFreeSync[COMBO_EDID_SIZE_256] =
{
    // Freesync EDID FullHD 40~70Hz
	0x00  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0xFF  ,0x00  ,0x05  ,0xA4  ,0x30  ,0x00  ,0x02  ,0x00  ,0x00  ,0x00,
	0x01  ,0x18  ,0x01  ,0x04  ,0x80  ,0x73  ,0x41  ,0x78  ,0x0B  ,0xCF  ,0x74  ,0xA7  ,0x55  ,0x46  ,0x98  ,0x24,
