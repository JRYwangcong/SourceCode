...
{
#if defined(ENABLE_USB) && defined(USB_POWER_SAVING_MODE)
    U32 ii;
...
void XBYTE_OR(U32 Addr, U8 offset, U8 val)
{
    ...
    if (offset & 1)
    {
    	temp=msRead2Byte(Addr+(offset-1));
		msWrite2Byte(Addr+(offset-1),(((U16)val)<<8) | (temp ));
        //temp=*(U16 volatile   *)(Addr+(offset-1)*2);
        //*(U16 volatile   *)(Addr+(offset-1)*2)=(((U16)val)<<8) | (temp );
    }
    else
    {
    	temp=msRead2Byte(Addr+offset);
		msWrite2Byte(Addr+(offset),(temp )|val);
...
void XBYTE_AND(U32 Addr, U8 offset,U8 val)
{
    ...
    {
    	temp=msRead2Byte(Addr+(offset-1));
		msWrite2Byte(Addr+(offset-1),((((U16)val)<<8)|0xff) & (temp ));
        //temp=*(U16 volatile   *)(Addr+(offset-1)*2);
    ...
    {
    	temp=msRead2Byte(Addr+offset);
		msWrite2Byte(Addr+(offset),(temp & (0xff00|val) ));
        //temp=*(U16 volatile   *)(Addr+offset*2);
...
void XBYTE_SET(U32 Addr, U8 offset,U8 val)
{
    ...
    {
    	temp=msRead2Byte(Addr+(offset-1));
		msWrite2Byte(Addr+(offset-1),((temp & 0x00ff) | (((U16)val)<<8)));
        //temp=*(U16 volatile   *)(Addr+(offset-1)*2);
...
U8 drvUSBHost_HID_Init(U8 u8UsbPort)
{
   if (u8UsbPort == USB_PORT_0)
    {
#if 1//defined(ENABLE_USB) && defined(USB_HID_ENABLE)
