...
//**************************************************************************
//  [Function Name]:
//                  mapi_tmds_Splitter_Done()
//  [Description]:
//                  detect if splitter is done in HDMI mode.
//  [Arguments]:
//                  ucInputPort : combo port
//  [Return]:
//                  none
...
{
    return mdrv_tmds_Splitter_Done(enInputPort);
}

//**************************************************************************
//  [Function Name]:
//                  mapi_tmds_fix_audio_clock()
//  [Description]:
//
//  [Arguments]:
//                  
...
{
    mdrv_tmds_fix_audio_clock(enAudioFS, bFlag);
}
...
//**************************************************************************
//  [Function Name]:
//                  mapi_tmds_GetPixelClock_10KHz()
//  [Description]:
//                  return pixel clock (10kHz)
//  [Arguments]:
//                  enInputPort
//  [Return]:
//  
...
{
    return mdrv_tmds_GetPixelClock_10KHz(enInputPort);
}
...
{
    return mdrv_tmds_ClrSplitFlag(enInputPort);
}
...
{
    mdrv_tmds_PowerControl(ucInputPort, bPowerOn, bCLKDET);
}

//**************************************************************************
//  [Function Name]:
//                  mapi_tmds_DualLink_Align()
//  [Description]
//                  
//  [Arguments]:
//
...
{
   mdrv_tmds_DualLink_Align(enInputPort);
}
...
//**************************************************************************
//  [Function Name]:
//                  mapi_tmds_CheckHDCPState()
//  [Description]
//                  
//  [Arguments]:
//                  enInputPort : combo port
//  [Return]:
//                  HDCP 1.4\2.2 or no encryption
//**************************************************************************
TMDS_HDCP_STATE mapi_tmds_CheckHDCPState(BYTE ucInputPort)
{
    return mdrv_tmds_CheckHDCPState(ucInputPort);
}

//**************************************************************************
//  [Function Name]:
//                  mapi_tmds_ForceColorFormat()
//  [Description]
//                  
//  [Arguments]:
//                  enInputPort : combo port
...
{
    mdrv_tmds_ForceColorFormat(enInputPort, bFlag, enColor);
}
