...
#define COMBO_DP_BLOCK_ENABLE            1//(ENABLE_DP_INPUT)
...
#define COMBO_MHL3_SUPPORT_PORT1        1
...
#define COMBO_HDCP2_INITPROC_NEW_MODE   1
...
// EQ
// HDMI1.4 port: 0 < 4 < 2 < 1 < 5 < 3 < 7
// HDMI2.0 port: 0x00 < 0x01 < ... < 0x1E < 0x1F
#if ((defined(FengYuan_Project))||((defined(LianHeChuangXin_Project))&&(EDID_2560x1080_120))||(MS_BOARD_TYPE_SEL == BD_MST9UHD_BV1)||(MS_BOARD_TYPE_SEL==BD_MST9UHD_DV1)||(MS_BOARD_TYPE_SEL==BD_MST9UHD_GV1))
#define COMBO_HDMI14_EQ_VALUE           0x02
#else
#define COMBO_HDMI14_EQ_VALUE           0x03
#endif

#define COMBO_HDMI_250_340MHZ_EQ_VALUE  0x10
#define COMBO_HDMI_25_250MHZ_EQ_VALUE   0x0C
//HDMI Port Show Nosign Befor HDMI PortInfo Show
#if (((EDID_2560x1440_120||EDID_3440x1440||EDID_3840x2160)))
#define COMBO_HDMI_EQ_VALUE             COMBO_HDMI_250_340MHZ_EQ_VALUE
#else
