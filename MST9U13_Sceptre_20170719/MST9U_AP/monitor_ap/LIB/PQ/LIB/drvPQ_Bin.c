...
#define MApi_XC_WriteByte(u32Reg, u8Val)  \
    msWriteByte(0x80000000 + (((MS_U16)u32Reg & 0xFF00)<<16) + u32ScBaseAddr + (u32Reg & 0xFF), u8Val)
...
#define SC_BK_SWITCH(_x_)\
        msWriteByte(u32ScBaseAddr, _x_)  //msWriteByte(u32ScBaseAddr, _x_) //MApi_XC_WriteByte(BK_SCALER_BASE, _x_)

#define SC_BK_CURRENT   \
        msReadByte(u32ScBaseAddr) //msReadByte(u32ScBaseAddr) //MApi_XC_ReadByte(BK_SCALER_BASE)
//-------------------------------------------------------------------------------------------------
//  Local Variable
//-------------------------------------------------------------------------------------------------
...
MS_U8 MDrv_PQBin_GetByteData(DWORD pAddrVirt, MS_U32 *u32Offset)
{
    ...
    *u32Offset = *u32Offset + 1;
    ...
    BYTE u8Ret;
    *u32Offset = *u32Offset + 1;
    Flash_ReadTbl(pAddrVirt, &u8Ret, 1);
    return u8Ret;
}
...
MS_U16 MDrv_PQBin_Get2ByteData(DWORD pAddrVirt, MS_U32 *u32Offset)
{
    ...
    *u32Offset = *u32Offset + 2;
    ...
    Flash_ReadTbl(pAddrVirt, &u16ret[0], 2);
    return (u16ret[0] + (u16ret[1] << 8));

}


MS_U32 MDrv_PQBin_Get4ByteData(DWORD pAddrVirt, MS_U32 *u32Offset)
{
    ...
    *u32Offset = *u32Offset + 4;
    Flash_ReadTbl(pAddrVirt, &u32ret[0], 4);

    return (u32ret[0] + (u32ret[1] << 8) + (u32ret[2] << 16) + (u32ret[3] << 24));
}
...
void MDrv_PQBin_DumpGeneralRegTable(const MS_PQBin_IP_Table_Info* const pTabInfo)
{
    ...
    for(i=0; i< pTabInfo->u16RegNum; i++)
    {
        ...
        u8Bank = MDrv_PQBin_GetByteData((u32Addr+u32Offset), &u32Offset);
        ...
        u8Value = MDrv_PQBin_GetByteData((u32Addr+u32Offset), &u32Offset);
...
void MDrv_PQBin_DumpFilterTable(MS_PQBin_IP_Table_Info *pTabInfo)
{
    ...
    for (i = 0; i< 2178; i++)
        u8TabelData[i] = FlashReadByte(u32Addr + i);    //read table data from flash
    switch(pTabInfo->u16TableType)
    {
    case PQ_TABTYPE_SRAM1:
        //Hal_PQ_set_y_sram_table(SC_FILTER_Y_SRAM1, (void *)u32Addr);
        Hal_PQ_set_y_sram_table(SC_FILTER_Y_SRAM1, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_SRAM2:
        //Hal_PQ_set_y_sram_table(SC_FILTER_Y_SRAM2, (void *)u32Addr);
        Hal_PQ_set_y_sram_table(SC_FILTER_Y_SRAM2, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_SRAM3:
        Hal_PQ_set_y_sram_table(SC_FILTER_Y_SRAM3, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_SRAM4:
        Hal_PQ_set_y_sram_table(SC_FILTER_Y_SRAM4, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_C_SRAM1:
        Hal_PQ_set_c_sram_table(SC_FILTER_C_SRAM1, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_C_SRAM2:
        Hal_PQ_set_c_sram_table(SC_FILTER_C_SRAM2, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_C_SRAM3:
        Hal_PQ_set_c_sram_table(SC_FILTER_C_SRAM3, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_C_SRAM4:
        Hal_PQ_set_c_sram_table(SC_FILTER_C_SRAM4, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_SRAM_COLOR_INDEX:
        Hal_PQ_set_sram_color_index_table(SC_FILTER_SRAM_COLOR_INDEX, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_SRAM_COLOR_GAIN_SNR:
        Hal_PQ_set_sram_color_gain_snr_table(SC_FILTER_SRAM_COLOR_GAIN_SNR, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_SRAM_COLOR_GAIN_DNR:
        Hal_PQ_set_sram_color_gain_dnr_table(SC_FILTER_SRAM_COLOR_GAIN_DNR, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_VIP_ICC_CRD_SRAM:
        Hal_PQ_set_sram_icc_crd_table(SC_FILTER_SRAM_ICC_CRD, &u8TabelData[0]);
        break;
    case PQ_TABTYPE_VIP_IHC_CRD_SRAM:
        Hal_PQ_set_sram_ihc_crd_table(SC_FILTER_SRAM_IHC_CRD, &u8TabelData[0]);
        break;
    default:
...
void MDrv_PQBin_DumpTable(MS_PQBin_IP_Table_Info* pTabInfo)
{
    ...
    */
    ...
    case PQ_TABTYPE_GENERAL:
        ...
        break;
    case PQ_TABTYPE_SRAM1:
        if (_u8SRAM1Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8SRAM1Table[_scIdx] = pTabInfo->u16GroupIdx;
        ...
        break;
    case PQ_TABTYPE_SRAM2:
        if (_u8SRAM2Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8SRAM2Table[_scIdx] = pTabInfo->u16GroupIdx;
        ...
        break;
    case PQ_TABTYPE_SRAM3:
        if (_u8SRAM3Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8SRAM3Table[_scIdx] = pTabInfo->u16GroupIdx;
        ...
        break;
    case PQ_TABTYPE_SRAM4:
        if (_u8SRAM4Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8SRAM4Table[_scIdx] = pTabInfo->u16GroupIdx;
    ...
    case PQ_TABTYPE_C_SRAM1:
        if (_u8CSRAM1Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8CSRAM1Table[_scIdx] = pTabInfo->u16GroupIdx;
        ...
        break;
    case PQ_TABTYPE_C_SRAM2:
        if (_u8CSRAM2Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8CSRAM2Table[_scIdx] = pTabInfo->u16GroupIdx;
        ...
        break;
    case PQ_TABTYPE_C_SRAM3:
        if (_u8CSRAM3Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8CSRAM3Table[_scIdx] = pTabInfo->u16GroupIdx;
        ...
        break;
    case PQ_TABTYPE_C_SRAM4:
        if (_u8CSRAM4Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8CSRAM4Table[_scIdx] = pTabInfo->u16GroupIdx;
    ...
    case PQ_TABTYPE_VIP_ICC_CRD_SRAM:
        if (_u8ICC_CRD_Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8ICC_CRD_Table[_scIdx] = pTabInfo->u16GroupIdx;
    ...
    case PQ_TABTYPE_VIP_IHC_CRD_SRAM:
        if (_u8IHC_CRD_Table[_scIdx] != pTabInfo->u16GroupIdx)
        {
            _isNewSetting = true;
        }
        _u8IHC_CRD_Table[_scIdx] = pTabInfo->u16GroupIdx;
...
MS_U16 MDrv_PQBin_GetTableNum(MS_U16 u16PQIPIdx, const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    u16TabNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
...
MS_U16 MDrv_PQBin_GetTableIndex(MS_U16 u16PQSrcType, MS_U16 u16PQIPIdx, MS_U16 u16PQPnlIdx, const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    PQ_BIN_DBG(printf("[PQBin]u16PQSrcType=%u, u16PQIPIdx=%u, u16PQPnlIdx=%u\n",u16PQSrcType, u16PQIPIdx, u16PQPnlIdx));
    ...
    u16SourceLUT_SourceNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
    ...
    u16SourceLUT_IPNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
    ...
    u32SourceLUT_Addr = MDrv_PQBin_Get4ByteData(u32Addr+u32Offset, &u32Offset);
    ...
    u16TableIdx = MDrv_PQBin_Get2ByteData(u32SourceLUT_Addr+u32SourceLUT_Offset,
                                          &u32SourceLUT_Offset);
...
void MDrv_PQBin_GetTable(MS_U16 u16PnlIdx, MS_U16 u16TabIdx, MS_U16 u16PQIPIdx, MS_PQBin_IP_Table_Info *pTableInfo, const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    if (u16TabIdx != PQ_BIN_IP_NULL)
    {
        ...
        if(u16TabIdx == PQ_BIN_IP_COMM)
        {
            ...
            pTableInfo->u16TableType = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);

            u32Offset = pPQBinHeader->u32IP_Comm_Pitch * (MS_U32)u16PQIPIdx + PQ_BIN_IP_COMM_COMM_REG_NUM_OFFSET;
            pTableInfo->u16RegNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);

            u32Offset = pPQBinHeader->u32IP_Comm_Pitch * (MS_U32)u16PQIPIdx + PQ_BIN_IP_COMM_COMMOFFSET_OFFSET;
            pTableInfo->u32TabOffset = MDrv_PQBin_Get4ByteData(u32Addr+u32Offset, &u32Offset);
        ...
        else
        {
            ...
            u32Offset = pPQBinHeader->u32IP_Comm_Pitch * (MS_U32)u16PQIPIdx + PQ_BIN_IP_COMM_IP_GROUP_NUM_OFFSET;
            pTableInfo->u16GroupNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
...
void MDrv_PQBin_LoadCommTable(MS_U16 u16PnlIdx, MS_PQBin_Header_Info *pPQBinHeader)
{
    ...
    for (i=0; i< pPQBinHeader->u16IP_Comm_Num; i++)
    {
        ...
        if ( MDrv_PQBin_GetSkipRule(i, pPQBinHeader))
        {
...
void MDrv_PQBin_Parsing(MS_PQBin_Header_Info *pPQBinHeader)
{
    ...
    {
        pPQBinHeader->u8Header[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }

    for(i=0; i< PQ_BIN_HEADER_LEN; i++)
    {
        pPQBinHeader->u8Version[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }

    pPQBinHeader->u32StartOffset = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    pPQBinHeader->u32EndOffset   = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32Offset, &u32Offset);

    for(i=0; i< PQ_BIN_DUMMY; i++)
    {
        pPQBinHeader->u8Dummy[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }
    ...
    for(i=0; i< PQ_BIN_HEADER_LEN; i++)
    {
        pPQBinHeader->u8GRuleHader[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }

    pPQBinHeader->u16GRule_RuleNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    pPQBinHeader->u16GRule_PnlNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);


    PQ_BIN_DBG_HEADER(printf("\nGRuleHeader:%16s\n", pPQBinHeader->u8GRuleHader));
    ...
    for(i=0; i< PQ_BIN_HEADER_LEN; i++)
    {
        pPQBinHeader->u8XRuleHader[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }
    pPQBinHeader->u16XRuleNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    ...
    for(i=0; i< PQ_BIN_HEADER_LEN; i++)
    {
        pPQBinHeader->u8SkipRuleHader[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }

    pPQBinHeader->u16SkipRule_IPNum  = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    pPQBinHeader->u32SkipRule_Offset = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    ...
    for(i=0; i< PQ_BIN_HEADER_LEN; i++)
    {
        pPQBinHeader->u8IP_Comm_Header[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }

    pPQBinHeader->u16IP_Comm_Num = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    ...
    for(i=0; i< PQ_BIN_HEADER_LEN; i++)
    {
        pPQBinHeader->u8SourceLUT_Header[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    }

    pPQBinHeader->u16SourceLUT_PnlNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
    ...
    for(i=0; i<pPQBinHeader->u16GRule_RuleNum; i++)
    {
        ...
        stGRuleInfo.u16IPNum      = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stGRuleInfo.u16SourceNum  = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stGRuleInfo.u16GroupNum   = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stGRuleInfo.u32IPOffset   = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stGRuleInfo.u32RuleOffset = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
    ...
    for(i=0; i<pPQBinHeader->u16GRule_RuleNum*pPQBinHeader->u16GRule_PnlNum; i++)
    {
        ...
        stGRuleLvlInfo.u16LvlNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stGRuleLvlInfo.u32Offset = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
    ...
    for(i=0; i<pPQBinHeader->u16XRuleNum; i++)
    {
        ...
        stXRuleInfo.u16IPNum       = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stXRuleInfo.u16GroupNum    = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stXRuleInfo.u32IPOffset    = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stXRuleInfo.u32GroupOffset = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
    ...
    for(i=0; i<pPQBinHeader->u16IP_Comm_Num; i++)
    {
        ...
        stIPCommInfo.u16CommRegNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stIPCommInfo.u16IPRegNum   = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stIPCommInfo.u16IPGroupNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stIPCommInfo.u32CommOffset = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stIPCommInfo.u32IPOffset   = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
    ...
    for(i=0; i<pPQBinHeader->u16SourceLUT_PnlNum; i++)
        ...
        stSourceLUTInfo.u16SourceNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stSourceLUTInfo.u16IPNum     = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
        stSourceLUTInfo.u32Offset    = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32tmpoffset, &u32tmpoffset);
...
MS_U16 MDrv_PQBin_GetSkipRule(MS_U16 u16PQIPIdx, const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    u16SkipRet = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset , &u32Offset);
    return u16SkipRet;
}
    ...
    MS_BOOL isWinRot)
{
    ...
    for(i=0; i<QMIPtype_size; i++, u16PQIPIdx++)
    {
        ...
        if (isWinRot)
        {
            if (u16PQIPIdx == PQ_IP_MADi_Motion_Main)
            {
                u16TabIdx = PQ_IP_MADi_Motion_MOT_PMODE_Main;    //Set MADi Motion = MOT_PMODE for window rotate
            }
            else if (u16PQIPIdx >= PQ_IP_MADi_Main && u16PQIPIdx <= PQ_IP_UC_CTL_Main)
            {
                u16TabIdx = 0; //set to off for rotate
            }
        }
...
MS_U16 MDrv_PQBin_GetXRuleTableIndex(MS_U16 u16XRuleType, MS_U16 u16XRuleIdx, MS_U16 u16XRuleIP, const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    u16IPNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);

    u32Offset = pPQBinHeader->u32XRUle_Pitch * u16XRuleType + PQ_BIN_XRULE_GROUPOFFSET_OFFSET;
    u32Rule_Addr = MDrv_PQBin_Get4ByteData(u32Addr+u32Offset, &u32Offset) +
                   pPQBinHeader->u32BinStartAddress;


    u32Rule_Offset = (u16IPNum * u16XRuleIdx + u16XRuleIP ) * 2;
    u16TableIdx = MDrv_PQBin_Get2ByteData(u32Rule_Addr+u32Rule_Offset, &u32Rule_Offset);
...
MS_U16 MDrv_PQBin_GetXRuleIPIndex(MS_U16 u16XRuleType, MS_U16 u16XRuleIP, const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    u32IP_Addr = MDrv_PQBin_Get4ByteData(u32Addr+u32Offset, &u32Offset) +
                 pPQBinHeader->u32BinStartAddress + PQ_BIN_XRULE_HEADER_LEN;

    u32IP_Offset =  u16XRuleIP * 2;

    u16IPIdx = MDrv_PQBin_Get2ByteData(u32IP_Addr+u32IP_Offset, &u32IP_Offset);
    ...
    const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    u16LvlNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
    ...
    u32Lvl_Addr = MDrv_PQBin_Get4ByteData(u32Addr+u32Offset, &u32Offset);

    u32Addr = u32Lvl_Addr + pPQBinHeader->u32BinStartAddress;
    u32Offset = PQ_BIN_GRULE_HEADER_LEN + u16GRuleLvlIndex * 2;

    u16LvlIdx = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
    ...
    const MS_PQBin_Header_Info* const pPQBinHeader)
{
    ...
    u16GroupNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
    ...
    u16SrcNum = MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
...
void MDrv_PQTextBin_Parsing(MS_PQTextBin_Header_Info *pPQTextBinHeader)
{
        ...
        {
            pPQTextBinHeader->u8Header[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        }

        for(i=0; i< PQ_TEXT_BIN_HEADER_LEN; i++)
        {
            pPQTextBinHeader->u8Version[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        }


        pPQTextBinHeader->u32StartOffset = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        pPQTextBinHeader->u32EndOffset   = MDrv_PQBin_Get4ByteData(u32PQBin_Addr+u32Offset, &u32Offset);

        for(i=0; i< PQ_TEXT_BIN_DUMMY; i++)
        {
            pPQTextBinHeader->u8Dummy[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        }
        ...
        for(i=0; i< PQ_TEXT_BIN_HEADER_LEN; i++)
        {
            pPQTextBinHeader->u8SrcTypeHeader[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        }
        pPQTextBinHeader->u16SrcNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        ...
        for(i=0; i< PQ_TEXT_BIN_HEADER_LEN; i++)
        {
            pPQTextBinHeader->u8IPNameHeader[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        }
        pPQTextBinHeader->u16IPNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        ...
        for(i=0; i< PQ_TEXT_BIN_HEADER_LEN; i++)
        {
            pPQTextBinHeader->u8GroupNameHeader[i] = MDrv_PQBin_GetByteData(u32PQBin_Addr+u32Offset, &u32Offset);
        }
        pPQTextBinHeader->u16GroupIPNum = MDrv_PQBin_Get2ByteData(u32PQBin_Addr+u32Offset, &u32Offset);
...
MS_U32 MDrv_PQTextBin_GetSrcType(MS_U16 u16SrcIdx, const MS_PQTextBin_Header_Info* const pPQTextBinHeader)
{
    ...
    u32DstAddr = MDrv_PQBin_Get4ByteData(u32Addr+u32Offset, &u32Offset) +
...
MS_U32 MDrv_PQTextBin_GetTableName(MS_U16 u16PQIPIdx, MS_U16 u16TabIdx, const MS_PQTextBin_Header_Info* const pPQTextBinHeader)
{
    ...
    u32Addr = MDrv_PQBin_Get4ByteData(u32Addr+u32Offset, &u32Offset) +
                 pPQTextBinHeader->u32BinStartAddress;
    ...
    for(i=0; i< u16TabIdx; i++)
    {
        ...
        u32Total_Len += MDrv_PQBin_Get2ByteData(u32Addr+u32Offset, &u32Offset);
    }
