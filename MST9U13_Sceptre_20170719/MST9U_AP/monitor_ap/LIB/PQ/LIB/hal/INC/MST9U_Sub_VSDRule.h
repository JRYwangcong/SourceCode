...
#define PQ_VSDRule_IP_NUM_Sub 3
...
extern const U8 MST_VSDRule_IP_Index_Sub[PQ_VSDRule_IP_NUM_Sub];
extern const U8 MST_VSDRule_Array_Sub[PQ_VSDRule_NUM_Sub][PQ_VSDRule_IP_NUM_Sub];
