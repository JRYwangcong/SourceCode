...
#define MDrv_PQ_LoadTableBySrcType_(PQTABLE_NAME, u16PQSrcType, u8PQIPIdx, bIsRot) \
    MDrv_PQ_LoadTableBySrcType_##PQTABLE_NAME(u16PQSrcType, u8PQIPIdx, bIsRot)

#define DECLARE_MDrv_PQ_LoadTableBySrcType_(PQTABLE_NAME) \
    extern void MDrv_PQ_LoadTableBySrcType_##PQTABLE_NAME(MS_U16 u16PQSrcType, MS_U8 u8PQIPIdx, MS_BOOL bIsRot);

#define INSTALL_MDrv_PQ_LoadTableBySrcType_(PQTABLE_NAME) \
    void MDrv_PQ_LoadTableBySrcType_##PQTABLE_NAME(MS_U16 u16PQSrcType, MS_U8 u8PQIPIdx, MS_BOOL bIsRot){ \
        _MDrv_PQ_LoadTableBySrcType(u16PQSrcType, u8PQIPIdx, bIsRot); \
    }
...
#include "MST9U_Main_HSDRule.h"      // table config parameter
#include "MST9U_Main_VSDRule.h"      // table config parameter
#include "MST9U_Main_HSPRule.h"      // table config parameter
#include "MST9U_Main_VSPRule.h"      // table config parameter
#include "MST9U_Main_CSCRule.h"      // table config parameter
#include "MST9U_Main_GRule.h"        // table config parameter
#include "MST9U_Main_Ex.h"           // table config parameter

#include "MST9U_Sub.h"               // table config parameter
#include "MST9U_Sub_HSDRule.h"       // table config parameter
#include "MST9U_Sub_VSDRule.h"       // table config parameter
#include "MST9U_Sub_HSPRule.h"       // table config parameter
#include "MST9U_Sub_VSPRule.h"       // table config parameter
#include "MST9U_Sub_CSCRule.h"       // table config parameter
#include "MST9U_Sub_GRule.h"         // table config parameter
#include "MST9U_Sub_Ex.h"            // table config parameter
