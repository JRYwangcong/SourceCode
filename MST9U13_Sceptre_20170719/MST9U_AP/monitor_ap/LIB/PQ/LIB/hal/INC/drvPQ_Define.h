...
#define PQ_TB_FOR_TV			0		//$$$ for MST9U new PQ table setting

#define PQ_ONLY_SUPPORT_BIN     0		//$$$ 1  Modified
...
#define PQ_ENABLE_VD_SAMPLING   1  //drvPQ.c
#define PQ_ENABLE_PIP           1   //QuQualityMap_Sub.c,  QuQualityMap_SubEx.c
#define PQ_ENABLE_3D_VIDEO      1    //drvPQ.c
#define PQ_ENABLE_IOCTL         1   //mapi_pql.cpp
...
#define PQ_GRULE_OSD_BW_ENABLE  1  //t12 = 1, chakra = 0
#define PQ_GRULE_FILM_MODE_ENABLE  1 ///t12 = 1, chakra = 0
#define PQ_GRULE_DYNAMIC_CONTRAST_ENABLE  1 //t12 = 1, chakra = 0
#define PQ_GRULE_ULTRAT_CLEAR_ENABLE 1 //t12 = 1, chakra = 0
...
#define PQ_GRULE_SR_ENABLE      1
#define PQ_GRULE_DI_BYPASS_ENABLE 1

//********* New GRule bypass feature
#define PQ_GRULE_BYPASS_NR_ENABLE       1
#define PQ_GRULE_BYPASS_DI_ENABLE       1
#define PQ_GRULE_BYPASS_PEAKING_ENABLE  1
#define PQ_GRULE_BYPASS_OTHERS_ENABLE   1
//**********************************
...
#define PQ_EN_UCNR_OFF      TRUE       //drvPQ.c
#define PQ_ENABLE_FORCE_MADI    ENABLE //drvPQ.c
#define PQ_NEW_HSD_SAMPLING_TYPE TRUE //drvPQ.c
...
#if ((PQ_GRULE_OSD_BW_ENABLE == 1) && (PQ_GRULE_MPEG_NR_ENABLE == 1))
#define E_GRULE_NR          0
#define E_GRULE_SR          1
#define E_GRULE_OSD_BW      2
#define E_GRULE_MPEG_NR     3
#define E_GRULE_FilmMode	4
#define E_GRULE_DynContr	5
#define E_GRULE_ULTRACLEAR	6
#define E_GRULE_Bypass_NR   7
#define E_GRULE_Bypass_DI   8
#define E_GRULE_Bypass_Peaking  9
#define E_GRULE_Bypass_Others   10
#define E_GRULE_NUM         11
#elif(PQ_GRULE_OSD_BW_ENABLE == 1)
#define E_GRULE_NR          0
#define E_GRULE_OSD_BW      1
#define E_GRULE_NUM         2
#elif(PQ_GRULE_MPEG_NR_ENABLE == 1)
#define E_GRULE_NR          0
#define E_GRULE_MPEG_NR     1
#define E_GRULE_NUM         2
#else
#define E_GRULE_NR          0
...
typedef struct
{
    const MS_U8 *pIPCommTable;
    const MS_U8 *pIPTable;
    MS_U8 u8TabNums;
    MS_U8 u8TabType;
} EN_IPTAB_INFO;
...
// restore bank
    ...
    #define SC_BK_STORE_MUTEX     \
        ...
        u8Bank = msReadByte(u32ScBaseAddr)

// restore bank
    #define SC_BK_RESTORE_MUTEX   \
        msWriteByte(u32ScBaseAddr, u8Bank); \
        MsOS_ReleaseMutex(_PQ_Mutex);
#endif

//$$$ Need to check below modify
// switch bank
#define SC_BK_SWITCH(_x_)\
