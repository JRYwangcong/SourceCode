...
const U8 MST_VSPRule_IP_Index_Main[PQ_VSPRule_IP_NUM_Main]=
{
    PQ_IP_VSP_Y_Main,
    PQ_IP_VSP_C_Main,
    PQ_IP_SRAM1_Main,
...
const U8 MST_VSPRule_Array_Main[PQ_VSPRule_NUM_Main][PQ_VSPRule_IP_NUM_Main]=
{
    {//PreV_ScalingDown_Interlace, 0
        PQ_IP_VSP_Y_Bilinear_Main, PQ_IP_VSP_C_Bilinear_Main, PQ_IP_NULL, 
    },
    ...
    {//ScalingDown_10x_YUV, 22
        PQ_IP_VSP_Y_Bypass_Main, PQ_IP_VSP_C_Bypass_Main, PQ_IP_NULL, 
    },
