...
#define PQ_VSDRule_IP_NUM_Main 3
...
extern const U8 MST_VSDRule_IP_Index_Main[PQ_VSDRule_IP_NUM_Main];
extern const U8 MST_VSDRule_Array_Main[PQ_VSDRule_NUM_Main][PQ_VSDRule_IP_NUM_Main];
