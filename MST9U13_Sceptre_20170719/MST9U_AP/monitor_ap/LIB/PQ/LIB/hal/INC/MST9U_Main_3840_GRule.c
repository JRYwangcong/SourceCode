...
const U8 MST_GRule_3840_NR_Main[PQ_GRULE_NR_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_SR_Main[PQ_GRULE_SR_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_OSD_BW_Main[PQ_GRULE_OSD_BW_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_MPEG_NR_Main[PQ_GRULE_MPEG_NR_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_FILM_MODE_Main[PQ_GRULE_FILM_MODE_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_ULTRAT_CLEAR_Main[PQ_GRULE_ULTRAT_CLEAR_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_Bypass_NR_Main[PQ_GRULE_Bypass_NR_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_Bypass_DI_Main[PQ_GRULE_Bypass_DI_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_Bypass_Peaking_Main[PQ_GRULE_Bypass_Peaking_LVL_NUM_Main]=
{
...
const U8 MST_GRule_3840_Bypass_Others_Main[PQ_GRULE_Bypass_Others_LVL_NUM_Main]=
{
