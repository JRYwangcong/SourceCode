...
// 3840
// MST9U
// 2/12/2015  11:55:24 AM
// 39630.43853
//****************************************************

#ifndef _MST9U_SUB_H_
#define _MST9U_SUB_H_

#define PQ_IP_NUM_Sub 236
#define PQ_IP_SRAM_COLOR_INDEX_SIZE_Sub 0
#define PQ_IP_SRAM_COLOR_GAIN_SNR_SIZE_Sub 0
#define PQ_IP_SRAM_COLOR_GAIN_DNR_SIZE_Sub 0
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_720p_24hz_Sub, //4
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_720p_50hz_Sub, //5
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_720p_60hz_Sub, //6
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_1080i_50hz_Sub, //7
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_1080i_60hz_Sub, //8
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_1080p_24hz_Sub, //9
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_1080p_50hz_Sub, //10
    #endif
    #if PQ_QM_YPBPR
    QM_YPbPr_1080p_60hz_Sub, //11
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_480i_Sub, //12
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_576i_Sub, //13
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_480p_Sub, //14
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_576p_Sub, //15
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_720p_24hz_Sub, //16
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_720p_50hz_Sub, //17
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_720p_60hz_Sub, //18
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_1080i_50hz_Sub, //19
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_1080i_60hz_Sub, //20
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_1080p_24hz_Sub, //21
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_1080p_60hz_Sub, //22
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_1080p_50hz_Sub, //23
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_RGB_4K2K_Sub, //24
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_480i_Sub, //25
    #endif
    ...
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_720p_24hz_Sub, //29
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_720p_50hz_Sub, //30
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_720p_60hz_Sub, //31
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080i_50hz_Sub, //32
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080i_60hz_Sub, //33
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080p_24hz_Sub, //34
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080p_60hz_Sub, //35
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_1080p_50hz_Sub, //36
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_4K2K_Sub, //37
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vup_Sub, //38
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vdown_Sub, //39
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vno_Sub, //40
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vup_Sub, //41
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vdown_Sub, //42
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vno_Sub, //43
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vup_Sub, //44
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vdown_Sub, //45
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vno_Sub, //46
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vup_Sub, //47
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vdown_Sub, //48
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vno_Sub, //49
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vup_Sub, //50
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vdown_Sub, //51
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vno_Sub, //52
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vup_Sub, //53
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vdown_Sub, //54
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vno_Sub, //55
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vup_Sub, //56
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vdown_Sub, //57
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vno_Sub, //58
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vup_Sub, //59
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vdown_Sub, //60
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vno_Sub, //61
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vup_Sub, //62
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vdown_Sub, //63
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_Sub, //64
    #endif
    QM_INPUTTYPE_NUM_Sub, // 65
} SC_QUALITY_MAP_INDEX_e_Sub;

typedef enum
{
PQ_IP_ADC_Sampling_Sub,  //0
PQ_IP_SCinit_Sub,  //1
PQ_IP_CSC_Sub,  //2
PQ_IP_CSC_Dither_Sub,  //3
PQ_IP_YCdelay_Sub,  //4
PQ_IP_PreFilter_Sub,  //5
PQ_IP_PreFilter_Dither_Sub,  //6
PQ_IP_HDSDD_Sub,  //7
PQ_IP_HSD_Sampling_Sub,  //8
PQ_IP_HSD_Y_Sub,  //9
PQ_IP_HSD_C_Sub,  //10
PQ_IP_444To422_Sub,  //11
PQ_IP_VSD_Sub,  //12
PQ_IP_HVSD_Dither_Sub,  //13
PQ_IP_10to8_Dither_Sub,  //14
PQ_IP_MemFormat_Sub,  //15
PQ_IP_PreSNR_Sub,  //16
PQ_IP_PreSNR_Patch_Sub,  //17
PQ_IP_DNR_Sub,  //18
PQ_IP_DNR_Motion_Sub,  //19
PQ_IP_DNR_Y_Sub,  //20
PQ_IP_DNR_Y_COLOR_DEP_Sub,  //21
PQ_IP_SRAM_COLOR_INDEX_Sub,  //22
PQ_IP_SRAM_COLOR_GAIN_SNR_Sub,  //23
PQ_IP_SRAM_COLOR_GAIN_DNR_Sub,  //24
PQ_IP_DNR_Y_LUMA_ADAPTIVE_Sub,  //25
PQ_IP_DNR_POSTTUNE_Sub,  //26
PQ_IP_DNR_C_Sub,  //27
PQ_IP_PNR_Sub,  //28
PQ_IP_PNR_Y_Sub,  //29
PQ_IP_PNR_C_Sub,  //30
PQ_IP_PostCCS_Sub,  //31
PQ_IP_PostCCS_NP_Sub,  //32
PQ_IP_DHD_Sub,  //33
PQ_IP_420CUP_Sub,  //34
PQ_IP_MADi_Sub,  //35
PQ_IP_MADi_Motion_Sub,  //36
PQ_IP_MADi_MORPHO_Sub,  //37
PQ_IP_MADi_DFK_Sub,  //38
PQ_IP_MADi_SST_Sub,  //39
PQ_IP_MADi_EODiW_Sub,  //40
PQ_IP_MADi_Force_Sub,  //41
PQ_IP_EODi_Sub,  //42
PQ_IP_EODi_Armored_Sub,  //43
PQ_IP_EODi_Armored_KFC_Sub,  //44
PQ_IP_EODi_Armored_UCDi_Sub,  //45
PQ_IP_Film_Sub,  //46
PQ_IP_Film32_Sub,  //47
PQ_IP_Film22_Sub,  //48
PQ_IP_Film_any_Sub,  //49
PQ_IP_UCNR_Sub,  //50
PQ_IP_UCDi_Sub,  //51
PQ_IP_UC_CTL_Sub,  //52
PQ_IP_DIPF_Sub,  //53
PQ_IP_SPF_Sub,  //54
PQ_IP_VCLPF_Sub,  //55
PQ_IP_Spike_NR_Sub,  //56
PQ_IP_SPF_DBK_Sub,  //57
PQ_IP_SPF_DBK_BKN_Sub,  //58
PQ_IP_SPF_DBK_MR_Sub,  //59
PQ_IP_SPF_DBK_HDE_Sub,  //60
PQ_IP_SPF_DBK_C_Sub,  //61
PQ_IP_SPF_VDBK_Sub,  //62
PQ_IP_SPF_SNR_Sub,  //63
PQ_IP_SPF_SNR_MR_Sub,  //64
PQ_IP_SPF_MR_LPF_Sub,  //65
PQ_IP_SPF_NMR_Y_Sub,  //66
PQ_IP_SPF_NMR_Y_MR_Sub,  //67
PQ_IP_SPF_NMR_C_Sub,  //68
PQ_IP_DMS_Sub,  //69
PQ_IP_DMS_H_Sub,  //70
PQ_IP_DMS_V_Sub,  //71
PQ_IP_DMS_V_12L_Sub,  //72
PQ_IP_DS_Sub,  //73
PQ_IP_DS_90_Sub,  //74
PQ_IP_DS_21_Sub,  //75
PQ_IP_DS_11_Sub,  //76
...
PQ_IP_VSP_Y_Sub,  //85
PQ_IP_VSP_C_Sub,  //86
PQ_IP_VSP_CoRing_Sub,  //87
PQ_IP_VSP_DeRing_Sub,  //88
PQ_IP_VSP_Dither_Sub,  //89
PQ_IP_VSP_PreVBound_Sub,  //90
PQ_IP_AntiPAL_filter_Sub,  //91
PQ_IP_422To444_Sub,  //92
PQ_IP_PreCTI_Sub,  //93
PQ_IP_HSP_Y_Sub,  //94
PQ_IP_HSP_C_Sub,  //95
PQ_IP_HSP_CoRing_Sub,  //96
PQ_IP_HSP_DeRing_Sub,  //97
PQ_IP_HSP_Dither_Sub,  //98
PQ_IP_HnonLinear_Sub,  //99
PQ_IP_SRAM1_Sub,  //100
PQ_IP_SRAM2_Sub,  //101
PQ_IP_SRAM3_Sub,  //102
PQ_IP_SRAM4_Sub,  //103
PQ_IP_C_SRAM1_Sub,  //104
PQ_IP_C_SRAM2_Sub,  //105
PQ_IP_C_SRAM3_Sub,  //106
PQ_IP_C_SRAM4_Sub,  //107
PQ_IP_VIP_Sub,  //108
PQ_IP_VIP_pseudo_Sub,  //109
PQ_IP_VIP_CSC_Sub,  //110
PQ_IP_VIP_CSC_dither_Sub,  //111
PQ_IP_VIP_Post_YC_delay_Sub,  //112
PQ_IP_VIP_HNMR_Y_Sub,  //113
PQ_IP_VIP_HNMR_C_Sub,  //114
PQ_IP_VIP_HNMR_ad_C_Sub,  //115
PQ_IP_VIP_HNMR_ad_C_gain_Sub,  //116
PQ_IP_VIP_HNMR_C_win1_Sub,  //117
PQ_IP_VIP_HNMR_C_win2_Sub,  //118
PQ_IP_VIP_Pre_Yoffset_Sub,  //119
PQ_IP_VIP_Pre_Ygain_Sub,  //120
PQ_IP_VIP_Pre_Ygain_dither_Sub,  //121
PQ_IP_VIP_HLPF_Sub,  //122
PQ_IP_VIP_HLPF_dither_Sub,  //123
PQ_IP_VIP_VNMR_Sub,  //124
PQ_IP_VIP_VNMR_dither_Sub,  //125
PQ_IP_VIP_VLPF_coef1_Sub,  //126
PQ_IP_VIP_VLPF_coef2_Sub,  //127
PQ_IP_VIP_VLPF_dither_Sub,  //128
PQ_IP_VIP_EE_Sub,  //129
PQ_IP_VIP_Peaking_Sub,  //130
PQ_IP_VIP_Peaking_band_Sub,  //131
PQ_IP_VIP_Peaking_dering_Sub,  //132
PQ_IP_VIP_Peaking_V_dering_Sub,  //133
PQ_IP_VIP_Peaking_V_dering_VDR1_Sub,  //134
PQ_IP_VIP_Peaking_V_dering_VDR2_Sub,  //135
PQ_IP_VIP_Peaking_Pcoring_Sub,  //136
PQ_IP_VIP_Peaking_gain_Sub,  //137
PQ_IP_VIP_Peaking_gain_ad_C_Sub,  //138
PQ_IP_VIP_Peaking_gain_ad_Y_Sub,  //139
PQ_IP_VIP_LTI_Sub,  //140
PQ_IP_VIP_LTI_Loc_Sub,  //141
PQ_IP_VIP_LTI_band_Sub,  //142
PQ_IP_VIP_LTI_dering_Sub,  //143
PQ_IP_VIP_LTI_Pcoring_Sub,  //144
PQ_IP_VIP_LTI_gain_Sub,  //145
PQ_IP_VIP_LTI_alpha_MIN_Sub,  //146
PQ_IP_VIP_LTI_alpha_fix_Sub,  //147
PQ_IP_VIP_Post_SNR_Sub,  //148
PQ_IP_VIP_Post_CTI_Sub,  //149
PQ_IP_VIP_Post_CTI_coef_Sub,  //150
PQ_IP_VIP_Post_CTI_gray_Sub,  //151
PQ_IP_VIP_FCC_full_range_Sub,  //152
PQ_IP_VIP_FCC_T1_Sub,  //153
PQ_IP_VIP_FCC_T2_Sub,  //154
PQ_IP_VIP_FCC_T3_Sub,  //155
PQ_IP_VIP_FCC_T4_Sub,  //156
PQ_IP_VIP_FCC_T5_Sub,  //157
PQ_IP_VIP_FCC_T6_Sub,  //158
PQ_IP_VIP_FCC_T7_Sub,  //159
PQ_IP_VIP_FCC_T8_Sub,  //160
PQ_IP_VIP_FCC_T9_Sub,  //161
PQ_IP_VIP_IHC_Sub,  //162
PQ_IP_VIP_IHC_Ymode_Sub,  //163
PQ_IP_VIP_IHC_dither_Sub,  //164
PQ_IP_VIP_IHC_CRD_SRAM_Sub,  //165
PQ_IP_VIP_IHC_SETTING_Sub,  //166
PQ_IP_VIP_ICC_Sub,  //167
PQ_IP_VIP_ICC_Ymode_Sub,  //168
PQ_IP_VIP_ICC_dither_Sub,  //169
PQ_IP_VIP_ICC_CRD_SRAM_Sub,  //170
PQ_IP_VIP_ICC_SETTING_Sub,  //171
PQ_IP_VIP_Ymode_Yvalue_ALL_Sub,  //172
PQ_IP_VIP_Ymode_Yvalue_SETTING_Sub,  //173
PQ_IP_VIP_IBC_Sub,  //174
PQ_IP_VIP_IBC_dither_Sub,  //175
PQ_IP_VIP_IBC_SETTING_Sub,  //176
PQ_IP_VIP_LCE_Sub,  //177
PQ_IP_VIP_LCE_dither_Sub,  //178
PQ_IP_VIP_LCE_setting_Sub,  //179
PQ_IP_VIP_LCE_ad_C_Sub,  //180
PQ_IP_VIP_LCE_curve_Sub,  //181
PQ_IP_VIP_DLC_Sub,  //182
PQ_IP_VIP_DLC_ad_C_Sub,  //183
PQ_IP_VIP_DLC_dither_Sub,  //184
PQ_IP_VIP_DLC_His_range_Sub,  //185
PQ_IP_VIP_DLC_His_rangeH_Sub,  //186
PQ_IP_VIP_DLC_His_rangeV_Sub,  //187
PQ_IP_VIP_DLC_PC_Sub,  //188
PQ_IP_VIP_BLE_Sub,  //189
PQ_IP_VIP_WLE_Sub,  //190
PQ_IP_VIP_BWLE_dither_Sub,  //191
PQ_IP_VIP_UVC_Sub,  //192
PQ_IP_VIP_Post_Yoffset_Sub,  //193
PQ_IP_VIP_Post_Ygain_Sub,  //194
PQ_IP_VIP_Post_Yoffset_2_Sub,  //195
PQ_IP_VIP_Post_Cgain_Sub,  //196
PQ_IP_VIP_Post_Cgain_by_Y_Sub,  //197
PQ_IP_VIP_Hcoring_Y_Sub,  //198
PQ_IP_VIP_Hcoring_C_Sub,  //199
PQ_IP_VIP_Hcoring_dither_Sub,  //200
PQ_IP_VIP_YCbCr_Clip_Sub,  //201
PQ_IP_SR_H_Peaking_Sub,  //202
PQ_IP_SR_V_Peaking_Sub,  //203
PQ_IP_SR_D_Peaking_Sub,  //204
PQ_IP_SR_Dering_Sub,  //205
PQ_IP_SR_V_Dering_Sub,  //206
PQ_IP_SR_Adaptive_Y_Peaking_Sub,  //207
PQ_IP_SR_User_Sharpness_Sub,  //208
PQ_IP_SR_LTI_Sub,  //209
PQ_IP_SR_EE_Sub,  //210
PQ_IP_SR_NoiseMasking_Sub,  //211
PQ_IP_SR_DS_Sub,  //212
PQ_IP_SR_AA_Sub,  //213
PQ_IP_SwDriver_Sub,  //214
PQ_IP_3x3_Sub,  //215
PQ_IP_RGB_Offset_Sub,  //216
PQ_IP_RGB_Clip_Sub,  //217
PQ_IP_xvYCC_bypass_Sub,  //218
PQ_IP_xvYCC_de_gamma_Sub,  //219
PQ_IP_xvYCC_de_gamma_dither_Sub,  //220
PQ_IP_xvYCC_3x3_Sub,  //221
PQ_IP_xvYCC_Comp_Sub,  //222
PQ_IP_xvYCC_Comp_dither_Sub,  //223
PQ_IP_xvYCC_Clip_Sub,  //224
PQ_IP_xvYCC_gamma_Sub,  //225
PQ_IP_xvYCC_gamma_dither_Sub,  //226
PQ_IP_rgb_3d_Sub,  //227
PQ_IP_HBC_Sub,  //228
PQ_IP_Pre_CON_BRI_Sub,  //229
PQ_IP_Blue_Stretch_Sub,  //230
PQ_IP_Blue_Stretch_dither_Sub,  //231
PQ_IP_Gamma_Sub,  //232
PQ_IP_Gamma_dither_Sub,  //233
PQ_IP_Post_CON_BRI_Sub,  //234
PQ_IP_PQ_ByPass_Sub,  //235
 }   PQ_IPTYPE_Sub;

typedef enum
{
PQ_IP_ADC_Sampling_COM_Sub,  //0
PQ_IP_SCinit_COM_Sub,  //1
PQ_IP_CSC_COM_Sub,  //2
PQ_IP_CSC_Dither_COM_Sub,  //3
PQ_IP_YCdelay_COM_Sub,  //4
PQ_IP_PreFilter_COM_Sub,  //5
PQ_IP_PreFilter_Dither_COM_Sub,  //6
PQ_IP_HDSDD_COM_Sub,  //7
PQ_IP_HSD_Sampling_COM_Sub,  //8
PQ_IP_HSD_Y_COM_Sub,  //9
PQ_IP_HSD_C_COM_Sub,  //10
PQ_IP_444To422_COM_Sub,  //11
PQ_IP_VSD_COM_Sub,  //12
PQ_IP_HVSD_Dither_COM_Sub,  //13
PQ_IP_10to8_Dither_COM_Sub,  //14
PQ_IP_MemFormat_COM_Sub,  //15
PQ_IP_PreSNR_COM_Sub,  //16
PQ_IP_PreSNR_Patch_COM_Sub,  //17
PQ_IP_DNR_COM_Sub,  //18
PQ_IP_DNR_Motion_COM_Sub,  //19
PQ_IP_DNR_Y_COM_Sub,  //20
PQ_IP_DNR_Y_COLOR_DEP_COM_Sub,  //21
PQ_IP_SRAM_COLOR_INDEX_COM_Sub,  //22
PQ_IP_SRAM_COLOR_GAIN_SNR_COM_Sub,  //23
PQ_IP_SRAM_COLOR_GAIN_DNR_COM_Sub,  //24
PQ_IP_DNR_Y_LUMA_ADAPTIVE_COM_Sub,  //25
PQ_IP_DNR_POSTTUNE_COM_Sub,  //26
PQ_IP_DNR_C_COM_Sub,  //27
PQ_IP_PNR_COM_Sub,  //28
PQ_IP_PNR_Y_COM_Sub,  //29
PQ_IP_PNR_C_COM_Sub,  //30
PQ_IP_PostCCS_COM_Sub,  //31
PQ_IP_PostCCS_NP_COM_Sub,  //32
PQ_IP_DHD_COM_Sub,  //33
PQ_IP_420CUP_COM_Sub,  //34
PQ_IP_MADi_COM_Sub,  //35
PQ_IP_MADi_Motion_COM_Sub,  //36
PQ_IP_MADi_MORPHO_COM_Sub,  //37
PQ_IP_MADi_DFK_COM_Sub,  //38
PQ_IP_MADi_SST_COM_Sub,  //39
PQ_IP_MADi_EODiW_COM_Sub,  //40
PQ_IP_MADi_Force_COM_Sub,  //41
PQ_IP_EODi_COM_Sub,  //42
PQ_IP_EODi_Armored_COM_Sub,  //43
PQ_IP_EODi_Armored_KFC_COM_Sub,  //44
PQ_IP_EODi_Armored_UCDi_COM_Sub,  //45
PQ_IP_Film_COM_Sub,  //46
PQ_IP_Film32_COM_Sub,  //47
PQ_IP_Film22_COM_Sub,  //48
PQ_IP_Film_any_COM_Sub,  //49
PQ_IP_UCNR_COM_Sub,  //50
PQ_IP_UCDi_COM_Sub,  //51
PQ_IP_UC_CTL_COM_Sub,  //52
PQ_IP_DIPF_COM_Sub,  //53
PQ_IP_SPF_COM_Sub,  //54
PQ_IP_VCLPF_COM_Sub,  //55
PQ_IP_Spike_NR_COM_Sub,  //56
PQ_IP_SPF_DBK_COM_Sub,  //57
PQ_IP_SPF_DBK_BKN_COM_Sub,  //58
PQ_IP_SPF_DBK_MR_COM_Sub,  //59
PQ_IP_SPF_DBK_HDE_COM_Sub,  //60
PQ_IP_SPF_DBK_C_COM_Sub,  //61
PQ_IP_SPF_VDBK_COM_Sub,  //62
PQ_IP_SPF_SNR_COM_Sub,  //63
PQ_IP_SPF_SNR_MR_COM_Sub,  //64
PQ_IP_SPF_MR_LPF_COM_Sub,  //65
PQ_IP_SPF_NMR_Y_COM_Sub,  //66
PQ_IP_SPF_NMR_Y_MR_COM_Sub,  //67
PQ_IP_SPF_NMR_C_COM_Sub,  //68
PQ_IP_DMS_COM_Sub,  //69
PQ_IP_DMS_H_COM_Sub,  //70
PQ_IP_DMS_V_COM_Sub,  //71
PQ_IP_DMS_V_12L_COM_Sub,  //72
PQ_IP_DS_COM_Sub,  //73
PQ_IP_DS_90_COM_Sub,  //74
PQ_IP_DS_21_COM_Sub,  //75
PQ_IP_DS_11_COM_Sub,  //76
PQ_IP_DS_12_COM_Sub,  //77
PQ_IP_DS_180_COM_Sub,  //78
PQ_IP_DS_C0_COM_Sub,  //79
PQ_IP_DS_C1_COM_Sub,  //80
PQ_IP_DS_C2_COM_Sub,  //81
PQ_IP_DS_C13_COM_Sub,  //82
PQ_IP_DS_C14_COM_Sub,  //83
PQ_IP_DS_C15_COM_Sub,  //84
PQ_IP_VSP_Y_COM_Sub,  //85
PQ_IP_VSP_C_COM_Sub,  //86
PQ_IP_VSP_CoRing_COM_Sub,  //87
PQ_IP_VSP_DeRing_COM_Sub,  //88
PQ_IP_VSP_Dither_COM_Sub,  //89
PQ_IP_VSP_PreVBound_COM_Sub,  //90
PQ_IP_AntiPAL_filter_COM_Sub,  //91
PQ_IP_422To444_COM_Sub,  //92
PQ_IP_PreCTI_COM_Sub,  //93
PQ_IP_HSP_Y_COM_Sub,  //94
PQ_IP_HSP_C_COM_Sub,  //95
PQ_IP_HSP_CoRing_COM_Sub,  //96
PQ_IP_HSP_DeRing_COM_Sub,  //97
PQ_IP_HSP_Dither_COM_Sub,  //98
PQ_IP_HnonLinear_COM_Sub,  //99
PQ_IP_SRAM1_COM_Sub,  //100
PQ_IP_SRAM2_COM_Sub,  //101
PQ_IP_SRAM3_COM_Sub,  //102
PQ_IP_SRAM4_COM_Sub,  //103
PQ_IP_C_SRAM1_COM_Sub,  //104
PQ_IP_C_SRAM2_COM_Sub,  //105
PQ_IP_C_SRAM3_COM_Sub,  //106
PQ_IP_C_SRAM4_COM_Sub,  //107
PQ_IP_VIP_COM_Sub,  //108
PQ_IP_VIP_pseudo_COM_Sub,  //109
PQ_IP_VIP_CSC_COM_Sub,  //110
PQ_IP_VIP_CSC_dither_COM_Sub,  //111
PQ_IP_VIP_Post_YC_delay_COM_Sub,  //112
PQ_IP_VIP_HNMR_Y_COM_Sub,  //113
PQ_IP_VIP_HNMR_C_COM_Sub,  //114
PQ_IP_VIP_HNMR_ad_C_COM_Sub,  //115
PQ_IP_VIP_HNMR_ad_C_gain_COM_Sub,  //116
PQ_IP_VIP_HNMR_C_win1_COM_Sub,  //117
PQ_IP_VIP_HNMR_C_win2_COM_Sub,  //118
PQ_IP_VIP_Pre_Yoffset_COM_Sub,  //119
PQ_IP_VIP_Pre_Ygain_COM_Sub,  //120
PQ_IP_VIP_Pre_Ygain_dither_COM_Sub,  //121
PQ_IP_VIP_HLPF_COM_Sub,  //122
PQ_IP_VIP_HLPF_dither_COM_Sub,  //123
PQ_IP_VIP_VNMR_COM_Sub,  //124
PQ_IP_VIP_VNMR_dither_COM_Sub,  //125
PQ_IP_VIP_VLPF_coef1_COM_Sub,  //126
PQ_IP_VIP_VLPF_coef2_COM_Sub,  //127
PQ_IP_VIP_VLPF_dither_COM_Sub,  //128
PQ_IP_VIP_EE_COM_Sub,  //129
PQ_IP_VIP_Peaking_COM_Sub,  //130
PQ_IP_VIP_Peaking_band_COM_Sub,  //131
PQ_IP_VIP_Peaking_dering_COM_Sub,  //132
PQ_IP_VIP_Peaking_V_dering_COM_Sub,  //133
PQ_IP_VIP_Peaking_V_dering_VDR1_COM_Sub,  //134
PQ_IP_VIP_Peaking_V_dering_VDR2_COM_Sub,  //135
PQ_IP_VIP_Peaking_Pcoring_COM_Sub,  //136
PQ_IP_VIP_Peaking_gain_COM_Sub,  //137
PQ_IP_VIP_Peaking_gain_ad_C_COM_Sub,  //138
PQ_IP_VIP_Peaking_gain_ad_Y_COM_Sub,  //139
PQ_IP_VIP_LTI_COM_Sub,  //140
PQ_IP_VIP_LTI_Loc_COM_Sub,  //141
PQ_IP_VIP_LTI_band_COM_Sub,  //142
PQ_IP_VIP_LTI_dering_COM_Sub,  //143
PQ_IP_VIP_LTI_Pcoring_COM_Sub,  //144
PQ_IP_VIP_LTI_gain_COM_Sub,  //145
PQ_IP_VIP_LTI_alpha_MIN_COM_Sub,  //146
PQ_IP_VIP_LTI_alpha_fix_COM_Sub,  //147
PQ_IP_VIP_Post_SNR_COM_Sub,  //148
PQ_IP_VIP_Post_CTI_COM_Sub,  //149
PQ_IP_VIP_Post_CTI_coef_COM_Sub,  //150
PQ_IP_VIP_Post_CTI_gray_COM_Sub,  //151
PQ_IP_VIP_FCC_full_range_COM_Sub,  //152
PQ_IP_VIP_FCC_T1_COM_Sub,  //153
PQ_IP_VIP_FCC_T2_COM_Sub,  //154
PQ_IP_VIP_FCC_T3_COM_Sub,  //155
PQ_IP_VIP_FCC_T4_COM_Sub,  //156
PQ_IP_VIP_FCC_T5_COM_Sub,  //157
PQ_IP_VIP_FCC_T6_COM_Sub,  //158
PQ_IP_VIP_FCC_T7_COM_Sub,  //159
PQ_IP_VIP_FCC_T8_COM_Sub,  //160
PQ_IP_VIP_FCC_T9_COM_Sub,  //161
PQ_IP_VIP_IHC_COM_Sub,  //162
PQ_IP_VIP_IHC_Ymode_COM_Sub,  //163
PQ_IP_VIP_IHC_dither_COM_Sub,  //164
PQ_IP_VIP_IHC_CRD_SRAM_COM_Sub,  //165
PQ_IP_VIP_IHC_SETTING_COM_Sub,  //166
PQ_IP_VIP_ICC_COM_Sub,  //167
PQ_IP_VIP_ICC_Ymode_COM_Sub,  //168
PQ_IP_VIP_ICC_dither_COM_Sub,  //169
PQ_IP_VIP_ICC_CRD_SRAM_COM_Sub,  //170
PQ_IP_VIP_ICC_SETTING_COM_Sub,  //171
PQ_IP_VIP_Ymode_Yvalue_ALL_COM_Sub,  //172
PQ_IP_VIP_Ymode_Yvalue_SETTING_COM_Sub,  //173
PQ_IP_VIP_IBC_COM_Sub,  //174
PQ_IP_VIP_IBC_dither_COM_Sub,  //175
PQ_IP_VIP_IBC_SETTING_COM_Sub,  //176
PQ_IP_VIP_LCE_COM_Sub,  //177
PQ_IP_VIP_LCE_dither_COM_Sub,  //178
PQ_IP_VIP_LCE_setting_COM_Sub,  //179
PQ_IP_VIP_LCE_ad_C_COM_Sub,  //180
PQ_IP_VIP_LCE_curve_COM_Sub,  //181
PQ_IP_VIP_DLC_COM_Sub,  //182
PQ_IP_VIP_DLC_ad_C_COM_Sub,  //183
PQ_IP_VIP_DLC_dither_COM_Sub,  //184
PQ_IP_VIP_DLC_His_range_COM_Sub,  //185
PQ_IP_VIP_DLC_His_rangeH_COM_Sub,  //186
PQ_IP_VIP_DLC_His_rangeV_COM_Sub,  //187
PQ_IP_VIP_DLC_PC_COM_Sub,  //188
PQ_IP_VIP_BLE_COM_Sub,  //189
PQ_IP_VIP_WLE_COM_Sub,  //190
PQ_IP_VIP_BWLE_dither_COM_Sub,  //191
PQ_IP_VIP_UVC_COM_Sub,  //192
PQ_IP_VIP_Post_Yoffset_COM_Sub,  //193
PQ_IP_VIP_Post_Ygain_COM_Sub,  //194
PQ_IP_VIP_Post_Yoffset_2_COM_Sub,  //195
PQ_IP_VIP_Post_Cgain_COM_Sub,  //196
PQ_IP_VIP_Post_Cgain_by_Y_COM_Sub,  //197
PQ_IP_VIP_Hcoring_Y_COM_Sub,  //198
PQ_IP_VIP_Hcoring_C_COM_Sub,  //199
PQ_IP_VIP_Hcoring_dither_COM_Sub,  //200
PQ_IP_VIP_YCbCr_Clip_COM_Sub,  //201
PQ_IP_SR_H_Peaking_COM_Sub,  //202
PQ_IP_SR_V_Peaking_COM_Sub,  //203
PQ_IP_SR_D_Peaking_COM_Sub,  //204
PQ_IP_SR_Dering_COM_Sub,  //205
PQ_IP_SR_V_Dering_COM_Sub,  //206
PQ_IP_SR_Adaptive_Y_Peaking_COM_Sub,  //207
PQ_IP_SR_User_Sharpness_COM_Sub,  //208
PQ_IP_SR_LTI_COM_Sub,  //209
PQ_IP_SR_EE_COM_Sub,  //210
PQ_IP_SR_NoiseMasking_COM_Sub,  //211
PQ_IP_SR_DS_COM_Sub,  //212
PQ_IP_SR_AA_COM_Sub,  //213
PQ_IP_SwDriver_COM_Sub,  //214
PQ_IP_3x3_COM_Sub,  //215
PQ_IP_RGB_Offset_COM_Sub,  //216
PQ_IP_RGB_Clip_COM_Sub,  //217
PQ_IP_xvYCC_bypass_COM_Sub,  //218
PQ_IP_xvYCC_de_gamma_COM_Sub,  //219
PQ_IP_xvYCC_de_gamma_dither_COM_Sub,  //220
PQ_IP_xvYCC_3x3_COM_Sub,  //221
PQ_IP_xvYCC_Comp_COM_Sub,  //222
PQ_IP_xvYCC_Comp_dither_COM_Sub,  //223
PQ_IP_xvYCC_Clip_COM_Sub,  //224
PQ_IP_xvYCC_gamma_COM_Sub,  //225
PQ_IP_xvYCC_gamma_dither_COM_Sub,  //226
PQ_IP_rgb_3d_COM_Sub,  //227
PQ_IP_HBC_COM_Sub,  //228
PQ_IP_Pre_CON_BRI_COM_Sub,  //229
PQ_IP_Blue_Stretch_COM_Sub,  //230
PQ_IP_Blue_Stretch_dither_COM_Sub,  //231
PQ_IP_Gamma_COM_Sub,  //232
PQ_IP_Gamma_dither_COM_Sub,  //233
PQ_IP_Post_CON_BRI_COM_Sub,  //234
PQ_IP_PQ_ByPass_COM_Sub,  //235
PQ_IP_COM_NUMS_Sub
} PQ_IP_COM_Group_Sub;
...
typedef enum
{
PQ_IP_PostCCS_NP_OFF_Sub,
PQ_IP_PostCCS_NP_PAL_Sub,
PQ_IP_PostCCS_NP_NTSC_Sub,
PQ_IP_PostCCS_NP_NUMS_Sub
} PQ_IP_PostCCS_NP_Group_Sub;

typedef enum
{
PQ_IP_DHD_OFF_Sub,
PQ_IP_DHD_VD_6R_0_Sub,
PQ_IP_DHD_VD_6R_1_Sub,
PQ_IP_DHD_VD_6R_2_Sub,
PQ_IP_DHD_VD_6R_3_Sub,
PQ_IP_DHD_VD_6R_4_Sub,
PQ_IP_DHD_VD_6R_5_Sub,
PQ_IP_DHD_VD_8R_0_Sub,
PQ_IP_DHD_VD_8R_1_Sub,
PQ_IP_DHD_VD_8R_2_Sub,
PQ_IP_DHD_VD_8R_3_Sub,
PQ_IP_DHD_VD_8R_4_Sub,
PQ_IP_DHD_VD_8R_5_Sub,
PQ_IP_DHD_HDMI_6R_0_Sub,
PQ_IP_DHD_HDMI_6R_1_Sub,
PQ_IP_DHD_HDMI_6R_2_Sub,
PQ_IP_DHD_HDMI_6R_3_Sub,
PQ_IP_DHD_HDMI_6R_4_Sub,
PQ_IP_DHD_HDMI_6R_5_Sub,
PQ_IP_DHD_HDMI_8R_0_Sub,
PQ_IP_DHD_HDMI_8R_1_Sub,
PQ_IP_DHD_HDMI_8R_2_Sub,
PQ_IP_DHD_HDMI_8R_3_Sub,
PQ_IP_DHD_HDMI_8R_4_Sub,
PQ_IP_DHD_HDMI_8R_5_Sub,
PQ_IP_DHD_YPbPr_6R_1_Sub,
PQ_IP_DHD_NUMS_Sub
} PQ_IP_DHD_Group_Sub;
...
PQ_IP_MADi_25_6R_Sub,
PQ_IP_MADi_25_14F_6R_Sub,
PQ_IP_MADi_25_12F_8R_MC_Sub,
PQ_IP_MADi_25_12F_8R_Sub,
PQ_IP_MADi_25_14F_8R_MC_Sub,
PQ_IP_MADi_25_14F_8R_NW_Sub,
PQ_IP_MADi_25_14F_8R_Sub,
PQ_IP_MADi_25_16F_8R_MC_Sub,
PQ_IP_MADi_25_16F_8R_Sub,
...
typedef enum
{
PQ_IP_EODi_Armored_OFF_Sub,
PQ_IP_EODi_Armored_NUMS_Sub
} PQ_IP_EODi_Armored_Group_Sub;

typedef enum
{
PQ_IP_EODi_Armored_KFC_OFF_Sub,
PQ_IP_EODi_Armored_KFC_EAK1_Sub,
PQ_IP_EODi_Armored_KFC_NUMS_Sub
} PQ_IP_EODi_Armored_KFC_Group_Sub;

typedef enum
{
PQ_IP_EODi_Armored_UCDi_OFF_Sub,
PQ_IP_EODi_Armored_UCDi_EAU1_Sub,
PQ_IP_EODi_Armored_UCDi_NUMS_Sub
} PQ_IP_EODi_Armored_UCDi_Group_Sub;
...
typedef enum
{
PQ_IP_SPF_DBK_HDE_OFF_Sub,
PQ_IP_SPF_DBK_HDE_HD_Sub,
PQ_IP_SPF_DBK_HDE_NUMS_Sub
} PQ_IP_SPF_DBK_HDE_Group_Sub;

typedef enum
{
PQ_IP_SPF_DBK_C_OFF_Sub,
PQ_IP_SPF_DBK_C_ON_Sub,
PQ_IP_SPF_DBK_C_NUMS_Sub
} PQ_IP_SPF_DBK_C_Group_Sub;

typedef enum
{
PQ_IP_SPF_VDBK_OFF_Sub,
PQ_IP_SPF_VDBK_NUMS_Sub
} PQ_IP_SPF_VDBK_Group_Sub;
...
{
PQ_IP_DS_90_OFF_Sub,
PQ_IP_DS_90_NUMS_Sub
} PQ_IP_DS_90_Group_Sub;

typedef enum
{
PQ_IP_DS_21_OFF_Sub,
PQ_IP_DS_21_NUMS_Sub
} PQ_IP_DS_21_Group_Sub;

typedef enum
{
PQ_IP_DS_11_OFF_Sub,
PQ_IP_DS_11_NUMS_Sub
} PQ_IP_DS_11_Group_Sub;

typedef enum
{
PQ_IP_DS_12_OFF_Sub,
PQ_IP_DS_12_NUMS_Sub
} PQ_IP_DS_12_Group_Sub;

typedef enum
{
PQ_IP_DS_180_OFF_Sub,
PQ_IP_DS_180_NUMS_Sub
} PQ_IP_DS_180_Group_Sub;

typedef enum
{
PQ_IP_DS_C0_OFF_Sub,
PQ_IP_DS_C0_NUMS_Sub
} PQ_IP_DS_C0_Group_Sub;

typedef enum
{
PQ_IP_DS_C1_OFF_Sub,
PQ_IP_DS_C1_NUMS_Sub
} PQ_IP_DS_C1_Group_Sub;

typedef enum
{
PQ_IP_DS_C2_OFF_Sub,
PQ_IP_DS_C2_NUMS_Sub
} PQ_IP_DS_C2_Group_Sub;

typedef enum
{
PQ_IP_DS_C13_OFF_Sub,
PQ_IP_DS_C13_NUMS_Sub
} PQ_IP_DS_C13_Group_Sub;

typedef enum
{
PQ_IP_DS_C14_OFF_Sub,
PQ_IP_DS_C14_NUMS_Sub
} PQ_IP_DS_C14_Group_Sub;

typedef enum
{
PQ_IP_DS_C15_OFF_Sub,
PQ_IP_DS_C15_NUMS_Sub
} PQ_IP_DS_C15_Group_Sub;
...
typedef enum
{
PQ_IP_AntiPAL_filter_OFF_Sub,
PQ_IP_AntiPAL_filter_PAL_0_Sub,
PQ_IP_AntiPAL_filter_PAL_1_Sub,
PQ_IP_AntiPAL_filter_PAL_2_Sub,
PQ_IP_AntiPAL_filter_PAL_3_Sub,
PQ_IP_AntiPAL_filter_PAL_4_Sub,
PQ_IP_AntiPAL_filter_PAL_5_Sub,
PQ_IP_AntiPAL_filter_NUMS_Sub
} PQ_IP_AntiPAL_filter_Group_Sub;
...
PQ_IP_VIP_CSC_601_RGB2YCC_709_Sub,
...
PQ_IP_VIP_Pre_Ygain_0x420_Sub,
PQ_IP_VIP_Pre_Ygain_0x428_Sub,
PQ_IP_VIP_Pre_Ygain_0x4A0_Sub,
PQ_IP_VIP_Pre_Ygain_0x4AC_Sub,
...
typedef enum
{
PQ_IP_VIP_VNMR_OFF_Sub,
PQ_IP_VIP_VNMR_S1_Sub,
PQ_IP_VIP_VNMR_S2_Sub,
PQ_IP_VIP_VNMR_S3_Sub,
PQ_IP_VIP_VNMR_NUMS_Sub
} PQ_IP_VIP_VNMR_Group_Sub;

typedef enum
{
PQ_IP_VIP_VNMR_dither_OFF_Sub,
PQ_IP_VIP_VNMR_dither_ON_Sub,
PQ_IP_VIP_VNMR_dither_NUMS_Sub
} PQ_IP_VIP_VNMR_dither_Group_Sub;

typedef enum
{
PQ_IP_VIP_VLPF_coef1_OFF_Sub,
PQ_IP_VIP_VLPF_coef1_0x1_Sub,
PQ_IP_VIP_VLPF_coef1_0x2_Sub,
PQ_IP_VIP_VLPF_coef1_0x3_Sub,
PQ_IP_VIP_VLPF_coef1_0x4_Sub,
PQ_IP_VIP_VLPF_coef1_0x5_Sub,
PQ_IP_VIP_VLPF_coef1_0x6_Sub,
PQ_IP_VIP_VLPF_coef1_0x7_Sub,
PQ_IP_VIP_VLPF_coef1_NUMS_Sub
} PQ_IP_VIP_VLPF_coef1_Group_Sub;

typedef enum
{
PQ_IP_VIP_VLPF_coef2_OFF_Sub,
PQ_IP_VIP_VLPF_coef2_0x1_Sub,
PQ_IP_VIP_VLPF_coef2_0x2_Sub,
PQ_IP_VIP_VLPF_coef2_0x3_Sub,
PQ_IP_VIP_VLPF_coef2_0x4_Sub,
PQ_IP_VIP_VLPF_coef2_0x5_Sub,
PQ_IP_VIP_VLPF_coef2_0x6_Sub,
PQ_IP_VIP_VLPF_coef2_0x7_Sub,
PQ_IP_VIP_VLPF_coef2_NUMS_Sub
} PQ_IP_VIP_VLPF_coef2_Group_Sub;

typedef enum
{
PQ_IP_VIP_VLPF_dither_OFF_Sub,
PQ_IP_VIP_VLPF_dither_NUMS_Sub
} PQ_IP_VIP_VLPF_dither_Group_Sub;

typedef enum
{
PQ_IP_VIP_EE_OFF_Sub,
PQ_IP_VIP_EE_S2_Sub,
PQ_IP_VIP_EE_NUMS_Sub
} PQ_IP_VIP_EE_Group_Sub;
...
typedef enum
{
PQ_IP_VIP_Peaking_dering_OFF_Sub,
PQ_IP_VIP_Peaking_dering_W1_R0_Sub,
PQ_IP_VIP_Peaking_dering_NUMS_Sub
} PQ_IP_VIP_Peaking_dering_Group_Sub;

typedef enum
{
PQ_IP_VIP_Peaking_V_dering_OFF_Sub,
PQ_IP_VIP_Peaking_V_dering_0x07_Sub,
PQ_IP_VIP_Peaking_V_dering_NUMS_Sub
} PQ_IP_VIP_Peaking_V_dering_Group_Sub;

typedef enum
{
PQ_IP_VIP_Peaking_V_dering_VDR1_OFF_Sub,
PQ_IP_VIP_Peaking_V_dering_VDR1_VDR1_1_Sub,
PQ_IP_VIP_Peaking_V_dering_VDR1_VDR1_2_Sub,
PQ_IP_VIP_Peaking_V_dering_VDR1_NUMS_Sub
} PQ_IP_VIP_Peaking_V_dering_VDR1_Group_Sub;

typedef enum
{
PQ_IP_VIP_Peaking_V_dering_VDR2_OFF_Sub,
PQ_IP_VIP_Peaking_V_dering_VDR2_VDR2_1_Sub,
PQ_IP_VIP_Peaking_V_dering_VDR2_NUMS_Sub
} PQ_IP_VIP_Peaking_V_dering_VDR2_Group_Sub;
...
PQ_IP_VIP_Peaking_gain_ad_C_T1_Sub,
PQ_IP_VIP_Peaking_gain_ad_C_T2_Sub,
PQ_IP_VIP_Peaking_gain_ad_C_T3_Sub,
PQ_IP_VIP_Peaking_gain_ad_C_T4_Sub,
PQ_IP_VIP_Peaking_gain_ad_C_T5_Sub,
PQ_IP_VIP_Peaking_gain_ad_C_T6_Sub,
PQ_IP_VIP_Peaking_gain_ad_C_NUMS_Sub
} PQ_IP_VIP_Peaking_gain_ad_C_Group_Sub;

typedef enum
{
PQ_IP_VIP_Peaking_gain_ad_Y_OFF_Sub,
PQ_IP_VIP_Peaking_gain_ad_Y_T2_Sub,
PQ_IP_VIP_Peaking_gain_ad_Y_NUMS_Sub
} PQ_IP_VIP_Peaking_gain_ad_Y_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_OFF_Sub,
PQ_IP_VIP_LTI_ON_Sub,
PQ_IP_VIP_LTI_NUMS_Sub
} PQ_IP_VIP_LTI_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_Loc_OFF_Sub,
PQ_IP_VIP_LTI_Loc_NUMS_Sub
} PQ_IP_VIP_LTI_Loc_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_band_RF_NTSC_Sub,
PQ_IP_VIP_LTI_band_NUMS_Sub
} PQ_IP_VIP_LTI_band_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_dering_OFF_Sub,
PQ_IP_VIP_LTI_dering_W3_R0_Sub,
PQ_IP_VIP_LTI_dering_NUMS_Sub
} PQ_IP_VIP_LTI_dering_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_Pcoring_S00_Sub,
PQ_IP_VIP_LTI_Pcoring_S0f_Sub,
PQ_IP_VIP_LTI_Pcoring_NUMS_Sub
} PQ_IP_VIP_LTI_Pcoring_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_gain_0x0F_Sub,
PQ_IP_VIP_LTI_gain_0x0A_Sub,
PQ_IP_VIP_LTI_gain_NUMS_Sub
} PQ_IP_VIP_LTI_gain_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_alpha_MIN_OFF_Sub,
PQ_IP_VIP_LTI_alpha_MIN_m1_Sub,
PQ_IP_VIP_LTI_alpha_MIN_m2_Sub,
PQ_IP_VIP_LTI_alpha_MIN_NUMS_Sub
} PQ_IP_VIP_LTI_alpha_MIN_Group_Sub;

typedef enum
{
PQ_IP_VIP_LTI_alpha_fix_OFF_Sub,
PQ_IP_VIP_LTI_alpha_fix_0x42_Sub,
PQ_IP_VIP_LTI_alpha_fix_NUMS_Sub
} PQ_IP_VIP_LTI_alpha_fix_Group_Sub;

typedef enum
{
PQ_IP_VIP_Post_SNR_OFF_Sub,
PQ_IP_VIP_Post_SNR_S1_Sub,
PQ_IP_VIP_Post_SNR_S2_Sub,
PQ_IP_VIP_Post_SNR_S3_Sub,
PQ_IP_VIP_Post_SNR_S4_Sub,
PQ_IP_VIP_Post_SNR_S5_Sub,
PQ_IP_VIP_Post_SNR_S6_Sub,
PQ_IP_VIP_Post_SNR_S7_Sub,
PQ_IP_VIP_Post_SNR_S8_Sub,
PQ_IP_VIP_Post_SNR_S9_Sub,
PQ_IP_VIP_Post_SNR_NUMS_Sub
} PQ_IP_VIP_Post_SNR_Group_Sub;
...
typedef enum
{
PQ_IP_VIP_LCE_OFF_Sub,
PQ_IP_VIP_LCE_ON_Sub,
PQ_IP_VIP_LCE_NUMS_Sub
} PQ_IP_VIP_LCE_Group_Sub;

typedef enum
{
PQ_IP_VIP_LCE_dither_OFF_Sub,
PQ_IP_VIP_LCE_dither_NUMS_Sub
} PQ_IP_VIP_LCE_dither_Group_Sub;

typedef enum
{
PQ_IP_VIP_LCE_setting_S1_Sub,
PQ_IP_VIP_LCE_setting_NUMS_Sub
} PQ_IP_VIP_LCE_setting_Group_Sub;

typedef enum
{
PQ_IP_VIP_LCE_ad_C_C1_Sub,
PQ_IP_VIP_LCE_ad_C_NUMS_Sub
} PQ_IP_VIP_LCE_ad_C_Group_Sub;

typedef enum
{
PQ_IP_VIP_LCE_curve_CV1_Sub,
PQ_IP_VIP_LCE_curve_NUMS_Sub
} PQ_IP_VIP_LCE_curve_Group_Sub;
...
typedef enum
{
PQ_IP_VIP_DLC_ad_C_OFF_Sub,
PQ_IP_VIP_DLC_ad_C_T1_Sub,
PQ_IP_VIP_DLC_ad_C_T2_Sub,
PQ_IP_VIP_DLC_ad_C_T3_Sub,
PQ_IP_VIP_DLC_ad_C_NUMS_Sub
} PQ_IP_VIP_DLC_ad_C_Group_Sub;
...
typedef enum
{
PQ_IP_VIP_DLC_PC_OFF_Sub,
PQ_IP_VIP_DLC_PC_ON_Sub,
PQ_IP_VIP_DLC_PC_NUMS_Sub
} PQ_IP_VIP_DLC_PC_Group_Sub;
...
PQ_IP_VIP_Post_Ygain_0x3C0_Sub,
PQ_IP_VIP_Post_Ygain_0x360_Sub,
PQ_IP_VIP_Post_Ygain_0x365_Sub,
PQ_IP_VIP_Post_Ygain_0x36D_Sub,
PQ_IP_VIP_Post_Ygain_NUMS_Sub
} PQ_IP_VIP_Post_Ygain_Group_Sub;

typedef enum
{
PQ_IP_VIP_Post_Yoffset_2_OFF_Sub,
PQ_IP_VIP_Post_Yoffset_2_0x05_Sub,
PQ_IP_VIP_Post_Yoffset_2_NUMS_Sub
} PQ_IP_VIP_Post_Yoffset_2_Group_Sub;
...
typedef enum
{
PQ_IP_VIP_YCbCr_Clip_OFF_Sub,
PQ_IP_VIP_YCbCr_Clip_NUMS_Sub
} PQ_IP_VIP_YCbCr_Clip_Group_Sub;
...
PQ_IP_SR_H_Peaking_NUMS_Sub
} PQ_IP_SR_H_Peaking_Group_Sub;
...
PQ_IP_SR_V_Peaking_NUMS_Sub
} PQ_IP_SR_V_Peaking_Group_Sub;
...
PQ_IP_SR_D_Peaking_NUMS_Sub
} PQ_IP_SR_D_Peaking_Group_Sub;
...
PQ_IP_SR_Dering_NUMS_Sub
} PQ_IP_SR_Dering_Group_Sub;
...
PQ_IP_SR_V_Dering_NUMS_Sub
} PQ_IP_SR_V_Dering_Group_Sub;
...
PQ_IP_SR_Adaptive_Y_Peaking_NUMS_Sub
} PQ_IP_SR_Adaptive_Y_Peaking_Group_Sub;
...
PQ_IP_SR_User_Sharpness_NUMS_Sub
} PQ_IP_SR_User_Sharpness_Group_Sub;
...
PQ_IP_SR_LTI_NUMS_Sub
} PQ_IP_SR_LTI_Group_Sub;
...
PQ_IP_SR_EE_NUMS_Sub
} PQ_IP_SR_EE_Group_Sub;
...
PQ_IP_SR_NoiseMasking_NUMS_Sub
} PQ_IP_SR_NoiseMasking_Group_Sub;
...
PQ_IP_SR_DS_NUMS_Sub
} PQ_IP_SR_DS_Group_Sub;
...
PQ_IP_SR_AA_NUMS_Sub
} PQ_IP_SR_AA_Group_Sub;
...
typedef enum
{
PQ_IP_PQ_ByPass_OFF_Sub,
PQ_IP_PQ_ByPass_NUMS_Sub
} PQ_IP_PQ_ByPass_Group_Sub;

extern const U8 MST_SkipRule_IP_Sub[PQ_IP_NUM_Sub];
extern const EN_IPTAB_INFO PQ_IPTAB_INFO_Sub[];
extern const U8 QMAP_3840_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
extern const U8 QMAP_3840_PIP_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
extern const U8 QMAP_3840_POP_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
extern const U8 QMAP_2560_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
extern const U8 QMAP_2560_PIP_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
extern const U8 QMAP_2560_POP_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
