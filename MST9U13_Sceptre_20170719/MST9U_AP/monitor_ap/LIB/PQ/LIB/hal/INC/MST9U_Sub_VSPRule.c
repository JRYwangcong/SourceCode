...
const U8 MST_VSPRule_IP_Index_Sub[PQ_VSPRule_IP_NUM_Sub]=
{
    PQ_IP_VSP_Y_Sub,
    PQ_IP_VSP_C_Sub,
    PQ_IP_SRAM3_Sub,
...
const U8 MST_VSPRule_Array_Sub[PQ_VSPRule_NUM_Sub][PQ_VSPRule_IP_NUM_Sub]=
{
    {//PreV_ScalingDown_Interlace, 0
        PQ_IP_VSP_Y_Bilinear_Sub, PQ_IP_VSP_C_Bilinear_Sub, PQ_IP_NULL, 
    },
    {//PreV_ScalingDown_Progressive, 1
        PQ_IP_VSP_Y_Bilinear_Sub, PQ_IP_VSP_C_Bilinear_Sub, PQ_IP_NULL, 
    },
    {//ScalingDown_00x_YUV, 2
        PQ_IP_VSP_Y_Bilinear_Sub, PQ_IP_VSP_C_Bilinear_Sub, PQ_IP_SRAM3_InvSinc6Tc4p4Fc57Apass01Astop60_Sub, 
    },
    ...
    {//ScalingDown_10x_YUV, 22
        PQ_IP_VSP_Y_Bypass_Sub, PQ_IP_VSP_C_Bypass_Sub, PQ_IP_NULL, 
    },
