...
#define _FMENULOADFONT_C

#include "datatype.h"
#include "menudef.h"
#include "FactoryMenu.h"
#include "FMenuFontTbl.h"
...
WORD code tFactoryFont1[] = 
{
  ...
  // 0x002(2) :   [0x006(6)]
  0x6000, 0x2060, 0x5000, 0x2060, 0x3000, 
  // Total  [0x00B(22)]
...
void FactoryMenuLoadFont(void)
{
       mStar_LoadCompressedFont( FONT_FACTORY_SPACE, tFactoryFont0, 0 ); 
	mStar_LoadCompressedFont( FONT_FACTORY_DOT_AND_DASH, tFactoryFont1, 0 ); 
	mStar_LoadCompressedFont( FONT_FACTORY_NUMBER_START, tFactoryFont_Number, 0 ); 
	mStar_LoadCompressedFont( FONT_FACTORY_ENGLISH_BIG_START, tFactoryFont_EnglishBig, 0 );
	mStar_LoadCompressedFont( FONT_FACTORY_ENGLISH_SMALL_START, tFactoryFont_EnglishSmall, 0 ); 
}
