...
#if (MS_BOARD_TYPE_SEL == BD_MST182A_A01A_S) || (MS_BOARD_TYPE_SEL == BD_MST182A_A01B_S) || (MS_BOARD_TYPE_SEL == BD_MST9U)
...
#define INPUT_TYPE              (INPUT_1A|INPUT_6C)
#define ENABLE_VGA_INPUT        (INPUT_TYPE&INPUT_1A)
#define ENABLE_DVI_INPUT        0
#define ENABLE_DVI2ND_INPUT     0
#define ENABLE_DVI3ND_INPUT     0
#define ENABLE_HDMI_INPUT       0
...
#define ENABLE_DP4ND_INPUT      1
#define ENABLE_DP5ND_INPUT      1
#define ENABLE_DP6ND_INPUT      1
#define ENABLE_VD_INPUT         0
#define ENABLE_LED_CONTROLLER   0
#define CHIP_ID                 MST9U2
#else
...
// PANEL SELECTION
////////////////////////////////////////////////////////////
#define ENABLE_VBY1_TO_EDP		((CHIP_ID==MST9U2)&&0)	// need sync with 51 setting

#ifdef MST9U_FPGA
#define PanelType               PanelAU20SVGA//PanelCMIM236HGJ_L21//PanelAU20SVGA // 800x600
#else
#if ENABLE_VBY1_TO_EDP
#define PanelType               PanelVby1ToEDP
#else
...
#define tool_model_panel_name  "MST9U_PanelCMIM236HGJ_L21" //length must smaller than 128
...
#define ENABLE_DAISY_CHAIN                  0                           // need sync with 51 setting
...
#define  DP_NoInput_Audio                   0

#define ENABLE_FB_BMP_DRAW                  0
#define ENABLE_FB_JPG_DRAW					0

#define MST9U_ASIC_1P2SC                    (0 && MST9U_ASIC_1P) // ASIC 1P and uses 2 scaler (L0, L1) for output display if needed

#define PANEL_VBY1_HW_MODE                  (0&&PANEL_VBY1()) //only support SW mode
