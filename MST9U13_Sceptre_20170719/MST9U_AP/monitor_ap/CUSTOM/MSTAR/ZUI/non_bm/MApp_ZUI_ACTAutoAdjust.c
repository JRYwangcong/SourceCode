...
#define MAPP_ZUI_ACTAUTOADJUST_C
...
void MApp_ZUI_ACT_AppShowAutoAdjust(void)
{
    HWND wnd;
    RECT rect;
    E_OSD_ID osd_id = E_OSD_AUTO_ADJUST;
    ...
    RECT_SET(rect,
        (gScreenWidth-ZUI_AUTO_ADJUST_WIDTH)/2, (gScreenHeight-ZUI_AUTO_ADJUST_HEIGHT)/2,
        ZUI_AUTO_ADJUST_WIDTH, ZUI_AUTO_ADJUST_HEIGHT);
    ...
    MApp_ZUI_API_ShowWindow(HWND_AUTO_ADJUST_TRANSPARENT_BG, SW_SHOW);
    MApp_ZUI_API_ShowWindow(HWND_DIRECT_MENU_AUTO_ADJUST_BG, SW_SHOW);
    //MApp_ZUI_API_ShowWindow(HWND_DIRECT_MENU_AUTO_ADJUST_BG, SW_SHOW);
...
BOOLEAN MApp_ZUI_ACT_HandleAutoAdjustKey(VIRTUAL_KEY_CODE key)
{
    switch(key)
    {
...
void MApp_ZUI_ACT_TerminateAutoAdjust(void)
{
...
//////////////////////////////////////////
BOOLEAN MApp_ZUI_ACT_ExecuteAutoAdjustAction(U16 act)
{
    switch(act)
    {
...
#undef MAPP_ZUI_ACTAUTOADJUST_C
