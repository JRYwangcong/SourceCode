...
#elif (IR_MODE_SEL == IR_SW_RC5_MODE)
...
#define ONE_BIT_COUNT              0x350
#define ONE_BIT_DELTA              0x100

#define TWO_BIT_COUNT              0x700
#define TWO_BIT_DELTA              0x200
...
#elif(IR_MODE_SEL == IR_FULL_INT_MIT_MODE)
#define IR_HEADER_CODE_TIME    8000 // us
#define IR_OFF_CODE_TIME       4000 // us
#define IR_OFF_CODE_RP_TIME    2500 // us
#define IR_LOGI_01H_TIME        500 // us
#define IR_LOGI_0_TIME         1000 // us
#define IR_LOGI_1_TIME         2000 // us

#define IR_MIT_SEPCODE_TIME        4000 // us
#define IR_LOGI_1_TIME         2000 // us
...
#define IR_LG1_LOB             irGetMinCnt(IR_LOGI_1_TIME)
#define IR_RP_TIMEOUT          irGetCnt(IR_TIMEOUT_CYC)
#define IR_MIT_SEP_UPB         irGetMaxCnt(IR_MIT_SEPCODE_TIME)
#define IR_MIT_SEP_LOB         irGetMinCnt(IR_MIT_SEPCODE_TIME)
#endif
