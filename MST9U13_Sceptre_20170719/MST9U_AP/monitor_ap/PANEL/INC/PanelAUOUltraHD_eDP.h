...
// //////// config ML<->AUX<->HPD Port Mapping ///////////////
#if (CHIP_ID==MST9U3)
#define eDPTXP0UseAUXPortNum 2 // 0~3
#define eDPTXP0UseHPDPortNum 0 // 0~1
#define eDPTXP1UseAUXPortNum 3 // 0~3
...
////////////////////////////////////////////////////////////
#define eDPTXEnPG 0
#define eDPTXMODPhyCalEn 1                        // Set 1 for MP
#endif
...
#define PanelHSyncWidth        28 //19 //38//22//24
...
#define PanelHTotal         (2048*2)//(2080*2) //(2200*2) //4400
#define PanelVTotal         2185 //2180 //2200 //2250
#define PanelVSyncWidth       PanelVTotal - PanelHeight - PanelVSyncBackPorch - 2   // 3
...
#endif
#define PanelMaxHTotal       4200 //4400 //4800
#define PanelMinHTotal      3800 //4080  //4336
#define PanelMaxVTotal      3000
#define PanelMinVTotal      2100 //2218
#define PanelDCLK             (66*8) //(70*8) // (74*8)
#define PanelMaxDCLK      (70*8) //(72*8) // (76*8)
#define PanelMinDCLK       (64*8) //(66*8) // (69*8)
