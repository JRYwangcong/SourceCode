...
#if 1//(MS_BOARD_TYPE_SEL == BD_MST9UHL_V3)
...
#define PANEL_OUTPUT_FMT_LR     0//0xFF
...
#define PanelOnTiming1          35  // time between panel & data while turn on power
...
#define PanelOffTiming2         25//25 // time between data & panel while turn off power
#define PanelOffTiming0         0 // time between 12V - 3.3V

#define PanelHSyncWidth            42
...
#define PanelVTotal         1472//1481//1455

#define PanelMaxHTotal      2760
#define PanelMinHTotal       2688
#define PanelMaxVTotal      2430
#define PanelMinVTotal       1470

#define PanelDCLK              (243)
#define PanelMaxDCLK        (584)
#define PanelMinDCLK        (189)
#define HV_OUTPUT_TYPE      HSRM_B


#define PanelVfreq               600
#define PanelMaxVfreq        760
#define PanelMinVfreq        (490) // 50Hz
