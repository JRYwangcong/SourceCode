...
#define PanelName               "SAM LSM270HP06"
...
#define PanelOnTiming1          30//25//  // time between panel & data while turn on power
#define PanelOnTiming2          1050//550 // time between data & back light while turn on power  //20050701
#define PanelOffTiming1         100 // time between back light & data while turn off power
#define PanelOffTiming2        100// 10//25 // time between data & panel while turn off power
#define PanelOffTiming0         0 // time between 12V - 3.3V
#define PanelHSyncWidth         10//22//24
#define PanelHSyncBackPorch     48
#define PanelVSyncWidth             3
#define PanelVSyncBackPorch     24 // 46
...
#define PanelHTotal                                             2176//2120
#define PanelVTotal                                             1125//1111

#define PanelMaxHTotal                                      2200
#define PanelMinHTotal                                       2080

#define PanelMaxVTotal                                      3300
#define PanelMinVTotal                                       1100

#define PanelDCLK                                               283//241
#define PanelMaxDCLK                                        345//304
#define PanelMinDCLK                                         112//199

#define HV_OUTPUT_TYPE                                  HSRM_B

#define PanelVfreq                                              (1200)
#define PanelMaxVfreq                                       (1450) // 75Hz
