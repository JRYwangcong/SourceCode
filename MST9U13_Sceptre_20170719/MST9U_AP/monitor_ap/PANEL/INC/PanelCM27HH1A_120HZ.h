...
#define PANEL_LVDS_4CH      1// 1
#define PANEL_LVDS_8CH      0//0
...
#define LVDS_CH_F_SWAP              LVDS_CH_A
...
#define PanelDCLK            (((DWORD)PanelHTotal*PanelVTotal*PanelVsyncFreq)/1000000)//148 // 74.25
#define PanelMaxDCLK      390 //196 // 98
