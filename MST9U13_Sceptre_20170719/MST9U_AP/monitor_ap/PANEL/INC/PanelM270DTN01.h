...
#define PanelName               "SAM M270DTN01"
...
#define PanelHTotal         (360*8)  
#define PanelVTotal         1481

#define PanelMaxHTotal      (1023*8)
#define PanelMinHTotal      (359*8)

#define PanelMaxVTotal      2700
#define PanelMinVTotal      1452

#define PanelDCLK           (64*8)
#define PanelMaxDCLK        (90*8)
#define PanelMinDCLK        (25*8)
#define HV_OUTPUT_TYPE      HSRM_B

#define PanelVfreq          (1200)
#define PanelMaxVfreq       (PanelVfreq+300)
#define PanelMinVfreq       (300) // 50Hz
