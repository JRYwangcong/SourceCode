#ifndef __PANEL_AU185__
#define __PANEL_AU185__
#define PanelName               "PanelAU185"

#define PanelDither         8
#define DITHER_COEFF        0x2D
#define DITHER_METHOD       0x4C
...
#define PanelOnTiming1    80  // time between panel & data while turn on power
...
#define PanelOffTiming2    30//25 // time between data & panel while turn off power
#define PanelOffTiming0 0 // time between 12V - 3.3V
#define PanelHSyncWidth   16//22//24
#define PanelHSyncBackPorch 8
#define PanelVSyncWidth         2
...
#define PanelMaxHTotal     2040
#define PanelMinHTotal     1424
#define PanelMaxVTotal     1023
#define PanelMinVTotal    766
#define PanelDCLK            (((DWORD)PanelHTotal*PanelVTotal*60)/1000000)//148 // 74.25
#define PanelMaxDCLK      90 // 98
#define PanelMinDCLK       60 // 58.54
#define HV_OUTPUT_TYPE          HSRM_B
...
//PVS / FSYNC
#define GPO9_VStart   0x07 //0x002
#define GPO9_VEnd   0x705 //0x306
#define GPO9_HStart   0 //0x00A
#define GPO9_HEnd   0 //0x005
#define GPO9_Control  0x07 //0x08
//HSYNC
#define GPOA_VStart   0x06
#define GPOA_VEnd   0x408
#define GPOA_HStart   0
#define GPOA_HEnd   0
#define GPOA_Control  0x04
