...
#define PanelName               "M320QAN01"

#define PanelSize_Num           "32"
...
#if ((MS_BOARD_TYPE_SEL == BD_MST9UHL_V3))//&&(!defined(FengYuan_Project)))
...
#define PanelHSyncBackPorch     48//40
#define PanelVSyncWidth             3
#define PanelVSyncBackPorch     21//11
