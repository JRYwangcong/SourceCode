...
#define PanelName               "K320WL3-SE350"
#else
#define PanelName               "LSM315HP01"
#endif
#define PanelSize_Num           "315"

#define PanelSize                  PanelSize40W

//#define PanelI2CCommandSetting
...
#define PANEL_OUTPUT_FMT_4B     0xFF
...
#define PanelOnTiming1          60  // time between panel & data while turn on power
#define PanelOnTiming2          1000 // time between data & back light while turn on power  //20050701
#define PanelOffTiming1         100 // time between back light & data while turn off power
#define PanelOffTiming2         200//25 // time between data & panel while turn off power
#define PanelOffTiming0         0 // time between 12V - 3.3V
#define PanelHSyncWidth         38
#define PanelHSyncBackPorch     41
#define PanelVSyncWidth             4
#define PanelVSyncBackPorch     14
...
//#define PanelVTotal         1113//1125
#define PanelVTotal         (GetVfreqType()?(1113):(2250))//2250//1120//2150

#define PanelMaxHTotal      2550
#define PanelMinHTotal       2096
#define PanelMaxVTotal      3168
#define PanelMinVTotal       1110
#define PanelNormalVTotal	2250

#define PanelDCLK             274// (84*4)
#define PanelMaxDCLK       336// (90*4)
#define PanelMinDCLK       233// (70*4)
#define Panel_120CLK        (286)//(69*8)

#define HV_OUTPUT_TYPE      HSRM_B

#define PanelVfreq         600// (1440)
#define PanelMaxVfreq       (1440+20)
#define PanelMinVfreq       (480-20) // 50Hz
...
#define PanelEvenDataCurrent    1 // Even data current
#define PanelOnTiming0          2 // time between 3.3V - 12V
#define PanelOnTiming1          75  // time between panel & data while turn on power
#define PanelOnTiming2          500 // time between data & back light while turn on power  //20050701
...
#define PanelDCLK              (84*4)
#define PanelMaxDCLK        (90*4)
#define PanelMinDCLK        (70*4)
#define HV_OUTPUT_TYPE      HSRM_B

#define PanelVfreq          (1440)
#define PanelMaxVfreq       (PanelVfreq+20)
#define PanelMinVfreq       (PanelVfreq-20) // 50Hz
#endif
//=================================================================
