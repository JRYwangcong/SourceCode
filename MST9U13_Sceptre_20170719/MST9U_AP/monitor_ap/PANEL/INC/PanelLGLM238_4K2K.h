...
#define LVDS_CH_E_SWAP              LVDS_CH_G
#define LVDS_CH_F_SWAP              LVDS_CH_E
#define LVDS_CH_G_SWAP              LVDS_CH_H
#define LVDS_CH_H_SWAP              LVDS_CH_F
...
#define PanelWidth          (2048*2)//4096
#define PanelHeight         2160
#define PanelHTotal         (2272*2) // 4544
