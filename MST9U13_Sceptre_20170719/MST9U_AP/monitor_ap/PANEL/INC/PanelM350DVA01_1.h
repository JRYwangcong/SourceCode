...
#define PanelName               "M350DVA01"

#define PanelSize_Num           "35"

#define PanelSize                  PanelSize35W
...
#define PANEL_OUTPUT_FMT_4B     0//0xFF
...
#define PanelOnTiming2          650 // time between data & back light while turn on power  //20050701
...
#define PanelHTotal         2880
#if (defined(LianHeChuangXin_Project))
#define PanelVTotal         1130
#else
#define PanelVTotal         (GetVfreqType()?(1130):(2200))
#endif

#define PanelMaxHTotal      3600
#define PanelMinHTotal       2720//2872
#define PanelMaxVTotal      2790
#define PanelMinVTotal       1100

#define PanelDCLK           (49*8)
#define PanelMaxDCLK        (85*8)
#define PanelMinDCLK        (40*8)
#define HV_OUTPUT_TYPE      HSRM_B

#define PanelVfreq          (1200)
#define PanelMaxVfreq       (PanelVfreq+300)
#define PanelMinVfreq       (300) //30Hz
