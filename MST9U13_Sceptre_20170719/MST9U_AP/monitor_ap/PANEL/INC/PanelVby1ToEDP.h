#ifndef __PANEL_VBY1_TO_EDP__
#define __PANEL_VBY1_TO_EDP__

#define PanelName               "PanelVby1ToEDP"
...
#define LVDS_CH_E_SWAP              LVDS_CH_A
#define LVDS_CH_F_SWAP              LVDS_CH_C
#define LVDS_CH_G_SWAP              LVDS_CH_E
#define LVDS_CH_H_SWAP              LVDS_CH_G
#else
#define LVDS_CH_A_SWAP              LVDS_CH_A
#define LVDS_CH_B_SWAP              LVDS_CH_C
...
#define PanelHTotal         	4160	//HTT % 8 = 0
#define PanelVTotal         	2190	//2200
#define PanelMaxHTotal      	4400	//4800
#define PanelMinHTotal      	3800	//4240//4336
#define PanelMaxVTotal      	2400	//2790//3000
#define PanelMinVTotal      	2000	//2200//2218
#define PanelDCLK           	(68*8) 	//(70*8)//520  //   528        //(66*8)//(71*8)
#define PanelMaxDCLK        	(80*8)	//(80*8)//(76*8)
#define PanelMinDCLK        	(60*8)	//(70*8)//(69*8
//=================== USE eDP PANEL SPEC (END) ========

#define HV_OUTPUT_TYPE      HSRM_B
#if PANEL_VBY1_4CH_8Bit||PANEL_VBY1_4CH_10Bit
#define PanelVfreq          (300)
#define PanelMaxVfreq       (300+10)
#define PanelMinVfreq       (300-10)
#else
#define PanelVfreq          (600)
#define PanelMaxVfreq       (600+20)
#define PanelMinVfreq       (600-20)
#endif
