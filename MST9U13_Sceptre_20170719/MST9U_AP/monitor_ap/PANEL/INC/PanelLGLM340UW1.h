#ifndef __PANEL_LG_LM340UW1__
#define __PANEL_LG_LM340UW1__

#define _PANEL_NORMALLY_BLACK_

#define PanelNumber             1800
#define PanelName               "PanelLG LM340UW1"
...
#define PanelOnTiming2          600 // time between data & back light while turn on power
#define PanelOffTiming1         300 // time between back light & data while turn off power
#define PanelOffTiming2         17  // time between data & panel while turn off power
#define PanelOffTiming0         0   // time between 12V - 3.3V

#define PanelHSyncWidth         480 // a multiple of 8
#define PanelHSyncBackPorch     496 // a multiple of 8

#define PanelVSyncWidth         3//(4-1)//3
#define PanelVSyncBackPorch     13//(16-1)//13

#define VERTICAL_DE_START       4  //PanelVStart

#define PanelHStart         (PanelHSyncWidth+PanelHSyncBackPorch)
#define PanelVStart         (PanelVSyncWidth+PanelVSyncBackPorch) //16

#define PanelWidth          3440
#define PanelHeight         1440

#define PanelHTotal         4864 //4880    //(610*8)
#define PanelVTotal         1468

#define PanelMaxHTotal      4912    //(614*8)
#define PanelMinHTotal      4848    //(606*8)   // a multiple of 8

#define PanelMaxVTotal      1470
#define PanelMinVTotal      1466

#define PanelDCLK           437     //(54.7*8)
#define PanelMaxDCLK        429     //(53.7*8)
#define PanelMinDCLK        423     //(52.8*8)
