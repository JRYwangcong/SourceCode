...
#define PanelName               "M270QAN01"

#define PanelSize_Num           "27"
...
#define eDPTXHBR2Enable 0  // set 1 when use MST9U3 chip && eDPTX ouput in HBR2 path
...
#define eDPTXHBR2PUseAUXPortNum 0 // 0~3
#define eDPTXHBR2PUseHPDPortNum 0 // 0~1
////////////////////////////////////////////////////////////
#define eDP_HBR2_SwTBL_ShiftLv                1         // set 1 means => sw Lv1 shift to Lv0 , Lv2 shift to Lv1, Lv3 shift to Lv2 ,Lv3=Lv2
...
#define eDPTXHPDPort0             eDPTXHPD_USE_GPIO50
#define eDPTXHPDPort1             eDPTXHPD_USE_GPIO50  // if  project only use One HPD port => please define HPDPort1 = HPDPort0
////////////////////////////////////////////////////////////
...
#define eDPTXSWAP          (MS_BOARD_TYPE_SEL== BD_MST9UHD_DV1)
...
#if ((MS_BOARD_TYPE_SEL == BD_MST9UHL_V3)||(MS_BOARD_TYPE_SEL== BD_MST9UHD_DV1)||(MS_BOARD_TYPE_SEL== BD_MST9UHL_V4||MS_BOARD_TYPE_SEL==BD_MST9UHL_V6)||(MS_BOARD_TYPE_SEL==BD_MST9UHL_V4_1H1DP)||(MS_BOARD_TYPE_SEL==BD_MST9UHL_V7)||(MS_BOARD_TYPE_SEL==BD_MST9UHL_A0))//&&(!defined(FengYuan_Project)))
...
#define eDPTXP0UseHPDPortNum 1 // 0~1
#define eDPTXP1UseAUXPortNum 1 // 0~3
#define eDPTXP1UseHPDPortNum 0 // 0~1
#else
...
//==================================================================
#if (MS_BOARD_TYPE_SEL== BD_MST9UHD_DV1)
#define LVDS_CH_A_SWAP              LVDS_CH_D//LVDS_CH_A////  0
#define LVDS_CH_B_SWAP              LVDS_CH_B//LVDS_CH_E////  1
#define LVDS_CH_C_SWAP              LVDS_CH_C//LVDS_CH_C//// //  2
#define LVDS_CH_D_SWAP              LVDS_CH_A//LVDS_CH_G////  // 3
#define LVDS_CH_E_SWAP              LVDS_CH_H//LVDS_CH_B////  // 0
#define LVDS_CH_F_SWAP              LVDS_CH_F//LVDS_CH_F//// // 1
#define LVDS_CH_G_SWAP              LVDS_CH_G//LVDS_CH_D//// // 2
#define LVDS_CH_H_SWAP              LVDS_CH_E//LVDS_CH_H////  // 3
#else
...
#define PanelWidth          3840
#define PanelHeight         2160
#define PanelHTotal         4200
#define PanelVTotal         2200

#define PanelMaxHTotal      4352
#define PanelMinHTotal      4056
#define PanelMaxVTotal      2372
#define PanelMinVTotal      2180

#define PanelDCLK           (277*2)
#define PanelMaxDCLK        (280*2)
#define PanelMinDCLK        (260*2)
