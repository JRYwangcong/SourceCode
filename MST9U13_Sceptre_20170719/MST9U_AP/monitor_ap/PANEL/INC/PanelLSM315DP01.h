...
#define PanelName               "LSM315DP01"

#define PanelSize                  PanelSize32W

#define Panel_DE_only 1 //set 1 to discard virtual BS for panel DE only mode
...
#define PanelHSyncWidth            42//32
#define PanelHSyncBackPorch     42//48
#define PanelVSyncWidth              4///3
#define PanelVSyncBackPorch      15///16//21
...
#define PanelHTotal         2700//2720
#define PanelVTotal         1490//   1490//1481
...
#define PanelMaxDCLK        568//(584)
#define PanelMinDCLK        (189)
#define HV_OUTPUT_TYPE      HSRM_B

#if eDPTXHBR2PortEn
#define PanelVfreq              1440//(600)
#else
#define PanelVfreq              600//(600)
#endif
#define PanelMaxVfreq       1540//(1460)
#define PanelMinVfreq        (470) // 50Hz
