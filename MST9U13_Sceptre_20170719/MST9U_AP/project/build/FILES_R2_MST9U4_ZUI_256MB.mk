...
MONITOR_FILES_DRIVER  += \
        ...
        $(MONITOR_PATH_DRIVER)/MST9U4/drvAudio.c                      \
        $(MONITOR_PATH_DRIVER)/drvDDC2Bi.c                            \
        $(MONITOR_PATH_DRIVER)/drvMcu.c                               \
        $(MONITOR_PATH_DRIVER)/mapi_combo.c                           \
        $(MONITOR_PATH_DRIVER)/drvMHL.c                               \
        $(MONITOR_PATH_DRIVER)/MST9U4/drvDPRxApp.c                    \
        $(MONITOR_PATH_DRIVER)/MST9U4/drvDPTxApp.c                    \
        $(MONITOR_PATH_DRIVER)/MST9U4/hal_Combo.c                     \
        ...
        $(MONITOR_PATH_DRIVER)/MST9U4/HDCP22/drvHDCPMbx.c		\
        $(MONITOR_PATH_DRIVER)/MST9U4/HDCP22/drvHDCPRx.c		\
...
MONITOR_FILES_CUSTOM_MSTAR_ZUI += \
        ...
        $(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/MApp_ZUI_ACTLogo.c                       \
        $(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/MApp_ZUI_ACTidle.c                       \
        $(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/MApp_ZUI_ACTMainMenu.c                   \
        $(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/MApp_ZUI_ACTAutoAdjust.c                 \
        $(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/MApp_ZUI_ACTDirMsgMenu.c                 \
...
MONITOR_FILES_INC += \
        ...
        -I$(MONITOR_PATH_DRIVER)/MST9U4/INC                      								 \
        -I$(MONITOR_PATH_DRIVER)/MST9U4/HDCP22/INC

ifeq ($(ZUI), 1)
MONITOR_FILES_INC += \
        -I$(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/include                               \
        -I$(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/osdcomposer/include                   \
        -I$(MONITOR_PATH_CUSTOM_MSTAR_ZUI)/res800x600x565/Osdcomposer/Include
endif
