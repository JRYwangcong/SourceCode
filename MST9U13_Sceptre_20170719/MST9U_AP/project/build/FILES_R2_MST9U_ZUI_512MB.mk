...
MONITOR_FILES_DRIVER  += \
        ...
        $(MONITOR_PATH_DRIVER)/MST9U/drvAudio.c                               \
        $(MONITOR_PATH_DRIVER)/drvDDC2Bi.c                            \
        $(MONITOR_PATH_DRIVER)/drvMcu.c                               \
        $(MONITOR_PATH_DRIVER)/mapi_combo.c                           \
        $(MONITOR_PATH_DRIVER)/drvMHL.c                               \
        $(MONITOR_PATH_DRIVER)/MST9U/drvDPRxApp.c                     \
        $(MONITOR_PATH_DRIVER)/MST9U/drvDPRxComboApp.c                \
        $(MONITOR_PATH_DRIVER)/MST9U/drvDPTxApp.c                     \
        $(MONITOR_PATH_DRIVER)/MST9U/hal_Combo.c                      \
...
MONITOR_FILES_INC += \
        ...
        -I$(MONITOR_PATH_DRIVER)/MST9U/INC                      								 \
