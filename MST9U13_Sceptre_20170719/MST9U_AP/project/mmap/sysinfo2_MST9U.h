...
#if (CHIP_ID==MST9U3)
    #include "MMAP_MST9U3_64_AEON.h"
#else
    #include "MMAP_MST9U_64_AEON.h"
#endif
#elif ( MEMORY_MAP == MMAP_128MB )
#if (CHIP_ID==MST9U3)
    #include "MMAP_MST9U3_128_AEON.h"
#else
    #include "MMAP_MST9U_128_AEON.h"
#endif
#elif ( MEMORY_MAP == MMAP_256MB )
  #if (CHIP_ID==MST9U4)
    #include "MMAP_MST9U4_256_AEON.h"
  #else
    #include "MMAP_MST9U_256_AEON.h"
  #endif
#elif ( MEMORY_MAP == MMAP_512MB )
    #include "MMAP_MST9U_512_AEON.h"
#elif ( MEMORY_MAP == MMAP_256_256MB )
    #include "MMAP_MST9U_256_256_AEON.h"
#else
    #error "Memory map undefined"
#endif
    #include "MIUSEL_MST9U_MIU.h"
