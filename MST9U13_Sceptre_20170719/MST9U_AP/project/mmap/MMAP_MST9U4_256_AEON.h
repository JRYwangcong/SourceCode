...
/* MENULOAD_BUFFER   */
//co_buffer L0
#define MENULOAD_BUFFER_AVAILABLE                              0x0000C25000
#define MENULOAD_BUFFER_ADR                                    0x0000C25000  //Alignment 0
...
/* DOWNLOAD_BUFFER   */
//co_buffer L0
#define DOWNLOAD_BUFFER_AVAILABLE                              0x0000C29000
#define DOWNLOAD_BUFFER_ADR                                    0x0000C29000  //Alignment 0
...
/* BDMA_BUFFER   */
//co_buffer L0
#define BDMA_BUFFER_AVAILABLE                                  0x0000E29000
#define BDMA_BUFFER_ADR                                        0x0000E29000  //Alignment 0x00001
...
/* FILE_SYSTEM_POOL   */
//co_buffer L0
#define FILE_SYSTEM_POOL_AVAILABLE                             0x0000F29000
#define FILE_SYSTEM_POOL_ADR                                   0x0000F29000  //Alignment 0x01000
...
/* MBX_XD2MIU   */
//co_buffer L0
#define MBX_XD2MIU_AVAILABLE                                   0x0000F89000
#define MBX_XD2MIU_ADR                                         0x0000F90000  //Alignment 0x10000
...
/* AudioPCM   */
//co_buffer L0
#define AudioPCM_AVAILABLE                                     0x0000FA0000
#define AudioPCM_ADR                                           0x0000FA0000  //Alignment 0
#define AudioPCM_GAP_CHK                                       0x0000000000
#define AudioPCM_LEN                                           0x0000400000
#define AudioPCM_MEMORY_TYPE                                   (MIU0 | SW | WRITE_BACK)

/* PQ_MAIN   */
//co_buffer L0
#define PQ_MAIN_AVAILABLE                                      0x00013A0000
#define PQ_MAIN_ADR                                            0x00013A0000  //Alignment 0
...
/* PQ_MAIN_EX   */
//co_buffer L0
#define PQ_MAIN_EX_AVAILABLE                                   0x0001404000
#define PQ_MAIN_EX_ADR                                         0x0001404000  //Alignment 0
...
/* PQ_TEXT_MAIN   */
//co_buffer L0
#define PQ_TEXT_MAIN_AVAILABLE                                 0x000140C000
#define PQ_TEXT_MAIN_ADR                                       0x000140C000  //Alignment 0
...
/* MS_TOOL   */
//co_buffer L0
#define MS_TOOL_AVAILABLE                                      0x0001414000
#define MS_TOOL_ADR                                            0x0001414000  //Alignment 0x01000
...
/* GOP_GWIN_RB   */
//co_buffer L0
#define GOP_GWIN_RB_AVAILABLE                                  0x0001614000
#define GOP_GWIN_RB_ADR                                        0x0001614000  //Alignment 0x00008
#define GOP_GWIN_RB_GAP_CHK                                    0x0000000000
#define GOP_GWIN_RB_LEN                                        0x0001800000
#define GOP_GWIN_RB_MEMORY_TYPE                                (MIU0 | SW | WRITE_BACK)

/* GOP_REGDMABASE   */
//co_buffer L0
#define GOP_REGDMABASE_AVAILABLE                               0x0002E14000
#define GOP_REGDMABASE_ADR                                     0x0002E14000  //Alignment 0x04000
...
/* POOL_BUFFER   */
//co_buffer L0
#define POOL_BUFFER_AVAILABLE                                  0x0002E15000
#define POOL_BUFFER_ADR                                        0x0002E80000  //Alignment 0x80000
#define POOL_BUFFER_GAP_CHK                                    0x000006B000
#define POOL_BUFFER_LEN                                        0x0001B00000
#define POOL_BUFFER_MEMORY_TYPE                                (MIU0 | SW | WRITE_BACK)

/* BMP_START   */
//co_buffer L0
#define BMP_START_AVAILABLE                                    0x0004980000
#define BMP_START_ADR                                          0x0004980000  //Alignment 0x00800
...
//co_buffer L0
#define BMP_PALETTE_BUF_START_AVAILABLE                        0x0005380000
#define BMP_PALETTE_BUF_START_ADR                              0x0005380000  //Alignment 0
#define BMP_PALETTE_BUF_START_GAP_CHK                          0x0000000000
#define BMP_PALETTE_BUF_START_LEN                              0x0000000800
#define BMP_PALETTE_BUF_START_MEMORY_TYPE                      (MIU0 | SW | WRITE_BACK)

/* STRING_START   */
//co_buffer L0
#define STRING_START_AVAILABLE                                 0x0005380800
#define STRING_START_ADR                                       0x0005380800  //Alignment 0x00800
...
/* FONT_START   */
//co_buffer L0
#define FONT_START_AVAILABLE                                   0x00053D0800
#define FONT_START_ADR                                         0x00053D0800  //Alignment 0x00008
...
/* OD_L   */
//co_buffer L0
#define OD_L_AVAILABLE                                         0x00054B1800
#define OD_L_ADR                                               0x00054B1800  //Alignment 0
#define OD_L_GAP_CHK                                           0x0000000000
#define OD_L_LEN                                               0x0000700000
#define OD_L_MEMORY_TYPE                                       (MIU0 | SW | WRITE_BACK)

/* OD_R   */
//co_buffer L0
#define OD_R_AVAILABLE                                         0x0005BB1800
#define OD_R_ADR                                               0x0005BB1800  //Alignment 0
#define OD_R_GAP_CHK                                           0x0000000000
#define OD_R_LEN                                               0x0000700000
#define OD_R_MEMORY_TYPE                                       (MIU0 | SW | WRITE_BACK)

/* OSDC_L   */
//co_buffer L0
#define OSDC_L_AVAILABLE                                       0x00062B1800
#define OSDC_L_ADR                                             0x00062B1800  //Alignment 0
#define OSDC_L_GAP_CHK                                         0x0000000000
#define OSDC_L_LEN                                             0x0000900000
#define OSDC_L_MEMORY_TYPE                                     (MIU0 | SW | WRITE_BACK)

/* OSDC_R   */
//co_buffer L0
#define OSDC_R_AVAILABLE                                       0x0006BB1800
#define OSDC_R_ADR                                             0x0006BB1800  //Alignment 0
#define OSDC_R_GAP_CHK                                         0x0000000000
#define OSDC_R_LEN                                             0x0000900000
#define OSDC_R_MEMORY_TYPE                                     (MIU0 | SW | WRITE_BACK)

/* FB_L0   */
//co_buffer L0
#define FB_L0_AVAILABLE                                        0x00074B1800
#define FB_L0_ADR                                              0x00074B2000  //Alignment 0x02000
#define FB_L0_GAP_CHK                                          0x0000000800
#define FB_L0_LEN                                              0x0002200000
#define FB_L0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_R0   */
//co_buffer L0
#define FB_R0_AVAILABLE                                        0x00096B2000
#define FB_R0_ADR                                              0x00096B2000  //Alignment 0x02000
#define FB_R0_GAP_CHK                                          0x0000000000
#define FB_R0_LEN                                              0x0002200000
#define FB_R0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_L1   */
//co_buffer L0
#define FB_L1_AVAILABLE                                        0x000B8B2000
#define FB_L1_ADR                                              0x000B8B2000  //Alignment 0x02000
#define FB_L1_GAP_CHK                                          0x0000000000
#define FB_L1_LEN                                              0x0002200000
#define FB_L1_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_R1   */
//co_buffer L0
#define FB_R1_AVAILABLE                                        0x000DAB2000
#define FB_R1_ADR                                              0x000DAB2000  //Alignment 0x02000
#define FB_R1_GAP_CHK                                          0x0000000000
#define FB_R1_LEN                                              0x0002200000
#define FB_R1_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

//MIU_1_START
//MIU_END
#define MIU0_END_ADR                                           0x000FCB2000
