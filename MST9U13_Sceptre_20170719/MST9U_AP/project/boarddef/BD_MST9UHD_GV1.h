...
#define BOARD_NAME                  "BD_MST9UHD_GV1"
...
#define MIIC0_ENABLE    MIIC0_1_ENABLE    // EEPROM
#define MIIC1_ENABLE    MIIC1_0_ENABLE    // Vby1
#define USE_MIIC        MIIC0

//------IR & Key Setting--------------------------------------------------------
#if (defined(LeXingEnMa_Project)||defined(ZhouYang_Project)||defined(MingCai_Project)||defined(KunDe_Project)||JieBo_IR_Function_Enable||defined(TaiBei_Project)||defined(HuaKe_Project)||defined(FengYuan_Project)||defined(ZhongChuangLianHe_Project)||(defined(Changjia_Project))||(defined(XuLi_Project))||LHCX_IR_Function_Enable)
#define IR_REMOTE_SEL                   JRY_IR_MODE
#else
...
#if 0//((MS_BOARD_TYPE_SEL == BD_MST9UHD_CV1_1H1DP))

#define PORT_FLOW_0     MUX_ADC
#define PORT_FLOW_1     MUX_COMBO2
#define PORT_FLOW_2     MUX_COMBO4
#define PORT_FLOW_3     MUX_RESERVED
#define PORT_FLOW_4     MUX_RESERVED
//#define PORT_FLOW_7

#define PORT_TYPE_0     TYPE_ANALOG
#define PORT_TYPE_1     (TYPE_HDMI |TYPE_MHL|TYPE_HDMI_2_0)
#define PORT_TYPE_2     (TYPE_DP|TYPE_HBR2_0) 
#define PORT_TYPE_3     (TYPE_RESERVED)
#define PORT_TYPE_4     (TYPE_RESERVED)

//#define PORT_TYPE_7

// Define TMDS/DP port used
#define TMDS_Port_D0    0 //HDMI
#define TMDS_Port_D1    0 //HDMI
#define TMDS_Port_D2    1 //HDMI
#define TMDS_Port_D3    0 //HDMI
#define TMDS_Port_D4    0 //none
#define TMDS_Port_D5    0 //DVI dual - master
...
#define DVI_PORT_PRIORITY       3 //Input_Digital5
#define DVI2ND_PORT_PRIORITY    3 //Input_Nums
#define DVI3ND_PORT_PRIORITY    3 //Input_Nums
#define HDMI_PORT_PRIORITY      0 //Input_Digital3
#define HDMI2ND_PORT_PRIORITY   3 //Input_Digital4
#define HDMI3ND_PORT_PRIORITY   3 //Input_Nums
#define HDMI4ND_PORT_PRIORITY   3 //Input_Nums
#define DP_PORT_PRIORITY        1 //Input_Digital1
#define DP2ND_PORT_PRIORITY     3 //Input_Digital2
#define DP3ND_PORT_PRIORITY     3 //Input_Nums
#define VD_PORT_PRIORITY       3 //Input_Digital6
...
#define DVI2ND_PORT_PRIORITY    3 //Input_Nums
#define DVI3ND_PORT_PRIORITY    3 //Input_Nums
#define HDMI_PORT_PRIORITY      1 //Input_Digital3
#define HDMI2ND_PORT_PRIORITY   2 //Input_Digital4
#define HDMI3ND_PORT_PRIORITY   3 //Input_Nums
#define HDMI4ND_PORT_PRIORITY   3 //Input_Nums
#define DP_PORT_PRIORITY        0 //Input_Digital1
#define DP2ND_PORT_PRIORITY     3 //Input_Digital2
#define DP3ND_PORT_PRIORITY     3 //Input_Nums
#define VD_PORT_PRIORITY       3 //Input_Digital6
...
#define VOLUME_PWM_FREQ                     46000
#define VOLUME_PWM_DUTY                     0x7F                //0~0xFF  0x7F=50%
#define VOLUME_PWM_CONFIG               _PWM_OD_EN_
#define VOLUME_PWM_VS_ALG_NUM           _NO_USE_
#else
#define VOLUME_PWM                          _PWM7_GP0_    // Not Finishhed Yet in CHIP_FAMILY_TSUMC //_DISP_PWM3_GP0_
#define VOLUME_PWM_FREQ                     46000
#define VOLUME_PWM_DUTY                     0x7F                //0~0xFF  0x7F=50%
#define VOLUME_PWM_CONFIG               _PWM_OD_EN_
#define VOLUME_PWM_VS_ALG_NUM           _NO_USE_
...
#if LED_Control_By_PWM
#define Init_LEDPWM(Enable)         (MEM_MSWRITE_BIT(0x00040C,Enable,BIT2), MEM_MSWRITE_BIT(0x00040E,0,BIT2), MEM_MSWRITE_BYTE(0x000586, 0x80),MEM_MSWRITE_BYTE(0x000592,0x10), MEM_MSWRITE_BIT(0x000580,Enable,BIT2))
#endif

#define NonUsepin

#define Set_PWM_ADJ()         MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, 0, BIT0)
#define Clr_PWM_ADJ()         MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, 1, BIT0)
#define Init_PWM_ADJ()      MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, 0, BIT0)

#if LED_HOT_Menu_Func
#define IS_LED_Power()         (_bit7_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))
#define Set_LED_Power()         MEM_MSWRITE_BIT(_REG_GPIO5_OUT, 1, BIT7)
#define Clr_LED_Power()         MEM_MSWRITE_BIT(_REG_GPIO5_OUT, 0, BIT7)
#define Init_LED_Power()        MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 0, BIT7)
#endif
...
#define hwEEPROM_WP             //GPIO44
#define hwFlash_WP_Pin          //GPIO10

// ddc eeprom wp be pulled high to 5V, set to input for output high level
#define hw_SetDDC_WP()          (MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT4))//(_MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 0, BIT6), _MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, 0, BIT6), DDCWPActiveFlag=0)
#define hw_ClrDDC_WP()          (MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 0, BIT4))
#define Init_hwDDC_WP_Pin()     (MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, 0, BIT4))//(_MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, 1, BIT6)) // output disable

#define Set_EEPROM_WP()         MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT4)
#define Clr_EEPROM_WP()         MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 0, BIT4)
#define Init_hwEEPROM_WP()      MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, 0, BIT4)
...
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 0, BIT2), Set_BacklightFlag())
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT2), Clr_BacklightFlag(),Clr_BackLightOnFlag())
#define Init_hwBlacklit_Pin()   MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, 0, BIT2)
#define IS_BackLight_On()      (!_bit2_(MEM_MSREAD_BYTE(_REG_GPIO4_IN)))

#define hw_SetPanel()           (MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 0, BIT2),MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, 0, BIT6))
#define hw_ClrPanel()            (MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT2),MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, 1, BIT6))
#define Init_hwPanel_Pin()      (hw_ClrPanel())


#define hw_SetPanel_10Bit()           MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT5)
#define hw_ClrPanel_10Bit()           MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 0, BIT5)
#define Init_hwPanel_10Bit_Pin()      MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, 0, BIT5)
...
#else
#define hwDSUBCable_Pin             0//(_bit7_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))  //GPIO57
...
#if TMDS_Port_D0
#define hwDigital0Cable_Pin          (!_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X3_IN)))
#define Init_hwDigital0Cable_Pin()       (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X3_OEZ,BIT1,BIT1))
#define CABLE_DET_DIGITAL0_SAR     0// SAR8_EN
#else
...
#define hwDigital2Cable_Pin         (!_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X1_IN)))
#define Init_hwDigital2Cable_Pin()  (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X1_OEZ,BIT1,BIT1)) // Enable SAR ch
...
#endif
#if TMDS_Port_D3//
#define hwDigital3Cable_Pin         //(KEYPAD_SAR08)
#define Init_hwDigital3Cable_Pin()  //(MEM_MSWRITE_BIT(REG_003A69,1,BIT0))
#define CABLE_DET_DIGITAL3_SAR      //SAR8_EN
#else
...
#endif
#if DP_Port_D4
#define hwSDMDP4Pin_Pin             (_bit0_(MEM_MSREAD_BYTE(_REG_GPIOAU_IN_L)))
#define Init_hw_DP4_SDMPin()        (MEM_MSWRITE_BIT(_REG_GPIOAU_SEL_L, TRUE, BIT0),MEM_MSWRITE_BIT(_REG_GPIOAU_OEZ_L, TRUE, BIT0))
#else
...
#define Init_hwGreenLed_Pin()         {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT1);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT1);}// output enable

#if LED_Control_By_PWM
#define hw_SetAmberLed()                {Init_LEDPWM(1);}
#define hw_ClrAmberLed()                {Init_LEDPWM(0);}
#else
#define hw_IsAmberLedOn                 (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO2_OUT)))
#define hw_SetAmberLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT0);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT0);}
#define hw_ClrAmberLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT0);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT0);}
#endif
#define Init_hwAmberLed_Pin()         {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT0);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT0);}// output enable
...
#if ENABLE_5707
#define hw_SetMute()                 {AMPHWMute(TRUE);Delay1ms(10); AMPReset(TRUE);}//   AMP_SetMute(TRUE)          //(_MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT4))
#define hw_ClrMute()                  {AMPReset(FALSE);Delay1ms(10); AMP_Init();}//  AMP_SetMute(FALSE)      //(_MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, TRUE, BIT4))
#define Init_hwMute_Pin()               //(_MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT4))
#else
#define hw_SetMute()                     (MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, TRUE, BIT1))
#define hw_ClrMute()                      (MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, FALSE, BIT1))
#define Init_hwMute_Pin()             {MEM_MSWRITE_BIT(_REG_GPIOAU_SEL_L, TRUE, BIT1);MEM_MSWRITE_BIT(_REG_GPIOAU_OEZ_L, FALSE, BIT1);MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, TRUE, BIT1);}
#endif
...
#define hw_SetAudio_SD()            {MEM_MSWRITE_BIT(_REG_GPIO4_OUT, FALSE, BIT3);MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, FALSE, BIT0);}
#define hw_ClrAudio_SD()                {MEM_MSWRITE_BIT(_REG_GPIO4_OUT, TRUE, BIT3);MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, TRUE, BIT0);}
#define Init_Audio_SD_Pin()         {MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT3);MEM_MSWRITE_BIT(_REG_GPIOAU_OEZ_L, FALSE, BIT0);MEM_MSWRITE_BIT(_REG_GPIOAU_SEL_L, FALSE, BIT0);}
...
#endif
#define hw_Set_SPIFGPIO_EN_Pin()             (MEM_MSWRITE_BIT(REG_000406, TRUE, BIT0))
#define hw_Clr_SPIFGPIO_EN_Pin()             (MEM_MSWRITE_BIT(REG_000406, FALSE, BIT0))
...
#define hw_HP_DET_Pin                   (_bit6_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))
#define Init_HP_DET_Pin()               {MEM_MSWRITE_BIT(_REG_GPIO5_OEZ,TRUE,BIT6);MEM_MSWRITE_BIT(_REG_GPIO5_OUT, TRUE, BIT6);}// Opendrain enable
...
#define Init_VGA_SDA_Pin()		       (MEM_MSWRITE_BIT(_REG_GPIO4_OEZ,TRUE,BIT1))
#define Init_VGA_SCL_Pin()		       (MEM_MSWRITE_BIT(_REG_GPIO4_OEZ,TRUE,BIT0))

#define Init_Digital1_SDA_Pin()             (MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ,TRUE,BIT4))
#define Init_Digital1_SCL_Pin()             (MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ,TRUE,BIT3))

#define Init_Digital2_SDA_Pin()		(MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ,TRUE,BIT4))
#define Init_Digital2_SCL_Pin()		(MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ,TRUE,BIT3))

#define Init_Digital3_SDA_Pin()		(MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ,TRUE,BIT4))
#define Init_Digital3_SCL_Pin()		(MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ,TRUE,BIT3))

#define INIT_DDC_I2C_SDA_PIN()  {Init_VGA_SDA_Pin();Init_Digital1_SDA_Pin();Init_Digital2_SDA_Pin();Init_Digital3_SDA_Pin();} 
#define INIT_DDC_I2C_SCL_PIN()   {Init_VGA_SCL_Pin(); Init_Digital1_SCL_Pin();Init_Digital2_SCL_Pin();Init_Digital3_SCL_Pin();}

#if 0
#define Set_Panel_I2C_SDA()               (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT2))
#define Clr_Panel_I2C_SDA()               (MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT2))
#define Panel_I2C_SDAHi()                 (_bit2_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))
#define Panel_I2C_SDALo()                 (!Panel_I2C_SDAHi())

#define Set_Panel_I2C_SCL()               (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT3))
#define Clr_Panel_I2C_SCL()               (MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT3))
#define Panel_I2C_SCLHi()                 (_bit3_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))
#define Panel_I2C_SCLLo()                 (!Panel_I2C_SCLHi())

#define Init_hw_Panel_I2C_SCL_Pin()        (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT3))
#define Init_hw_Panel_I2C_SDA_Pin()        (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT2))
#else
#define Set_Panel_I2C_SDA()               (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT3),MEM_MSWRITE_BIT(_REG_GPIO5_OUT, TRUE, BIT3))
#define Clr_Panel_I2C_SDA()               (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT3),MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT3))
#define Panel_I2C_SDAHi()                 (_bit3_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))
#define Panel_I2C_SDALo()                 (!Panel_I2C_SDAHi())

#define Set_Panel_I2C_SCL()               (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT2))
#define Clr_Panel_I2C_SCL()               (MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT2))
#define Panel_I2C_SCLHi()                 (_bit2_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))
#define Panel_I2C_SCLLo()                 (!Panel_I2C_SCLHi())

#define Init_hw_Panel_I2C_SCL_Pin()        (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT2))
#define Init_hw_Panel_I2C_SDA_Pin()        (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT3))

/*
#define Set_Panel_I2C_SDA()               (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT3))
#define Clr_Panel_I2C_SDA()               (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT3),MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT3))
#define Panel_I2C_SDAHi()                 (_bit3_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))
#define Panel_I2C_SDALo()                 (!Panel_I2C_SDAHi())
...
#define Init_hwHDCP_Hpd_Pin()   (hw_Set_HdcpHpd()) //default high
...
#define Init_hwHDCP_Hpd_Pin1()  //(hw_Set_HdcpHpd1())//(hw_Set_HdcpHpd1()) //default high
...
#define Init_hwHDCP_Hpd_Pin2()  (hw_Set_HdcpHpd2())//(hw_Set_HdcpHpd2()) //default high

#define hw_Set_HdcpHpd3()       //(MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT2))
#define hw_Clr_HdcpHpd3()       //(MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT2))
#define Init_hwHDCP_Hpd_Pin3()  //(hw_Set_HdcpHpd3()) //default high
...
#define hw_Set_HdcpHpd5()       //(MEM_MSWRITE_BIT(_REG_GPIO_X5_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X5_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_000468, FALSE, BIT5))
#define hw_Clr_HdcpHpd5()       //(MEM_MSWRITE_BIT(_REG_GPIO_X5_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X5_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_000468, FALSE, BIT5))
...
#define hw_Set_DPHpd4()         (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT5))
#define hw_Clr_DPHpd4()         (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT5)) //default high
#if 0//(defined(FengYuan_Project))
#define Init_hwDP_Hpd_Pin4()    (hw_Set_DPHpd4())//(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT5))
#else
#define Init_hwDP_Hpd_Pin4()    (hw_Clr_DPHpd4())//(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT5))
#endif
...
#if 1//Disable DP 5V
#define hw_Set_DPCable5V4()     (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT4))
#define hw_Clr_DPCable5V4()     (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT4))
#define Init_hwDP_Cable5V4()    (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT4)) //default high
#else
#define hw_Set_DPCable5V4()     (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT4))
#define hw_Clr_DPCable5V4()     (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT4))
#define Init_hwDP_Cable5V4()    (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT4)) //default high
#endif
...
#if ENABLE_USB_INPUT
#define hwUSB_Pin
#define hw_USB_HI()               (MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, BIT7, BIT7))
#define hw_USB_LOW()            (MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, 0, BIT7))
#define Init_hwUSB_Pin()        (MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 0, BIT3))
#endif

#if SwitchPortByDP_Detect
#define hw_DP_DET_Pin                   (_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X3_IN)))
#define Init_DP_DET_Pin()               {MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ,TRUE,BIT1);MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, FALSE, BIT1);}// Opendrain enable
#endif
...
#define INIT_HW_POWER_KEY() (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 1, BIT4))
...
// MHL PS_CTRL
#define SET_MHL_PS_CTRL_CHARGE0()    //(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT3))
#define CLR_MHL_PS_CTRL_CHARGE0()    //(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT3))

#define SET_MHL_PS_CTRL_CHARGE1()
#define CLR_MHL_PS_CTRL_CHARGE1()

#define SET_MHL_PS_CTRL_CHARGE2()   (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT2))
#define CLR_MHL_PS_CTRL_CHARGE2()   (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT2))

#define SET_MHL_PS_CTRL_CHARGE3()   
#define CLR_MHL_PS_CTRL_CHARGE3()   
...
#define Init_CORE_PWR_VID_HIGH()    //(MEM_MSWRITE_BIT(_REG_GPIO2_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT5), 
                                    //MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT4))
