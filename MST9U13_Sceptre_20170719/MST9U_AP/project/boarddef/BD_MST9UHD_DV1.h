...
#define BOARD_NAME                  "BD_MST9UHD_DV1"
...
#define PORT_FLOW_1     MUX_COMBO4//MUX_COMBO1
#define PORT_FLOW_2     MUX_COMBO2//MUX_COMBO0
#define PORT_FLOW_3     MUX_COMBO0//MUX_COMBO2
#define PORT_FLOW_4     MUX_COMBO1//MUX_COMBO4
//#define PORT_FLOW_7

#define PORT_TYPE_0     TYPE_ANALOG
#define PORT_TYPE_1     (TYPE_DP|TYPE_HBR2_0)//(TYPE_DVI_SINGLE)
#define PORT_TYPE_2     (TYPE_HDMI |TYPE_MHL|TYPE_HDMI_2_0)//(TYPE_HDMI/* |TYPE_MHL*/) 
#define PORT_TYPE_3     (TYPE_HDMI/* |TYPE_MHL*/)//(TYPE_HDMI |TYPE_MHL|TYPE_HDMI_2_0)
#define PORT_TYPE_4     (TYPE_DVI_SINGLE)//(TYPE_DP|TYPE_HBR2_0)
...
#define DVI2ND_PORT_PRIORITY    4 //Input_Nums
#define DVI3ND_PORT_PRIORITY    4 //Input_Nums
...
#define HDMI4ND_PORT_PRIORITY   4 //Input_Nums
#define DP_PORT_PRIORITY        0 //Input_Digital1
#define DP2ND_PORT_PRIORITY     4 //Input_Digital2
#define DP3ND_PORT_PRIORITY     4 //Input_Nums
#define VD_PORT_PRIORITY       4 //Input_Digital6
...
#endif
#if DP_Port_D4
#define hwSDMDP4Pin_Pin             0//(_bit0_(MEM_MSREAD_BYTE(_REG_GPIOAU_IN_L)))
