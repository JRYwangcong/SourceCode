...
#define BOARD_NAME                  "BD_MST203B_A01A_S"
...
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT2), Clr_BacklightFlag())
...
#define Init_hwHDCP_Hpd_Pin()   (hw_Clr_HdcpHpd()) //default high
...
#define Set_EEPROM_WP()         MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT2)
#define Clr_EEPROM_WP()         MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 0, BIT2)
#define Init_hwEEPROM_WP()      MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, 0, BIT2)
...
//================================================================================================================
// 2.Backlight and panelon:
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 0, BIT5), Set_BacklightFlag())
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT5), Clr_BacklightFlag())
#define Init_hwBlacklit_Pin()   MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, 0, BIT5)
...
//to enable demo board's external DAC , // Set demo board's AUMUTE_S and AUMUTE pin to high(enable pin and mute pin of lineout and I2S amplifier)
#define hw_SetAudio_SD()            {MEM_MSWRITE_BIT(_REG_GPIO4_OUT, FALSE, BIT4);MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, FALSE, BIT0);}
#define hw_ClrAudio_SD()                {MEM_MSWRITE_BIT(_REG_GPIO4_OUT, TRUE, BIT4);MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, TRUE, BIT0);}
#define Init_Audio_SD_Pin()         {MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT4);MEM_MSWRITE_BIT(_REG_GPIOAU_OEZ_L, FALSE, BIT0);MEM_MSWRITE_BIT(_REG_GPIOAU_SEL_L, FALSE, BIT0);}
