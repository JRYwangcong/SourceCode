...
#define BOARD_NAME                  "BD_MST192A_A01A_S"
...
#define MIIC0_ENABLE    MIIC0_2_ENABLE  // MIIC0_2_ENABLE reserved for daisy chain
#define MIIC1_ENABLE    MIIC1_0_ENABLE  // EEPROM
#define USE_MIIC        MIIC1           // EEPROM HWI2C device
#if ENABLE_VBY1_TO_EDP
#define Vby1ToEDP_MIIC          MIIC0
#define Vby1ToEDP_MIIC_ENABLE   MIIC0_1_ENABLE
#endif
...
#define PORT_FLOW_5     MUX_COMBO5//MUX_COMBO4
#define PORT_FLOW_6     MUX_VD
//#define PORT_FLOW_7
...
#define TMDS_Port_D5    1 //DVI dual - master
...
#define HDMI4ND_PORT_PRIORITY   6 //Input_Nums
...
#define Init_Audio_SD_Pin()         {MEM_MSWRITE_BIT(_REG_GPIOAU_OEZ_L, FALSE, BIT0);MEM_MSWRITE_BIT(_REG_GPIOAU_SEL_L, FALSE, BIT0);}
...
#define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT2))
#define hw_Clr_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT2))
#define Init_hwHDCP_Hpd_Pin2()  (hw_Set_HdcpHpd2()) //default high
#define hw_Set_HdcpHpd3()       (MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT3))
#define hw_Clr_HdcpHpd3()       (MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT3))
...
#if TMDS_Port_D0
    #define TMDS_P0_CEC     ENALBE_CEC_SET(FALSE, GPIO26_AS_CEC)
#else
