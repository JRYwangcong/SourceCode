...
#define BOARD_NAME                  "BD_MST182A_A01B_S"
...
#endif
#if TMDS_Port_D4
#define hwDigital4Cable_Pin         (_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X5_IN)))  // GPIO_X51
#define Init_hwDigital4Cable_Pin()  (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X5_OEZ,BIT1,BIT1))
...
#define Init_hw_DP1_SDMPin()        (MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, TRUE, BIT0))
#else
