...
#define BOARD_NAME                  "BD_MST192A_A01C_S"
...
#define MIIC0_ENABLE    MIIC0_2_ENABLE // reserved (MIIC0_1_ENABLE)
#define MIIC1_ENABLE    MIIC1_0_ENABLE // EEPROM
#define USE_MIIC        MIIC1
...
//------Memory Setting----------------------------------------------------------
#ifndef MEMORY_MAP
#define MEMORY_MAP                      MMAP_256_256MB
#endif
...
#define PORT_FLOW_6     MUX_COMBO5
//#define PORT_FLOW_7

#define PORT_TYPE_0     TYPE_ANALOG
#define PORT_TYPE_1     (TYPE_DP)
#define PORT_TYPE_2     (TYPE_DP)
#define PORT_TYPE_3     (TYPE_DP)
#define PORT_TYPE_4     (TYPE_DP)
#define PORT_TYPE_5     (TYPE_DP| TYPE_HBR2_0)
#define PORT_TYPE_6     (TYPE_DP| TYPE_HBR2_1)
//#define PORT_TYPE_7

// Define TMDS/DP port used
#define TMDS_Port_D0    0 //none
#define TMDS_Port_D1    0 //none
#define TMDS_Port_D2    0 //none
#define TMDS_Port_D3    0 //none
...
#define DP_Port_D0      1 //DP
#define DP_Port_D1      1 //DP
#define DP_Port_D2      1 //DP
#define DP_Port_D3      1 //DP
#define DP_Port_D4      1 //DP
#define DP_Port_D5      1 //DP
...
#define DVI_PORT_PRIORITY       7 //Input_Nums
#define DVI2ND_PORT_PRIORITY    7 //Input_Nums
#define DVI3ND_PORT_PRIORITY    7 //Input_Nums
#define HDMI_PORT_PRIORITY      7 //Input_Nums
#define HDMI2ND_PORT_PRIORITY   7 //Input_Nums
#define HDMI3ND_PORT_PRIORITY   7 //Input_Nums
#define HDMI4ND_PORT_PRIORITY   7 //Input_Nums
#define DP_PORT_PRIORITY        1 //Input_Digital1
#define DP2ND_PORT_PRIORITY     2 //Input_Digital2
#define DP3ND_PORT_PRIORITY     3 //Input_Digital3
#define DP4ND_PORT_PRIORITY     4 //Input_Digital4
#define DP5ND_PORT_PRIORITY     5 //Input_Digital5
#define DP6ND_PORT_PRIORITY     6 //Input_Digital6
#define VD_PORT_PRIORITY        7 //Input_Nums
...
#define BACKLIGHT_PWM_DUTY           0x7F //0~0xFFFF  50%
#define BACKLIGHT_PWM_CONFIG        _PWM_DB_EN_
#define BACKLIGHT_PWM_VS_ALG_NUM    _NO_USE_//vsync align number
#if AudioFunc
#define VOLUME_PWM               _NO_USE_ // Not Finishhed Yet in CHIP_FAMILY_TSUMC
#define VOLUME_PWM_FREQ          _NO_USE_
#define VOLUME_PWM_DUTY          0x7F //0~0xFFFF  50%
#define VOLUME_PWM_CONFIG        _NO_USE_
...
#define CABLE_DET_DIGITAL1_SAR      0
#endif
#if TMDS_Port_D2 // SAR9, schematic might be not correct
#define hwDigital2Cable_Pin         (KEYPAD_SAR09)
#define Init_hwDigital2Cable_Pin()  (MEM_MSWRITE_BIT(REG_003A69,1,BIT1)) // Enable SAR ch
#define CABLE_DET_DIGITAL2_SAR      SAR9_EN
#else
#define hwDigital2Cable_Pin         0
#define Init_hwDigital2Cable_Pin()
#define CABLE_DET_DIGITAL2_SAR      0
#endif
#if TMDS_Port_D3// SAR8, schematic might be not correct
#define hwDigital3Cable_Pin         (KEYPAD_SAR08)
#define Init_hwDigital3Cable_Pin()  (MEM_MSWRITE_BIT(REG_003A69,1,BIT0)) // Enable SAR ch
...
#endif
#if TMDS_Port_D5
#define hwDigital5Cable_Pin         (_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X5_IN)))  // GPIO_X51
#define Init_hwDigital5Cable_Pin()  (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X5_OEZ,BIT1,BIT1))
...
#define Init_hw_DP0_SDMPin()        {MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, TRUE, BIT0);MEM_MSWRITE_BIT(REG_000462, FALSE, BIT0);}
#else
...
#define hwSDMDP1Pin_Pin         	(KEYPAD_SAR10<=((255ul*200)/330)?TRUE:FALSE)	// FALSE: connected, TRUE: not connected
#define Init_hw_DP1_SDMPin()        {MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, TRUE, BIT0);MEM_MSWRITE_BIT(REG_000462, FALSE, BIT2);\
									 MEM_MSWRITE_BIT(REG_003A69, TRUE, BIT2);\
									 MEM_MSWRITE_BIT(_REG_GPIO6_OEZ, FALSE, BIT0);}	// SAR10 for SDM detect, GPIO60 for SDM forward									 
#define DC_SDM_DET_SAR_EN			SAR10_EN
	#else
#define hwSDMDP1Pin_Pin             (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X1_IN)))      //GPIOX10
#define Init_hw_DP1_SDMPin()        {MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, TRUE, BIT0);MEM_MSWRITE_BIT(REG_000462, FALSE, BIT2);}
	#endif
#else
...
#endif
#if DP_Port_D2
#define hwSDMDP2Pin_Pin             (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X2_IN)))      //GPIOX20
#define Init_hw_DP2_SDMPin()        (MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, TRUE, BIT0))
#else
#define hwSDMDP2Pin_Pin             0
#define Init_hw_DP2_SDMPin()
#endif
#if DP_Port_D3
#define hwSDMDP3Pin_Pin             (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X3_IN)))      //GPIOX30
#define Init_hw_DP3_SDMPin()        (MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, TRUE, BIT0))
#else
#define hwSDMDP3Pin_Pin             0
#define Init_hw_DP3_SDMPin()
#endif
#if DP_Port_D4
#define hwSDMDP4Pin_Pin             (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X4_IN)))      //GPIOX40
#define Init_hw_DP4_SDMPin()        (MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, TRUE, BIT0))
#else
#define hwSDMDP4Pin_Pin             0
#define Init_hw_DP4_SDMPin()
#endif
#if DP_Port_D5
#define hwSDMDP5Pin_Pin             (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X5_IN)))      //GPIOX50
#define Init_hw_DP5_SDMPin()        (MEM_MSWRITE_BIT(_REG_GPIO_X5_OEZ, TRUE, BIT0))
#else
...
#if 1
#define hw_SetAudio_SD()            (MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, FALSE, BIT0))
#define hw_ClrAudio_SD()                (MEM_MSWRITE_BIT(_REG_GPIOAU_OUT_L, TRUE, BIT0))
#define Init_Audio_SD_Pin()         (MEM_MSWRITE_BIT(_REG_GPIOAU_OEZ_L, FALSE, BIT0))  //[4] Lineout output control on GPIO01
#define Init_SPIFGPIO_Pin()         (MEM_MSWRITE_BIT(REG_000406, TRUE, BIT0))   //[0]S/PDIF output control on SPDIFO (GPIOA8)
...
#if !USEFLASH
#define hwI2C_SCL_Pin               // GPIO53
#define hwI2C_SDA_Pin               // GPIO52
#if PANEL_EDP
#define Init_hwI2C_SCL_Pin()        (MEM_MSWRITE_BIT(REG_1408A3,TRUE,BIT3))
#define Init_hwI2C_SDA_Pin()        (MEM_MSWRITE_BIT(REG_1408A3,TRUE,BIT2))

#define Set_i2c_SDA()               (MEM_MSWRITE_BIT(REG_1408A3,TRUE,BIT2))
#define Clr_i2c_SDA()               (MEM_MSWRITE_BIT(REG_1408A3,FALSE,BIT6),MEM_MSWRITE_BIT(REG_1408A3,FALSE,BIT2))
#define i2c_SDAHi()                 (_bit2_(MEM_MSREAD_BYTE(REG_1408A4)))
#define i2c_SDALo()                 (!i2c_SDAHi())
#define Set_i2c_SCL()               (MEM_MSWRITE_BIT(REG_1408A3,TRUE,BIT3))
#define Clr_i2c_SCL()               (MEM_MSWRITE_BIT(REG_1408A3,FALSE,BIT7),MEM_MSWRITE_BIT(REG_1408A3,FALSE,BIT3))
#define i2c_SCLHi()                 (_bit3_(MEM_MSREAD_BYTE(REG_1408A4)))
...
#define hw_Set_HdcpHpd1()       (MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, TRUE, BIT2))
#define hw_Clr_HdcpHpd1()       (MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, FALSE, BIT2))
#define Init_hwHDCP_Hpd_Pin1()  (hw_Set_HdcpHpd1()) //default high
#define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, TRUE, BIT2))
#define hw_Clr_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, FALSE, BIT2))
#define Init_hwHDCP_Hpd_Pin2()  (hw_Set_HdcpHpd2()) //default high
#define hw_Set_HdcpHpd3()       (MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, TRUE, BIT2))
#define hw_Clr_HdcpHpd3()       (MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, FALSE, BIT2))
...
#define hw_Set_HdcpHpd5()       (MEM_MSWRITE_BIT(_REG_GPIO_X5_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X5_OEZ, FALSE, BIT2))
#define hw_Clr_HdcpHpd5()       (MEM_MSWRITE_BIT(_REG_GPIO_X5_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X5_OEZ, FALSE, BIT2))
...
#define Init_hwDP_TXPWR_Pin() 	(MEM_MSWRITE_BIT(_REG_GPIO_X0_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, FALSE, BIT1))  //DP Rx PWR pin should default be 3.3V
#define hw_Set_DP_TXPWR_Pin()	(MEM_MSWRITE_BIT(_REG_GPIO_X0_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, FALSE, BIT1))  //DP Rx PWR pin should default be 3.3V
#define hw_Clr_DP_TXPWR_Pin()	(MEM_MSWRITE_BIT(_REG_GPIO_X0_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, FALSE, BIT1))  //DP Rx PWR pin should default be 3.3V
...
#define Init_hwDP_Hpd_Pin1()    (MEM_MSWRITE_BIT(REG_000462, TRUE, BIT3),MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, FALSE, BIT2))
#define hw_Set_DPHpd1()         (MEM_MSWRITE_BIT(REG_000462, TRUE, BIT3),MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, FALSE, BIT2))
#define hw_Clr_DPHpd1()         (MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, FALSE, BIT2)) //default high
...
#define Init_hwDP_Hpd_Pin4()    (MEM_MSWRITE_BIT(REG_000463, TRUE, BIT1),MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT2))
#define hw_Set_DPHpd4()         (MEM_MSWRITE_BIT(REG_000463, TRUE, BIT1),MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT2))
#define hw_Clr_DPHpd4()         (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT2)) //default high
...
#define hw_Set_DPCable5V1()     (MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, FALSE, BIT1))
#define hw_Clr_DPCable5V1()     (MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, TRUE, BIT1))
#define Init_hwDP_Cable5V1()    (MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, FALSE, BIT1)) //default high
...
#define hw_Set_DPCable5V4()     (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT1))
#define hw_Clr_DPCable5V4()     (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, TRUE, BIT1))
#define Init_hwDP_Cable5V4()    (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT1)) //default high
...
#if ENABLE_VD_INPUT
#define Init_CORE_PWR_VID_HIGH()
#define Init_CORE_PWR_VID_LOW()
#else
#define Init_CORE_PWR_VID_HIGH()    (MEM_MSWRITE_BIT(_REG_GPIO6_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO6_OEZ, FALSE, BIT2), \
                                    MEM_MSWRITE_BIT(_REG_GPIO6_OUT, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_GPIO6_OEZ, FALSE, BIT3))
#define Init_CORE_PWR_VID_LOW()     (MEM_MSWRITE_BIT(_REG_GPIO6_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO6_OEZ, FALSE, BIT2), \
                                    MEM_MSWRITE_BIT(_REG_GPIO6_OUT, TRUE, BIT3), MEM_MSWRITE_BIT(_REG_GPIO6_OEZ, FALSE, BIT3))
#endif

//EP 1.2
//#define Set_PD_CTL_E_High()         (MEM_MSWRITE_BIT(_REG_GPIO6_OUT, 1, BIT1))
//#define Set_PD_CTL_E_Low()          (MEM_MSWRITE_BIT(_REG_GPIO6_OUT, 0, BIT1))
//#define Init_PD_CTL_E_Pin()         (MEM_MSWRITE_BIT(_REG_GPIO6_OEZ, 0, BIT1))
