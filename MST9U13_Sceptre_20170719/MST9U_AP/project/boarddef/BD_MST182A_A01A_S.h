...
#define BOARD_NAME                  "BD_MST182A_A01A_S"
...
#endif
#if TMDS_Port_D2
#define hwDigital2Cable_Pin         (KEYPAD_SAR06)
#define Init_hwDigital2Cable_Pin()  (MEM_MSWRITE_BIT(REG_003A68,1,BIT6)) // Enable SAR ch
#define CABLE_DET_DIGITAL2_SAR      SAR6_EN
#else
...
#endif
#if TMDS_Port_D3
#define hwDigital3Cable_Pin         (KEYPAD_SAR07)
#define Init_hwDigital3Cable_Pin()  (MEM_MSWRITE_BIT(REG_003A68,1,BIT7)) // Enable SAR ch
#define CABLE_DET_DIGITAL3_SAR      SAR7_EN
#else
...
#define hw_Set_HdcpHpd4()
#define hw_Clr_HdcpHpd4()
#define Init_hwHDCP_Hpd_Pin4()
