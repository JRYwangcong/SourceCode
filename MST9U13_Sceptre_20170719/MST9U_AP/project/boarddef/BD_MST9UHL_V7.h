...
#define BOARD_NAME                  "BD_MST9UHL_V7"
...
//------IR & Key Setting--------------------------------------------------------
#if (defined(LeXingEnMa_Project)||defined(ZhouYang_Project)||defined(KunDe_Project)||defined(MingCai_Project)||JieBo_IR_Function_Enable||defined(TaiBei_Project)||defined(HuaKe_Project)||defined(FengYuan_Project)||defined(ZhongChuangLianHe_Project)||(defined(Changjia_Project)))
...
#define PORT_FLOW_0     MUX_RESERVED
#define PORT_FLOW_1     MUX_COMBO2
#define PORT_FLOW_2     MUX_COMBO4
#define PORT_FLOW_3     MUX_RESERVED
//#define PORT_FLOW_7

#define PORT_TYPE_0     TYPE_RESERVED
#define PORT_TYPE_1     (TYPE_HDMI |TYPE_HDMI_2_0) 
...
#define TMDS_Port_D1    0 //DVI dual
#define TMDS_Port_D2    1 //HDMI
#define TMDS_Port_D3    0 //DVI dual - master
...
#define PORT_FLOW_0     MUX_RESERVED
#define PORT_FLOW_1     MUX_COMBO2
#define PORT_FLOW_2     MUX_RESERVED
#define PORT_FLOW_3     MUX_RESERVED
//#define PORT_FLOW_7

#define PORT_TYPE_0     TYPE_RESERVED
#define PORT_TYPE_1     (TYPE_HDMI |TYPE_HDMI_2_0) 
#define PORT_TYPE_2     (TYPE_RESERVED)
#define PORT_TYPE_3     (TYPE_RESERVED)
//#define PORT_TYPE_7
...
#define DP_Port_D2      0 //none
#define DP_Port_D3      0 //none
#define DP_Port_D4      0 //DP
#define DP_Port_D5      0 //none
#define DP_Port_Num     (DP_Port_D0+DP_Port_D1+DP_Port_D2+DP_Port_D3+DP_Port_D4+DP_Port_D5)
#endif
#else
#define PORT_FLOW_0     MUX_ADC
#define PORT_FLOW_1     MUX_COMBO1
#define PORT_FLOW_2     MUX_COMBO2
#define PORT_FLOW_3     MUX_COMBO4
//#define PORT_FLOW_7

#define PORT_TYPE_0     TYPE_ANALOG
#define PORT_TYPE_1     TYPE_DVI_DUAL 
#define PORT_TYPE_2     (TYPE_HDMI |TYPE_MHL|TYPE_HDMI_2_0)
#define PORT_TYPE_3     (TYPE_DP|TYPE_HBR2_0)
//#define PORT_TYPE_7

// Define TMDS/DP port used
#define TMDS_Port_D0    0 //none
#define TMDS_Port_D1    1 //DVI dual
#define TMDS_Port_D2    1 //HDMI
#define TMDS_Port_D3    0 //DVI dual - master
#define TMDS_Port_D4    0 //none
#define TMDS_Port_D5    0 //DVI dual - master
...
#define HDMI3ND_PORT_PRIORITY   3 //Input_Nums
#define HDMI4ND_PORT_PRIORITY   3 //Input_Nums
#define DP_PORT_PRIORITY           3 //Input_Digital1
#define DP2ND_PORT_PRIORITY     3 //Input_Digital2
#define DP3ND_PORT_PRIORITY     3 //Input_Nums
#define VD_PORT_PRIORITY       3 //Input_Digital6
#endif
#else
#define DVI_PORT_PRIORITY       0 //Input_Digital5
#define DVI2ND_PORT_PRIORITY    3 //Input_Nums
#define DVI3ND_PORT_PRIORITY    3 //Input_Nums
...
#define HDMI3ND_PORT_PRIORITY   3 //Input_Nums
#define HDMI4ND_PORT_PRIORITY   3 //Input_Nums
#define DP_PORT_PRIORITY        2 //Input_Digital1
#define DP2ND_PORT_PRIORITY     3 //Input_Digital2
#define DP3ND_PORT_PRIORITY     3 //Input_Nums
#define VD_PORT_PRIORITY       3 //Input_Digital6
#endif
...
#define IS_LED_Power()         (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X3_IN)))
#define Set_LED_Power()         MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, 1, BIT0)
#define Clr_LED_Power()         MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, 0, BIT0)
#define Init_LED_Power()        MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, 0, BIT0)
#endif
...
#define hw_SetPanel()              (MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, 0, BIT6),MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 0, BIT2))
#define hw_ClrPanel()              (MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, 1, BIT6),MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT2))
#define Init_hwPanel_Pin()      (MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, 1, BIT6),MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT2))
...
#endif
#if TMDS_Port_D3//
#define hwDigital3Cable_Pin         //(_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X4_IN)))
#define Init_hwDigital3Cable_Pin()  //(MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X4_OEZ,BIT1,BIT1))
...
#endif
#if DP_Port_D4
#define hwSDMDP4Pin_Pin             (_bit6_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))//GPIO_06, HW rework//  (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X0_IN)))      //GPIOX00
#define Init_hw_DP4_SDMPin()        (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT6))//(MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, TRUE, BIT0))
#else
...
#define hw_SetGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT1);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT1);}
#define hw_ClrGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT1);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT1);}
#define Init_hwGreenLed_Pin()           hw_SetGreenLed()// output enable
...
#define Init_hwAmberLed_Pin()           {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT0);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT0);}// output enable
...
#define hw_Set_HdcpHpd()        //(MEM_MSWRITE_BIT(_REG_GPIO_X0_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, TRUE, BIT2))
#define hw_Clr_HdcpHpd()        //(MEM_MSWRITE_BIT(_REG_GPIO_X0_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, FALSE, BIT2))
#define Init_hwHDCP_Hpd_Pin()   //(hw_Set_HdcpHpd()) //default high

#define hw_Set_HdcpHpd1()       (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_0031F2, TRUE, BIT0))
#define hw_Clr_HdcpHpd1()       (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_0031F2, TRUE, BIT0))
...
#if AIO_Board
#define Init_hwHDCP_Hpd_Pin2()  (hw_Set_HdcpHpd2()) //default high
#else
#define Init_hwHDCP_Hpd_Pin2()  (hw_Clr_HdcpHpd2())//(hw_Set_HdcpHpd2()) //default high
#endif

#define hw_Set_HdcpHpd3()       //(MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT2))
#define hw_Clr_HdcpHpd3()       //(MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_000468, TRUE, BIT2))
