...
#define BOARD_NAME                  "BD_MST9UHL_A0"
...
#define PORT_TYPE_3     TYPE_DVI_DUAL
//#define PORT_TYPE_7
...
#define Init_hwGreenLed_Pin()           {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT1);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT1);}// output enable
