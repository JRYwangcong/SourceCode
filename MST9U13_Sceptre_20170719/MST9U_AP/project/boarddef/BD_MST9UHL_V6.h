...
#define BOARD_NAME                  "BD_MST9UHL_V6"
...
//------IR & Key Setting--------------------------------------------------------
#if (defined(LeXingEnMa_Project)||defined(ZhouYang_Project)||defined(KunDe_Project)||defined(MingCai_Project)||JieBo_IR_Function_Enable||defined(TaiBei_Project)||defined(HuaKe_Project)||defined(FengYuan_Project)||defined(ZhongChuangLianHe_Project)||(defined(Changjia_Project))||(defined(XuLi_Project))||LHCX_IR_Function_Enable)
