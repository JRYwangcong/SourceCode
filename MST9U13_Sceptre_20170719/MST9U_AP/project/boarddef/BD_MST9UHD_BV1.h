...
#define BOARD_NAME                  "BD_MST9UHD_BV1"
...
#define PORT_TYPE_4     (TYPE_HDMI)
*/
#define PORT_FLOW_0     MUX_ADC
#define PORT_FLOW_1     MUX_COMBO2
#define PORT_FLOW_2     MUX_COMBO0
#define PORT_FLOW_3     MUX_COMBO1
#define PORT_FLOW_4     MUX_COMBO4
//#define PORT_FLOW_7

#define PORT_TYPE_0     TYPE_ANALOG
#define PORT_TYPE_1     (TYPE_HDMI |TYPE_MHL|TYPE_HDMI_2_0)
#define PORT_TYPE_2     (TYPE_HDMI/* |TYPE_MHL*/) 
#define PORT_TYPE_3     (TYPE_HDMI)
#define PORT_TYPE_4     (TYPE_DP|TYPE_HBR2_0)
...
#define HDMI2ND_PORT_PRIORITY   1 //Input_Digital4
#define HDMI3ND_PORT_PRIORITY   2 //Input_Nums
