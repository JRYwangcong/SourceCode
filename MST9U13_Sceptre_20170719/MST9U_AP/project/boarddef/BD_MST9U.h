...
typedef enum // UART GPIO //MST9U4_TBD
{
    UART_GPIO02_03,
    UART_GPIO40_41,  // VGA ?
    UART_GPIO50_51,
...
#define DFT_R2_UART0_GPIO           UART_GPIOX03_04 // default mux uart 0
...
#define PORT_FLOW_7     MUX_COMBO6
#define PORT_FLOW_8     MUX_COMBO7


//#define PORT_TYPE_0     TYPE_ANALOG
#define PORT_TYPE_1     (TYPE_HDMI | TYPE_MHL)
#define PORT_TYPE_2     (TYPE_HDMI | TYPE_MHL)
#define PORT_TYPE_3     (TYPE_HDMI | TYPE_MHL)
#define PORT_TYPE_4     (TYPE_HDMI | TYPE_MHL)
#define PORT_TYPE_5     (TYPE_DP | TYPE_DP_MST)
#define PORT_TYPE_6     (TYPE_DP)
#define PORT_TYPE_7     (TYPE_DP)
#define PORT_TYPE_8     (TYPE_VBY1)
...
#define TMDS_Port_D6    0 //none
#define TMDS_Port_Num   (TMDS_Port_D0+TMDS_Port_D1+TMDS_Port_D2+TMDS_Port_D3+TMDS_Port_D4+TMDS_Port_D5+TMDS_Port_D6)
...
#define DP_Port_D6      1 //DP
#define DP_Port_Num     (DP_Port_D0+DP_Port_D1+DP_Port_D2+DP_Port_D3+DP_Port_D4+DP_Port_D5+DP_Port_D6)
//=================================================
//for switch input port priority and input source OSD item priority setting
#define DVI_PORT_PRIORITY       8 //Input_Digital5
#define DVI2ND_PORT_PRIORITY    8 //Input_Nums
#define DVI3ND_PORT_PRIORITY    8 //Input_Nums
...
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT6), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT6), BackLightActiveFlag=0)
...
#if PANEL_I2C_CONTROL
#define Init_Panel_I2C_SDA_Pin()    (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT2))
#define Init_Panel_I2C_SCL_Pin()    (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, TRUE, BIT3))
...
#define hw_Set_HdcpHpd1()       (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_0031F2, FALSE, BIT0))
#define hw_Clr_HdcpHpd1()       (MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_0031F2, FALSE, BIT0))
...
#else
#define Init_hwDP_Hpd_Pin4()     (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT5),MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT5))
#define hw_Set_DPHpd4()            (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT5),MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT5))
...
#define ADCKEY_B0       KEY_TICK  //KEY_EXIT
