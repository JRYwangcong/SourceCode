...
typedef enum
{
	SCA_FIRE_DISABLE=0x00, //Disable all scaler menu load
	SCA_FIRE_FIXL0=0x01,// select scaler common write mode select L0
	SCA_FIRE_FIXL1=0x02,// select scaler common write mode select L1
	SCA_FIRE_FIXR0=0x04,// select scaler common write mode select R0
	SCA_FIRE_FIXR1=0x08,// select scaler common write mode select R1
	SCA_FIRE_FIXALL=0x2F,
	SCA_FIRE_FIXDEF=SCA_FIRE_FIXL0,   // select scaler common write mode by Def L0
}MS_MLCOMWRITEMODE;
