...
#define ALIGN_64(_x_)               (((_x_) + 63) & ~63)           // No data type specified, optimized by complier
#define ALIGN_128(_x_)              (((_x_) + 127) & ~127)        // No data type specified, optimized by complier
#define ALIGN_256(_x_)              (((_x_) + 255) & ~255)        // No data type specified, optimized by complier
