...
typedef enum _BDMA_SrcDev
{
    ...
    ,E_BDMA_SRCDEV_SPI1			= E_BDMA_DEV_SRC_SPI1
...
typedef enum _BDMA_DstDev
{
    ...
    ,E_BDMA_DSTDEV_SPI0			= E_BDMA_DEV_DST_SPI0
    ,E_BDMA_DSTDEV_SPI1			= E_BDMA_DEV_DST_SPI1
...
typedef enum _BDMA_CpyType
{
    ...
    ,E_BDMA_FLASH2SDRAM2        = BDMA_SET_CPYTYPE(E_BDMA_DEV_FLASH, E_BDMA_DEV_MIU2)
	,E_BDMA_FLASH12SDRAM 		= BDMA_SET_CPYTYPE(E_BDMA_DEV_SRC_SPI1, E_BDMA_DEV_MIU0)
	,E_BDMA_FLASH12SDRAM1		= BDMA_SET_CPYTYPE(E_BDMA_DEV_SRC_SPI1, E_BDMA_DEV_MIU1)
	,E_BDMA_FLASH12SDRAM2		= BDMA_SET_CPYTYPE(E_BDMA_DEV_SRC_SPI1, E_BDMA_DEV_MIU2)
    ...
    ,E_BDMA_SDRAM02FLASH0       = BDMA_SET_CPYTYPE(E_BDMA_DEV_MIU0, E_BDMA_DEV_DST_SPI0)
    ,E_BDMA_SDRAM02FLASH1		= BDMA_SET_CPYTYPE(E_BDMA_DEV_MIU0, E_BDMA_DEV_DST_SPI1)
    ,E_BDMA_SDRAM12FLASH0		= BDMA_SET_CPYTYPE(E_BDMA_DEV_MIU1, E_BDMA_DEV_DST_SPI0)
    ,E_BDMA_SDRAM12FLASH1		= BDMA_SET_CPYTYPE(E_BDMA_DEV_MIU1, E_BDMA_DEV_DST_SPI1)
    ,E_BDMA_SDRAM22FLASH0		= BDMA_SET_CPYTYPE(E_BDMA_DEV_MIU2, E_BDMA_DEV_DST_SPI0)
    ,E_BDMA_SDRAM22FLASH1		= BDMA_SET_CPYTYPE(E_BDMA_DEV_MIU2, E_BDMA_DEV_DST_SPI1)
    ,E_BDMA_CPYTYPE_MAX
}BDMA_CpyType;
...
BDMA_Result MDrv_BDMA_MultiMemCopy(BDMA_Dev eSrcDev, BDMA_Dev eDstDev ,MS_PHYADDR u32SrcAddr, MS_PHYADDR u32DstAddr, MS_U32 u32Len);
BDMA_Result MDrv_BDMA_FlashCopy2Dram(MS_PHYADDR u32FlashAddr, MS_PHYADDR u32DramAddr, MS_U32 u32Len);
BDMA_Result MDrv_BDMA_MultiFlashCopy2Dram(BDMA_Dev eSrcDev, BDMA_Dev eDstDev ,MS_PHYADDR u32FlashAddr, MS_PHYADDR u32DramAddr, MS_U32 u32Len);
BDMA_Result MDrv_BDMA_MemCopySPI(MS_PHYADDR u32SrcAddr, MS_PHYADDR u32DstAddr,MS_U32 u32Len, BDMA_SrcDev eSrcDev,BDMA_DstDev eDstDev);
