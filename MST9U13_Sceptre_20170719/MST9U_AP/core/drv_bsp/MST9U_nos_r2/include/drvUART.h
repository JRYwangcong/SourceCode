...
typedef enum
{
    ...
    E_UART_AEON_PQ_R2,      ///< AEON_R2 for PQ
...
typedef enum
{
    ...
    E_UART_PORT_GPIO02_03,
    E_UART_PORT_GPIO40_41,  // VGA ?
    E_UART_PORT_GPIO50_51,
    E_UART_PORT_GPIOX03_04, // combo 0
    E_UART_PORT_GPIOX13_14, // combo 1
    E_UART_PORT_GPIOX23_24, // combo 2
    E_UART_PORT_GPIOX33_34, // combo 3
    E_UART_PORT_GPIOX43_44, // combo 4
    E_UART_PORT_GPIOX53_54 // combo 5
} UART_PORT_TYPE;
...
//set uart using printf function if need to print message
void MDrv_UART_SetIsPrint(MS_BOOL bEnPrint);
