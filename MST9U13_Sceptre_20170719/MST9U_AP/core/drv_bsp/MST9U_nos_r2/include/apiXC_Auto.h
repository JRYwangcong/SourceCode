...
typedef enum
{
    E_XC_CALIBRATION_REF_LDO,
    E_XC_CALIBRATION_REF_BANDGAP,
} XC_Auto_CalibrationRefSrc;
...
//***************************************************************************
///-This function is to set ADC calibration reference source 
/// @param  eType        \b IN: Reference source for calibration
/// @return @ref MS_BOOL
//***************************************************************************
MS_BOOL MApi_XC_Auto_SetCalibrationRefSource(XC_Auto_CalibrationRefSrc eType);

//***************************************************************************
///-This function is to get ADC calibration reference source
/// @param  eType        \b OUT: Reference source for calibration
//***************************************************************************
void MApi_XC_Auto_GetCalibrationRefSource(XC_Auto_CalibrationRefSrc *eType);
