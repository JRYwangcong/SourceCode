...
//-------------------------------------------------------------------------------------------------
    ...
    void MDrv_COPRO_Enable(MS_U32 u32Addr);
    MS_U32 MDrv_COPRO_Init_Front(void);
    void   MDrv_COPRO_Init_End(MS_U32 u32Addr);
    ...
    MS_U32 MDrv_CPU_SetClock(MS_U32 u32CpuClock);
