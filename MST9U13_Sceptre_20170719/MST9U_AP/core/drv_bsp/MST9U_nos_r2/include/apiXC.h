...
#define MSIF_XC_BUILDNUM               {'1','1'}
#define MSIF_XC_CHANGELIST             {'0','0','4','2','0','3','5','2'}
...
typedef enum
{
    E_XC_MCDI_ME1 = 0,          ///< MDCI ME1
    E_XC_MCDI_ME2 = 1,          ///< MDCI ME2
    E_XC_MCDI_BOTH,             ///< MDCI ME1+ME2
}E_XC_MCDI_TYPE;
...
typedef enum
{
    ...
    E_LD_PANEL_Konka42inch_LR16 = 0x6,
    E_LD_PANEL_DEFAULT,
    E_LD_PANEL_NUMS,
}Eun_LD_PANEL_TYPE;
...
///     MApi_XC_GetStatusEx(&stXCStatus, MAIN_WINDOW);
...
//-------------------------------------------------------------------------------------------------
/// Get current mirror mode type
/// @return @ref MirrorMode_t Mirror mode type.
//-------------------------------------------------------------------------------------------------
...
/// @return E_APIXC_RET_OK or E_APIXC_RET_FAIL
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_XC_LD_Init(Eun_LD_PANEL_TYPE eLdPanelType );
//-------------------------------------------------------------------------------------------------
...
/// @return E_APIXC_RET_OK or E_APIXC_RET_FAIL
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_XC_LD_SetLevel(Enu_LD_Mode eMode);
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
/// set XC compression mode
/// @param  bEnable                   \b IN: enable or disable
/// @param  eWindow                 \b IN: which window we are going to enable or disable
//-------------------------------------------------------------------------------------------------
void MApi_XC_SetCompressionMode(MS_BOOL bEnable, SCALER_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
/// Enable or Disable AutoIncreaseFrameCount function
/// @param   bEnable                                 \b IN: enable/disable
/// @return  TRUE if succeed, FALSE if failed
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_XC_EnableAutoIncreaseFrameCount(MS_BOOL bEnable);
