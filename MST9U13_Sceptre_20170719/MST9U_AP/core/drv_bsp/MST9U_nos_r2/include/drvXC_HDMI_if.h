...
INTERFACE MS_U8 MDrv_HDMI_Get_AVIInfoFrameVer(void);
...
INTERFACE void MDrv_HDMI_Get_KSV_info(MS_U8 * pu8KSVData);
...
INTERFACE void MDrv_HDMI_POWER_OFF(void);
//#endif
