...
typedef struct
{
    ...
    ///panel h-start.
    MS_U16 u16PanelHStr;
    /// panel with guard band like scaler
    MS_U16 u16PanelGuardBand;
...
typedef struct
{
    ...
    /// gwin dram offset address (unit: Byte).
    MS_U16 u16DataOffsetAddress;
} GOP_GwinInfo;
...
MS_U16 MApi_GOP_GetCurrentHPipe(MS_U8 u8GOP);
...
E_GOP_API_Result MApi_GOP_TestPatternEx(GOP_TSTPATTERN *pPattern);
...
E_GOP_API_Result MApi_GOP_GWIN_Delete2Win(MS_U8 win1Id, MS_U8 win2Id);
...
E_GOP_API_Result MApi_GOP_GWIN_SetHSPipe(MS_U8 u8GOPNum,MS_U16 u16HSPipe);
...
E_GOP_API_Result MApi_GOP_GWIN_Set2WinPosition(MS_U8 win1Id, MS_U8 win2Id, MS_U16 dispX, MS_U16 dispY);
...
E_GOP_API_Result MApi_GOP_GWIN_UpdateRegAllBankOnceEx(MS_BOOL bWriteRegOnce);
...
MS_U8 MApi_GOP_GWIN_Create2Win(MS_U16 width, MS_U16 height, MS_U16 fbFmt, MS_U8 *pWin1Id, MS_U8 *pWin2Id, MS_U8 u8RightGOP);
...
E_GOP_API_Result MApi_GOP_GWIN_MapFBTo2Win(MS_U8 fbId, MS_U8 gwin1Id, MS_U8 gwin2Id);
