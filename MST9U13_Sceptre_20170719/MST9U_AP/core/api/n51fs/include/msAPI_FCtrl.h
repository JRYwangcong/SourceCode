...
INTERFACE U8 msAPI_FCtrl_FileOpen(FileEntry* pFileEntry, U8 u8OpenMode);
...
INTERFACE U8 msAPI_FCtrl_FileCreate_WithoutNameChecking(U8 u8enid, U16 *pu16LongName, U8 charLen);
