...
#endif
// compare internal SW version between current code and USB bin file.
#define ENABLE_USB_DOWNLOAD_USE_AP_SW_VERSION 0  
// search latest bin file by file name
#define ENABLE_USB_DOWNLOAD_USE_VERSION_BY_FILENAME (0&&!ENABLE_USB_DOWNLOAD_USE_AP_SW_VERSION)
...
INTERFACE BOOLEAN MW_UsbDownload_Start(BOOL bFullDL);
