...
static void ProcessCPU0toCPU1Isr(MHAL_SavedRegisters *pHalReg, U32 vector)
{
    ...
    MsOS_EnableInterrupt(E_INT_FIQ_8051_TO_R2);
}
...
static void ProcessCPU2toCPU1Isr(MHAL_SavedRegisters *pHalReg, U32 vector)
{
    ...
    MsOS_EnableInterrupt(E_INT_FIQ_PQR2_TO_R2);
}

static void ProcessCPU3toCPU1Isr(MHAL_SavedRegisters *pHalReg, U32 vector)
{
    UNUSED(pHalReg);
    UNUSED(vector);
...
{
    MsOS_AttachInterrupt(E_INT_FIQ_8051_TO_R2, (InterruptCb)ProcessCPU0toCPU1Isr);
    MsOS_AttachInterrupt(E_INT_FIQ_PQR2_TO_R2, (InterruptCb)ProcessCPU2toCPU1Isr);
    MsOS_AttachInterrupt(E_INT_FIQ_HST3TOHST1_INT, (InterruptCb)ProcessCPU3toCPU1Isr);
