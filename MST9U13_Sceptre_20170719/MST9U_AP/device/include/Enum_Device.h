...
//------------------------------------------------------------------------------------
//DVB demodulator
#define ZARLINK_ZL10353_DEMODE          0x10 // DVB COFDM Demodulator
#define ZARLINK_CE6355_DEMOD            0x11 // DVB COFDM Demodulator
#define MSTAR_MSB1200_DEMOD             0x12 // DVB COFDM Demodulator
#define MSTAR_MSB1210_DEMOD             0x13 // DVB COFDM Demodulator
#define MSTAR_MSB123X_DEMOD             0x14 // DVB COFDM Demodulator

#define MONTAGE_M88DC2800_DEMOD         0x15 // DVB-C COFDM Demodulator
#define EMBEDDED_DVBC_DEMOD             0x16 // Internal DVB-C Demodulator
#define MSTAR_MSB1233C_DEMOD            0x17

//ISDB Demodulator
#define DIB_DiB8006GP_DEMOD             0x20 // DIB ISDB-T Demodulator
#define EMBEDDED_ATSC_DEMOD             0x21 // Internal ATSC Demodulator
#define TOSHIBA_TC90512XBG_DEMOD        0x22 // TOSHIBA ISDB-T Demodulator
#define TOSHIBA_TC90517FG_DEMOD         0x23 // TOSHIBA ISDB-T Demodulator
#define TOSHIBA_TC90527FG_DEMOD         0x24 // TOSHIBA ISDB-T Demodulator
#define MSTAR_MSB1400_DEMOD             0x25 // MSTAR ISDBT Demodulator
#define EMBEDDED_ISDBT_DEMOD            0x26 // Internal ISDB-T Demodulator

//DVB-T demodulator
#define MONTAGE_M88DD2000_DEMOD         0x30 // DMB-T COFDM Demodulator
#define MTK_5131_DEMOD                  0x31 // MTK solution for Samsung DVBT project
#define EMBEDDED_DVBT_DEMOD             0x32 // Internal DVB-T Demodulator
#define MSTAR_MSB1228_DEMOD             0x33 // MSTAR DVB-T Demodulator

//DTMB demodulator
#define ALTOBEAM_883X                   0x40 // ALTOBEAM DTMB Demodulator
#define ALTOBEAM_884X			        0x41 // ALTOBEAM DTMB Demodulator
#define ALTOBEAM_885X                   0x42
#define LEGEND_8G42_DEMOD               0x43 // LEGEND DMB-T Demodulator
#define LEGEND_8G52_DEMOD               0x44 // LEGEND DMB-T Demodulator
#define LEGEND_8G80_DEMOD               0x45 // LEGEND DMB-T Demodulator
#define LEGEND_8G75_DEMOD               0x46 // LEGEND DVB-C+DTMB Demodulator
#define LEGEND_9000_DEMOD               0x47 // LEGEND DMB-T Demodulator

//ATSC demodulator
#define LG_3303_DEMODE                  0x50 // ATSC 8VSB & XQAM Demodulator
#define LG_3304_DEMODE                  0x51 // ATSC 8VSB & XQAM Demodulator
#define SAMSUNG_S5H1409_DEMODE          0x52 // ATSC 8VSB & XQAM Demodulator
#define SAMSUNG_S5H1410_DEMODE          0x53 // ATSC 8VSB & XQAM Demodulator
#define MSTAR_MSB1500_DEMODE            0x54 // ATSC 8VSB & XQAM Demodulator
#define MSTAR_MSB1501_DEMODE            0x55
#define PHILIPS_TUV1236D_DEMODE         0x56 // ATSC 8VSB & XQAM Demodulator
#define OLD_LG_3304_DEMODE              0x57 // ATSC 8VSB & XQAM Demodulator

#define MSTAR_NONE_DEMOD                0xFF // no Demodulator
...
#define NXP_TDA18273_TUNER              0x6A // NXP silicon tuner
#define NXP_TDA18272_TUNER              0x6B
#define NXP_TDA18274_TUNER              0x6C // NXP silicon tuner
...
#define TCL_DA91WT_13_E_TUNER           0x86 // TCL ATSC Sawless Tuner
#define TCL_DT91WT_2_E_TUNER            0x87 // TCL DVB-T Sawless Tuner
...
#define XC7000_TUNER                    0xD7

#define DMCT_6A_111_TUNER               0xDA

#define SONY_SUT_RE217_TUNER            0xDB // SONY silicon tuner
#define SILICON_MT2063_TUNER            0xDC // Silicon tuner
#define NUTUNE_FI4801_TUNER             0xDD // Silicon tuner
#define NUTUNE_FK1602_TUNER             0xDE // Silicon tuner
#define MxL_301RF_TUNER                 0xDF
#define RAFAEL_R828_TUNER               0xE0
#define MxL_601SI_TUNER                 0xE1
#define SILAB_2158_TUNER                0xE2
#define SILICON_R620D_TUNER             0xE3 // Silicon tuner
#define FRESCO_FM2150A_TUNER            0xE4 // FRESCO silicon tuner
...
#define IR_TYPE_XIAOMI_NEC              0x48 // like NEC
...
#define IR_TYPE_TCL_PIONEER             0x7B
#define IR_TYPE_HAIER_TOSHIBA           0x80
#define IR_TYPE_SKY_TOSHIBA             0x86
#define IR_TYPE_CHANGHONG_RP57C         0x8A
#define IR_TYPE_XOCO_MITSUBISHI         0x8B

#define IR_TYPE_PANASONIC_REMOTE        0x90
#define IR_TYPE_MITSUBISHI_REMOTE_HP    0x91    // with Head pulse
#define IR_TYPE_MITSUBISHI_REMOTE       0x92    // without Header
#define IR_TYPE_SAMSUNG_REMOTE          0x93
#define IR_TYPE_SONY_REMOTE             0x94
#define IR_TYPE_SAMPO_REMOTE            0x95
