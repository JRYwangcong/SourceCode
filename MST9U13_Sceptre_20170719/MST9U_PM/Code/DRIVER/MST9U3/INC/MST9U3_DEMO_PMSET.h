...
#endif
#define PM_CLOCK                                      ((sPMInfo.ucPMMode==ePM_POWER_DCOFF)? RCOSC: XTAL)   //modified clock rate on PM mode - A059
...
#define PM_SUPPORT_DVI5V_TurnonRterm        0//(MS_BOARD_TYPE_SEL != BD_MST9UHL_V4)

#define PM_SUPPORT_WAKEUP_CEC			(0)

#if (FPGA_HW_PMMODE||AIO_Board_PM)
#define PM_POWERkEY_GETVALUE                (0)
#else
#define PM_POWERkEY_GETVALUE                (1)
#endif
#define PM_SARKEY_GETVALUE              (0)
...
#define ENABLE_SYNC_CHECK_AGAIN          (1)
#define ENABLE_SW_SARSINGLEMODE          (0)
...
#define PM_POWERSAVING_SARmode                  ePMSAR_ALIVE
...
#define EN_SYNC_DET_SET       EN_CSYNC_DET|EN_HVSYNC_DET
...
#define REG_DVIRAW_3    REG_000395
...
#define REG_DVI_DET         REG_00039F
#define EN_DVI_LOST_0      _BIT4
#define EN_DVI_LOST_1      _BIT5
#define EN_DVI_LOST_2      _BIT6
#define EN_DVI_LOST_3      _BIT7

#define EN_DVI_DET_0       _BIT0
#define EN_DVI_DET_1       _BIT1
#define EN_DVI_DET_2       _BIT2
#define EN_DVI_DET_3       _BIT3

#define EN_DVI_DET_SET      (EN_DVI_DET_0|EN_DVI_DET_1|EN_DVI_DET_2|EN_DVI_DET_3)
#define EN_DVI_DET_MASK     0xFF
//---------------------------------------
...
#if (MS_BOARD_TYPE_SEL == BD_MST203A_A01B_S||MS_BOARD_TYPE_SEL == BD_MST9UHL_V3||MS_BOARD_TYPE_SEL == BD_MST9UHD_BV1||MS_BOARD_TYPE_SEL==BD_MST9UHD_DV1||MS_BOARD_TYPE_SEL==BD_MST9UHD_GV1)
#define REG_DVI5V_DETECT     REG_001728
#define DVI5V_DETECT_0               BIT0
#define DVI5V_DETECT_1               BIT1
#define DVI5V_DETECT_2               BIT2
#define DVI5V_DETECT_3               BIT3
#else
#define REG_DVI5V_DETECT     REG_001728
#define DVI5V_DETECT_0               BIT0|BIT4
#define DVI5V_DETECT_1               BIT1|BIT5
#define DVI5V_DETECT_2               BIT2
#define DVI5V_DETECT_3               BIT3
#endif
...
#if ENABLE_DAISY_CHAIN
#define PM_GPIO_DET_DC      EN_GPIO47_DET
