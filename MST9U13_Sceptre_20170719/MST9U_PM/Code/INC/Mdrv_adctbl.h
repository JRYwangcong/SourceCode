...
// INIT
//****************************************************
code BYTE MST_ADCINIT_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_INIT_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
 ...
 { DRV_ADC_REG(REG_ADC_DTOP_65_L), 0xFF, 0x00, 0x33/*$All*/, },
 { DRV_ADC_REG(REG_ADC_DTOP_65_H), 0x0F, 0x00, 0x03/*All*/, },
...
// FreeRunEn
//****************************************************
code BYTE MST_ADCFreeRunEn_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_FreeRunEn_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
...
// FreeRunDis
//****************************************************
code BYTE MST_ADCFreeRunDis_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_FreeRunDis_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
...
// PorstEn
//****************************************************
code BYTE MST_ADCPorstEn_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_PorstEn_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
...
// PorstDis
//****************************************************
code BYTE MST_ADCPorstDis_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_PorstDis_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
 { DRV_ADC_REG(REG_ADC_ATOP_0E_L), 0xFE, 0x00, 0x00/*All*/, },
...
// MUX
//****************************************************
code BYTE MST_ADCMUX_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_MUX_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
...
// SOURCE
//****************************************************
code BYTE MST_ADCSOURCE_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_SOURCE_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
...
// AdcCal
//****************************************************
code BYTE MST_ADCAdcCal_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_AdcCal_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
 { DRV_ADC_REG(REG_ADC_DTOP_65_L), 0xFF, 0x00, 0x33/*$SW_UG*/,
                                         0x00, 0x33/*$Fix_UG*/,
                                         0x00, 0x33/*$BG_Fix_UG*/, },
 { DRV_ADC_REG(REG_ADC_DTOP_65_H), 0x0F, 0x00, 0x03/*SW_UG*/,
                                         0x00, 0x03/*Fix_UG*/,
                                         0x00, 0x03/*BG_Fix_UG*/, },
 ...
 { DRV_ADC_REG(REG_ADC_DTOPB_06_L), 0x01, 0x00, 0x01/*SW_UG*/,
                                         0x00, 0x01/*Fix_UG*/,
                                         0x00, 0x01/*BG_Fix_UG*/, },
 { DRV_ADC_REG(REG_ADC_DTOPB_06_H), 0xFF, 0x00, 0xE3/*$SW_UG*/,
                                         0x00, 0xE3/*$Fix_UG*/,
                                         0x00, 0xE3/*$BG_Fix_UG*/, },
 ...
 { DRV_ADC_REG(REG_ADC_DTOPB_3F_L), 0xFF, 0x00, 0xBF/*$SW_UG*/,
                                         0x00, 0xBF/*$Fix_UG*/,
                                         0x00, 0xBF/*$BG_Fix_UG*/, },
 { DRV_ADC_REG(REG_ADC_DTOPB_3F_H), 0x8F, 0x00, 0x83/*$SW_UG*/,
                                         0x00, 0x83/*$Fix_UG*/,
                                         0x00, 0x83/*$BG_Fix_UG*/, },
 ...
 { DRV_ADC_REG(REG_ADC_DTOPB_40_H), 0x0F, 0x00, 0x08/*SW_UG*/,
                                         0x00, 0x08/*Fix_UG*/,
                                         0x00, 0x08/*BG_Fix_UG*/, },
 { DRV_ADC_REG(REG_ADC_DTOPB_41_L), 0x8F, 0x00, 0x83/*$SW_UG*/,
                                         0x00, 0x83/*$Fix_UG*/,
                                         0x00, 0x83/*$BG_Fix_UG*/, },
 ...
 { DRV_ADC_REG(REG_ADC_DTOPB_1F_L), 0x1F, 0x00, 0x0F/*$SW_UG*/,
                                         0x00, 0x0F/*$Fix_UG*/,
                                         0x00, 0x0F/*$BG_Fix_UG*/, },
 { DRV_ADC_REG(REG_ADC_DTOPB_20_L), 0xFF, 0x00, 0xFF/*SW_UG*/,
                                         0x00, 0xFF/*Fix_UG*/,
                                         0x00, 0xFF/*BG_Fix_UG*/, },
 { DRV_ADC_REG(REG_ADC_DTOPB_20_H), 0x0F, 0x00, 0x0C/*SW_UG*/,
                                         0x00, 0x0C/*Fix_UG*/,
                                         0x00, 0x0C/*BG_Fix_UG*/, },
...
code BYTE MST_ADCSetModeYUV_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_SetMode_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
 ...
 { DRV_ADC_REG(REG_ADC_ATOP_09_H), 0x07, 0x00, 0x03/*ADC_TABLE_FREQ_SECTION1*/,
...
code BYTE MST_ADCSetModeRGB_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_SetMode_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
 { DRV_ADC_REG(REG_ADC_ATOP_34_L), 0x0F, 0x00, 0x00/*ADC_TABLE_FREQ_SECTION1*/,
                                         0x00, 0x00/*ADC_TABLE_FREQ_SECTION2*/,
                                         0x00, 0x01/*ADC_TABLE_FREQ_SECTION3*/,
...
code BYTE MST_ADCSetModeYUV_Y_TBL[][REG_ADC_ADDR_SIZE+REG_ADC_MASK_SIZE+ADC_TABLE_SetMode_NUMS*REG_ADC_DATA_SIZE]=
{                 // Reg           Mask Ignore Value
 { DRV_ADC_REG(REG_ADC_ATOP_34_H), 0x0F, 0x00, 0x00/*ADC_TABLE_FREQ_SECTION1*/,
                                         0x00, 0x00/*ADC_TABLE_FREQ_SECTION2*/,
                                         0x00, 0x01/*ADC_TABLE_FREQ_SECTION3*/,
