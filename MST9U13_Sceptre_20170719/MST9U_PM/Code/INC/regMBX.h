...
#define REG_MBX_BASE                (0x103380)
//#define MBX_REG8(gid, addr)         RIU8[((gid+REG_MBX_BASE)<<1) + ((addr) * 2) - ((addr) & 1)]

//Reg8 defines:
#define REG8_MBX_CTRL               0x0000
    #define MBX_CTRL_FIRE             BIT0
    #define MBX_CTRL_READBACK         BIT1
    #define MBX_CTRL_INSTANT          BIT2
...
#define REG8_MBX_STATE_1              0x000F
    #define MBX_STATE1_DISABLED          BIT4
    #define MBX_STATE1_OVERFLOW           BIT5
    #define MBX_STATE1_ERROR              BIT6
    #define MBX_STATE1_BUSY               BIT7

#if 1
#define REG_MBX_GROUP0      0x00
#define REG_MBX_GROUP1      0x10
#define REG_MBX_GROUP2      0x20
#define REG_MBX_GROUP3      0x30
#define REG_MBX_GROUP4      0x40
#define REG_MBX_GROUP5      0x50
#else
#define REG_MBX_GROUP0      0x00
...
#if ENABLE_MBX
BYTE MBX_ReadByte( DWORD u32Reg )
{
    DWORD ucdata = 0;
    u32Reg += REG_MBX_BASE;
...
void MBX_WriteByte( DWORD u32Reg, BYTE u8Val )
{
    u32Reg += REG_MBX_BASE;
    P2 = (u32Reg & 0x00FF0000)>>16; // Bank switch for 51 (P2 need bk in ISR)
    if( u32Reg & 0x80000000 ) // Sub bank
