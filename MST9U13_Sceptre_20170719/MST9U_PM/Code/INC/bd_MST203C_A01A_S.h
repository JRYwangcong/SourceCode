...
#define HDMI2ND_PORT_PRIORITY   5 //Input_Digital4
...
#endif
#if DP_Port_D4
#define hwSDMDP4Pin_Pin             0//(_bit6_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))//GPIO_06, HW rework//  (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO_X0_IN)))      //GPIOX00
...
#define hwDVI3Cable_Pin             0//hwSDMDP3Pin_Pin
