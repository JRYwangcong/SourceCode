...
#if 0
//#define REG_INT_BASE                     (0x2B00)
#define REG_INT_BASE                     (0x2B00)
#define INT_REG(address)                 RIU[address*2+REG_INT_BASE]

#define REG_INT_FIQMASK_L                   0x0000
    #define INT_FIQMASK_AEON2PM             BIT(3)
    #define INT_FIQMASK_PM2AEON             BIT(4)
    #define INT_FIQMASK_PM2MIPS              BIT(5)
    #define INT_FIQMASK_MIPS2PM              BIT(6)
    #define INT_FIQMASK_MIPS2AEON          BIT(7)
    #define INT_FIQMASK_AEON2MIPS          BIT(8)
...
#define REG_INT_FIQCLEAR_L                   0x0004
    #define INT_FIQCLEAR_AEON2PM             BIT(3)
    #define INT_FIQCLEAR_PM2AEON             BIT(4)
    #define INT_FIQCLEAR_PM2MIPS              BIT(5)
    #define INT_FIQCLEAR_MIPS2PM              BIT(6)
    #define INT_FIQCLEAR_MIPS2AEON          BIT(7)
    #define INT_FIQCLEAR_AEON2MIPS          BIT(8)
...
#define REG_INT_FIQFINALSTATUS_L        0x0008
    #define INT_FIQFINALSTATUS_AEON2PM  BIT(3)
    #define INT_FIQFINALSTATUS_PM2AEON  BIT(4)
    #define INT_FIQFINALSTATUS_PM2MIPS  BIT(5)
    #define INT_FIQFINALSTATUS_MIPS2PM  BIT(6)
    #define INT_FIQFINALSTATUS_MIPS2AEON    BIT(7)
    #define INT_FIQFINALSTATUS_AEON2MIPS    BIT(8)
#define REG_INT_FIQFINALSTATUS_H        0x0009
#endif

#if 1
#define CPU_INT_REG(address)            RIU8[address]
#define REG_INT_PMFIRE                  0x100540
#define INT_PM_AEON                     BIT0

#define REG_INT_AEONFIRE                0x100544
