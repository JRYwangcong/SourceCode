...
#define CABLE_DET_DVI3_SAR_EN              1
...
#elif (defined(LianHeChuangXin_Project)||defined(Sceptre_Project))
#define ADCKEY_A0_VALUE     0x00
...
#elif 0//(defined(FengYuan_Project))
/*
//ZhouYang_Project
...
//KeyPad Set
#elif (defined(LianHeChuangXin_Project)||defined(Sceptre_Project))
  #if 1//(MS_BOARD_TYPE_SEL == BD_MST9UHD_CV1)
...
//POWER_KEY
#if ((defined(DaYu_Project))||((defined(LianHeChuangXin_Project))||(defined(Sceptre_Project))))
