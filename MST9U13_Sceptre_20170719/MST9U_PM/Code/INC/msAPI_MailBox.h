...
typedef enum
{
    MB_SAR_CMD_READ_DRAM,
} MB_SAR_CMD_INDEX;

//=============================================================================
INTERFACE MBX_Result MApi_MBX_SetInformation(BYTE *pU8Info, BYTE u8Size);
INTERFACE MBX_Result MApi_MBX_GetInformation(BYTE *pU8Info, BYTE u8Size);

INTERFACE MBX_Result MApi_MBX_Init(void);
INTERFACE MBX_Result MApi_MBX_DeInit(void);
INTERFACE MBX_Result MApi_MBX_Enable(Bool bEnable);

INTERFACE MBX_Result MApi_MBX_RegisterMSG(MBX_Class eMsgClass, WORD u16MsgQueueSize);
INTERFACE MBX_Result MApi_MBX_RegisterMSGWithCallBack(MBX_Class eMsgClass, WORD u16MsgQueueSize, MBX_MAIL_ARRIVE_NOTIFY_FUNC notifier);
...
INTERFACE MBX_Result MApi_MBX_RecvMsg(MBX_Class eTargetClass, MBX_Msg *pMsg, WORD u32WaitMillSecs, WORD u32Flag);
INTERFACE MBX_Result MApi_MBX_ClearMSG(MBX_Class eMsgClass);
INTERFACE void Mailbox_dummy(void);
#endif  //ENABLE_MBX
#undef INTERFACE
