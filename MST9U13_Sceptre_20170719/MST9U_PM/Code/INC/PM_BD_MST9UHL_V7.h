...
#if (defined(LeXingEnMa_Project)||defined(ZhouYang_Project)||defined(MingCai_Project)||defined(KunDe_Project)||JieBo_IR_Function_Enable||defined(TaiBei_Project)||defined(HuaKe_Project)||defined(FengYuan_Project)||defined(ZhongChuangLianHe_Project)||LHCX_IR_Function_Enable)
