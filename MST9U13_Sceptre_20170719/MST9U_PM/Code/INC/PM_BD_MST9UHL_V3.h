...
#if TMDS_Port_D0
#define hwDVI0Cable_Pin                   (KEYPAD_SAR08)
#define Init_hwDVI0Cable_Pin()           (MEM_MSWRITE_BIT(REG_003A69,1,BIT0))// Enable SAR ch
#define CABLE_DET_DVI0_SAR              SAR8_EN

#define CABLE_DET_DVI0_SAR_EN              1
#else
