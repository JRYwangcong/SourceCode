...
// interrupt
#define INT_FIQ_TIMER0_ENABLE(Enable)    (msWriteByteMask( REG_002B08, (Enable)?(0):(BIT0), BIT0 ))
#define INT_IRQ_TIMER0_ENABLE(Enable)    (msWriteByteMask( REG_002B28, (Enable)?(0):(BIT1), BIT1 ))
#define INT_FIQ_WDT_ENABLE(Enable)    (msWriteByteMask( REG_2B00, ((Enable)?(0):(BIT1)), BIT1 ))
#define INT_IRQ_DISP_ENABLE(Enable)    Enable=0//(msWriteByteMask( REG_2B18, ((Enable)?(0):(BIT1)), BIT1 ))
#define INT_STATUS_DISP_ISR()               (_bit1_(msRegs[REG_2B28])) // V
#define INT_IRQ_DVI_ENABLE(Enable)    Enable=0//(msWriteByteMask( REG_2B19, ((Enable)?(0):(BIT7)), BIT7 ))
...
#define INT_CLEAR_STATUS_IR_ISR()       (MEM_MSWRITE_BYTE(REG_002B18, MEM_MSREAD_BYTE_EXT1(REG_002B18)))
...
#define WDT_DISABLE()       (msWrite4Byte( REG_002C08, 0x0 ))
...
#define HDCP_CPU_WR_BUSY()    (_bit4_(msReadByte(REG_152E)))
...
#define NEW_SOG_WAKEUP_FLUSH_ISR(ISR_SRC)   {MEM_MSWRITE_BYTE_MASK_ISR(ISR_SRC, REG_0025F4, BIT3, BIT3); MEM_MSWRITE_BYTE_MASK_ISR(ISR_SRC, REG_0025F4, 0, BIT3);}
#endif
//============================================================
// Keypad sar status
//============================================================
