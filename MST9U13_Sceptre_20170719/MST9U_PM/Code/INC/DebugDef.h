...
#define UART1_CMD_LENGTH         (SIORxBuffer1[0] >> 5)
#define UART1_CMD                (SIORxBuffer1[0] & 0x1F)
#define UART1_CMD_MS_REG         (SIORxBuffer1[1])
#define UART1_CMD_MS_DAT         (SIORxBuffer1[2])

#define UART1_CMD_MS_BANK        (SIORxBuffer1[1])
#define UART1_CMD_MS_REGINDEX    (SIORxBuffer1[2])
#define UART1_CMD_MS_REGDATA     (SIORxBuffer1[3])

#define UART1_CMD_MCU_IDX_H      (SIORxBuffer1[1])
#define UART1_CMD_MCU_IDX_L      (SIORxBuffer1[2])
#define UART1_CMD_MCU_DATA       (SIORxBuffer1[3])

#define DebugCommand_UART1            (SIORxBuffer1[0]&0x3F)
#define CommandLength_UART1           ((SIORxBuffer1[0]>>6) + 1)
#define DebugAddress_UART1            SIORxBuffer1[1]
#define DebugData_UART1               SIORxBuffer1[2]
#define DebugDeviceAddr_UART1         SIORxBuffer1[3]
#define DebugAddressBank_UART1        SIORxBuffer1[3]
