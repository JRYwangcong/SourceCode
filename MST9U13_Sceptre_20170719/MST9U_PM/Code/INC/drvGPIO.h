...
INTERFACE void msAPIPWMConfig(DWORD u32PWMCh, WORD u16Freq, WORD u16Duty, BYTE u8Config, BYTE u8Counter);
INTERFACE void msDrvPWMEnableSwitch(DWORD u32PWMCh, Bool bEnable);
INTERFACE void drvGPIO_dummy(void);
#if 0//(ODM_NAME==ODM_BENQ)
