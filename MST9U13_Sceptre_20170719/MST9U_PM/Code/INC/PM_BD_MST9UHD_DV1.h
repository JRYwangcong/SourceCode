...
#define PORT_FLOW_5     MUX_RESERVED
//#define PORT_FLOW_6
//#define PORT_FLOW_7
...
#define PORT_TYPE_5     TYPE_RESERVED
*/
#define PORT_FLOW_0     MUX_ADC
...
#define TMDS_Port_D0   			1 //DP
#define TMDS_Port_D1      		       1 //DP
#define TMDS_Port_D2       		1 //HDMI
#define TMDS_Port_D3       		0 //HDMI
#define TMDS_Port_D4       		0 //DVI dual
...
#define Init_hwBlacklit_Pin()   {MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, 0, BIT2);(MEM_MSWRITE_BIT(_REG_GPIO4_OUT, 1, BIT2));}
...
#else
#define hwDSUBCable_Pin                 (_bit7_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))  //GPIO03
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BYTE_MASK(_REG_GPIO5_OEZ, BIT7, BIT7))
#define CABLE_DET_VGA_SAR               0
#endif

#if TMDS_Port_D0
#define hwDVI0Cable_Pin                   (!_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X3_IN)))
#define Init_hwDVI0Cable_Pin()           (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X3_OEZ,BIT1,BIT1))// Enable SAR ch
#define CABLE_DET_DVI0_SAR              0//SAR8_EN

#define CABLE_DET_DVI0_SAR_EN            0//  1
#else
...
#define CABLE_DET_DVI0_SAR_EN              CABLE_DET_DVI0_SAR
#endif

#if TMDS_Port_D1
#define hwDVI1Cable_Pin                 (!_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X4_IN)))
#define Init_hwDVI1Cable_Pin()         (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X4_OEZ,BIT1,BIT1))
#define CABLE_DET_DVI1_SAR              0

#define CABLE_DET_DVI1_SAR_EN              0
#else
#define hwDVI1Cable_Pin                 0
#define Init_hwDVI1Cable_Pin()         // (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X1_OEZ,BIT0,BIT0))
#define CABLE_DET_DVI1_SAR              0
#define CABLE_DET_DVI1_SAR_EN              CABLE_DET_DVI1_SAR
#endif

#if TMDS_Port_D2//SAR9
#define hwDVI2Cable_Pin                 (!_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X1_IN)))
#define Init_hwDVI2Cable_Pin()          (MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X1_OEZ,BIT1,BIT1))
#define CABLE_DET_DVI2_SAR              0//SAR10_EN

#define CABLE_DET_DVI2_SAR_EN              0
...
#define CABLE_DET_DVI2_SAR_EN              CABLE_DET_DVI2_SAR
#endif
...
#define CABLE_DET_DVI3_SAR_EN            0//  1
...
#define CABLE_DET_DVI3_SAR_EN              CABLE_DET_DVI3_SAR
...
#define ADCKEY_A0       KEY_MINUS//KEY_MENU
...
#define ADCKEY_B2       KEY_MENU//KEY_NOTHING
...
//POWER_KEY
#if (defined(DaYu_Project)||(defined(LianHeChuangXin_Project)))
#define HW_POWER_KEY        1//(_bit4_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
#else
#define HW_POWER_KEY        (_bit4_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))//(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 1, BIT4))
#endif
...
#if (defined(LeXingEnMa_Project)||defined(MingCai_Project)||defined(ZhouYang_Project)||defined(KunDe_Project)||JieBo_IR_Function_Enable||defined(TaiBei_Project)||defined(HuaKe_Project)||defined(FengYuan_Project)||defined(ZhongChuangLianHe_Project)||(defined(XuLi_Project))||LHCX_IR_Function_Enable)
