...
#if TMDS_Port_D1
#define hwDVI1Cable_Pin                 0//(!_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X4_IN)))//(KEYPAD_SAR05)
#define Init_hwDVI1Cable_Pin()         //(MEM_MSWRITE_BYTE_MASK(_REG_GPIO_X4_OEZ,BIT1,BIT1)) //(MEM_MSWRITE_BIT(REG_3A68,1,BIT5)) // Enable SAR ch
...
#define Init_hwDVI2Cable_Pin()          (MEM_MSWRITE_BIT(REG_003A69,1,BIT2))
#define CABLE_DET_DVI2_SAR              SAR10_EN

#define CABLE_DET_DVI2_SAR_EN              1
