...
#define BOARD_NAME                  "BD_MSTxxxA_DxxA_S"

#define PIN_FLASH_WP0               PIN_62
...
#define I2S_IN_MODE1                1
#define I2S_OUT_MODE1               1
#define I2S_OUT_MODE2               2
#define DDCR_PATH(X)                X // 1 ~ 4
#define IIC_PATH(X)                 X // 1 ~ 4
#define TS_IN_P_MODE(X)             X // 1 ~ 3
#define TS_IN_S_MODE(X)             X // 1 ~ 8

//define the following values from 1
#define PADS_CEC_CONFIG             PAD_CEC //Unknown_pad_mux
#define PADS_TCON_CONFIG            0x0007FF //TCON0~TCON10
...
#define PADS_SPDIF_IN               PAD_GPIO6
#define PADS_SPDIF_OUT              PAD_GPIO5
...
#define PADS_TS_IN_P_CFG            TS_IN_P_MODE(3)
#define PADS_TS_IN_S_CFG            Unknown_pad_mux

//------GPIO setting(default GPIO pin level)------------------------------------
#define PIN_58_IS_GPIO              GPIO_OUT_LOW  //GPIO55, MUTE_AMP
#define PIN_60_IS_GPIO              GPIO_OUT_HIGH //GPIO57, PWR-ON_OFF
#define PIN_59_IS_GPIO              GPIO_OUT_LOW  //GPIO56, VBL-CTRL
#define PIN_141_IS_GPIO             GPIO_IN       //GPIO73, USB0_OCD_N
#define PIN_65_IS_GPIO              GPIO_OUT_LOW  //GPIO62, PreAMP_EN
#define PIN_61_IS_GPIO              GPIO_OUT_LOW  //GPIO58, PANEL_ON/OFF
#define PIN_99_IS_GPIO              GPIO_OUT_LOW  //GPIO65, AUDIO_EN
#define PIN_62_IS_GPIO              GPIO_OUT_LOW  //GPIO59, SPI_WP
#define PIN_132_IS_GPIO             GPIO_IN       //GPIO64, Tuner_SCL, EEPROM_SCL
#define PIN_131_IS_GPIO             GPIO_IN       //GPIO63, Tuner_SDA, EEPROM_SDA

//------Chip Type---------------------------------------------------------------
#include "chip/MST6932XPT.h"
...
#define AUDIO_PATH_SPEAKER          AUDIO_PATH_0
...
#define AUDIO_PATH_SCART2           AUDIO_PATH_NULL  // for Line out

#define AUDIO_OUTPUT_MAIN_SPEAKER   AUDIO_AUOUT0_OUTPUT
#define AUDIO_OUTPUT_HP             AUDIO_NULL_OUTPUT
#define AUDIO_OUTPUT_LINEOUT        AUDIO_AUOUT1_OUTPUT
...
#define FRONTEND_DEMOD_TYPE             ALTOBEAM_884X  //EMBEDDED_ATSC_DEMOD//TOSHIBA_TC90512XBG_DEMOD
#define FRONTEND_TUNER_TYPE             XUGUANG_HFT_8B1_V116H_TUNER//XUGUANG_HFT_8B1_V116H_TUNER//SAMSUNG_S203FH201B_TUNER //SAMSUNG_S205_TUNER////SHARP_VA1G5BF2009_TUNERPHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
...
#define FRONTEND_DEMOD_TYPE             ALTOBEAM_884X//MSTAR_MSB123X_DEMOD
#define FRONTEND_TUNER_TYPE             NUTUNE_FK1602_TUNER//TCL_F20WT_3DD_E//NXP_FH2608_TUNER
...
#define DEMO_TUNER_IIC_TYPE             DEMO_TO_TUNER
...
#if ENABLE_SSC
#define MIU_SSC_SPAN_DEFAULT            35
#define MIU_SSC_STEP_DEFAULT            20
#define MIU_SSC_SPAN_MAX                50
#define MIU_SSC_STEP_MAX                30
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_99 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_99 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_65 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_65 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_61 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_61 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_59 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_59 )
...
#define hw_SetFlashWP()         MDrv_WriteRegBit(0x000426, 0, BIT0); MDrv_WriteRegBit(0x000428, 0, BIT0);
#define hw_ClrFlashWP()         MDrv_WriteRegBit(0x000426, 1, BIT0); MDrv_WriteRegBit(0x000428, 0, BIT0);
#define hw_SetUSB5V()           MDrv_WriteRegBit(0x000454/*_REG_GPIOSAR_OUT*/, 1, BIT7); MDrv_WriteRegBit(0x000455/*_REG_GPIOSAR_OEZ*/, 0, BIT3);// SAR3 for USB 5V
