...
$2 == "ENABLE_MSTAR_AMBER3" { if($3==1) system("cd ../u-boot-2011.06/;make amber3_config;make -s")}
$2 == "ENABLE_MSTAR_AGATE" { if($3==1) system("cd ../u-boot-2011.06/;make agate_config;make -s")}
$2 == "ENABLE_MSTAR_AMBER5" { if($3==1) system("cd ../u-boot-1.1.6/;make amber5_config;make -s")}
...
$2 == "ENABLE_MSTAR_AMETHYST" { if($3==1) system("cd ../u-boot-1.1.6/;make amethyst_config;make -s")}  
...
$2 == "ENABLE_MSTAR_EAGLE" { if($3==1) system("cd ../u-boot-2011.06/;make eagle_config;make -s")}
