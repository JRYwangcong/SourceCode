...
#endif
#define USBDELAY(x)	      MDrv_SysDelayUs(x*1000)
#else
...
#ifndef VA2PA
  #if defined(CHIP_T8) || defined(CHIP_J2) || defined(CPU_TYPE_ARM)
...
//========================================================================================================
 ...
 extern BOOLEAN USB_Hub_Handle(U8 port, U32 *devspeed);
...
extern void flib_Host20_Allocate_QHD(qHD_Structure  *psQHTemp,UINT8 bNextType,UINT8 bAddress,UINT8 bHead,UINT8 bEndPt, UINT32 wMaxPacketSize);
  ...
  extern U8  flib_Host20_Issue_mouse_Interrupt(U32 buf,U32 hwSize);
  extern void flib_Host20_Send_qTD_Int_Pipe(qTD_Structure  *spHeadqTD ,qHD_Structure  *spTempqHD,U16 wTimeOutSec);
...
//   extern UINT8             Host20_iTD_Manage[Host20_iTD_MAX];  //1=>Free 2=>used
   ...
   extern  Host20_Attach_Device_Structure xdata *sHubDevice;
   extern volatile UINT32 wOTG_Timer_Counter;
