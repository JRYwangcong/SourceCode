...
#define MSIF_SPIF_BUILDNUM                      {'0','7'}            //Build Number
#define MSIF_SPIF_CHANGELIST                    {'0','0','6','5','0','4','8','0'} //P4 ChangeList Number
...
MS_BOOL MDrv_FLASH_ReadUserStatusReg(MS_U16 u16DeviceID,MS_U8 u8MID,MS_U8 u8cmd,MS_U8 *pu8UserStatus, MS_U32 u32IDSize);
