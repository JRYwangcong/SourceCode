...
BOOLEAN msAPI_FSEnv_Init(U32 u32FS_adr,U32 u32FS_len)
{
    ...
    {
        FS_FILE_HANDLE_NUM = 5;        //for read / write
    }
    ...
    N51FS_TEMP_4K_FIXUP = (N51FS_INDEX_BUFFER_ADDR + N51FS_INDEX_BUFFER_LEN);
...
FS_EnvironmentStruct* msAPI_FSEnv_GetEnvironment(U8 environmentId)
{
    ...
    {
        __ASSERT(0);
        return (FS_EnvironmentStruct*)NULL;
    }
...
FS_TIME msAPI_FS_GetLocalTime(void)
{
    ...
    u32LocalTime = MDrv_GetSystemTime();
