...
#if 1
struct LUN_Device  Mass_stor_device[5]; //support 4 LUN
#else
...
extern UINT8  *pUsbData;//extern UINT8  pUsbData[256];
Scsi_Cmnd  srb_data;
...
struct stForceModeSense1A gForceModeSense1A[] =
{
        ...
        {0x0DD8, 0x1F08},           //alan.yu add on 2011.10.17 (朗科Netac)
        {0, 0}
};
...
BOOLEAN bSCSI_Initial(void)
{
 ...
 DRV_SCSI_DBG(printf("ValidLunNum:%x\r\n",ValidLunNum));
