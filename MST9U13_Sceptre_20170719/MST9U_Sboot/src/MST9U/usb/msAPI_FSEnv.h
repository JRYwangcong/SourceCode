...
#define FILE_ENVIRONMENT_MEMORY_SIZE 0x6000UL
#define FILE_HANDLE_MEMORY_SIZE 0x2000UL
#define FILE_INODE_MEMORY_SIZE 0x2000UL
...
#define NONCACHE_MASK  0xA0000000   //MIPS_NONCACHE_MASK
#elif defined(ARM_CHAKRA)
#define NONCACHE_MASK  0x20000000   //MIPS_NONCACHE_MASK
#else
#define NONCACHE_MASK  0x80000000   //AEON_NONCACHE_MASK
#endif
...
//+++++++++++++++++++++++++++++++++++++++++++++
// leo.chou 20130904, temporary added here, will move to mmap (project/mmap/MMAP_MST9U_512_AEON.h)
extern unsigned char _file_system_pool_buffer[];
/* FILE_SYSTEM_POOL   */
//co_buffer L0

#define FILE_SYSTEM_POOL_AVAILABLE                             ((DWORD)_file_system_pool_buffer)
#define FILE_SYSTEM_POOL_ADR                                   ((DWORD)_file_system_pool_buffer)  //Alignment 0x01000
...
#define DRIVE_MEMORY_LEN                0x800UL   // 2K  0x800>16 * 13 ( sizeof(MSDCtrl_Drive))
