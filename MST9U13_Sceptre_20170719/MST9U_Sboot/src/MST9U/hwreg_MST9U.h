...
#ifndef _HWREG_MST9U_H
#define _HWREG_MST9U_H
#include "c_riubase.h"
...
#define DDR2_TYPE_ESMT              0
#define DDR2_TYPE_WINBOND           1
#define DDR2_TYPE_ETRON             2

#define DDR_SSC_DEVIATION           0 //unit: 0.1%, Need Sync with AP:ENABLE_DDR_SSC/DDR_SSC_PERCENTAGE_DEF
                                      //DDR_SSC_DEVIATION = ENABLE_DDR_SSC?DDR_SSC_PERCENTAGE_DEF:0

#define ENABLE_PRINT_MSG            1
#define ENABLE_DRAM_SELFREFRESH     0
#define ENABLE_USB_HOST_DUAL_IMAGE  (ENABLE_USB && 0) //need sync with AP code

#define IS_WAKEUP_FROM_PM           (MDrv_ReadByte(0x3AA)&BIT2)
#define SET_SELFREFRESH_BOOT()      MDrv_WriteByteMask(0x3AA,BIT3,BIT3|BIT2)

#define UART0_BAUDRATE              115200
#define UART0_BAUDRATE_FPGA         38400
#define DEFAULT_UART_DEV            UART_ENGINE_R2_HK
#define DEFAULT_UART_PORT           UART_GPIO40_41
...
#if FPGA_VERIFY
#define R2_CLK       (60000000)
#elif ENABLE_CPU_345MHZ
#define R2_CLK       (345000000)
#define R2_CLK_SET   (0x0<<2)
#elif ENABLE_CPU_320MHZ
#define R2_CLK       (320000000)
#define R2_CLK_SET   (0x1<<2)
#elif ENABLE_CPU_288MHZ
#define R2_CLK       (288000000)
#define R2_CLK_SET   (0x2<<2)
#elif ENABLE_CPU_240MHZ
#define R2_CLK       (240000000)
#define R2_CLK_SET   (0x3<<2)
#elif ENABLE_CPU_216MHZ
#define R2_CLK       (216000000)
#define R2_CLK_SET   (0x4<<2)
#elif ENABLE_CPU_192MHZ
#define R2_CLK       (192000000)
#define R2_CLK_SET   (0x5<<2)
#elif ENABLE_CPU_144MHZ
#define R2_CLK       (144000000)
#define R2_CLK_SET   (0x6<<2)
#elif ENABLE_CPU_108MHZ
#define R2_CLK       (108000000)
#define R2_CLK_SET   (0x7<<2)
#endif
