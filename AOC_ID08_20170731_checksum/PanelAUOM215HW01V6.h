...
#if PanelType==PanelAUOM215HW01V6
    #define PanelName               _M,_2,_1,_5,_H,_W,_0,_1,_SPACE,_V,_6
#elif PanelType==PanelAUOM215HW01VB
    #define PanelName               _M,_2,_1,_5,_H,_W,_0,_1,_SPACE,_V,_B
#endif
	
    #define PanelDither   6 // 8  for ficker
    #define PanelTTL    0
    #define PanelTCON   0
    ...
    #define PanelOnTiming2    550//300 //30 // time between data & back light while turn on power  //20050701
#else
    #define PanelOnTiming2    300//300 //30 // time between data & back light while turn on power  //20050701
#endif
    ...
    #define PanelHSyncWidth   24//22//24
