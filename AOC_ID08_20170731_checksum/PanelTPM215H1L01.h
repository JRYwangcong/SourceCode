#ifndef __PANEL_TPM215H1L01__
    #define __PANEL_TPM215H1L01__
    #define PanelNumber             1800
    #define PanelName               _T,_P,_M,_2,_1,_5,_H,_1,_L,_0,_1
    ...
    #define PanelOnTiming1    15 // 0//40 // time between panel & data while turn on power
    #define PanelOnTiming2    500//300 //30 // time between data & back light while turn on power  //20050701
    ...
    #define PanelHSyncWidth   15//22//24
    ...
    #define PanelHTotal   2200//2120
    #define PanelVTotal   1125//1120
    #define PanelMaxHTotal     2300//4094
    #define PanelMinHTotal     2100//2068
    #define PanelMaxVTotal     1136//2047
    #define PanelMinVTotal    1115//1088
    #define PanelDCLK            150
    #define PanelMaxDCLK          196//180
    #define PanelMinDCLK          117//80
