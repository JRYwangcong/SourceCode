...
#define hwPanel_Pin			P1_0//P0_4 // 080530
...
#define ReduceDDC
#ifdef ReduceDDC
#define OnlyVGAEDIDInFlash
#define hwSystemVcc_Pin		P0_4
#endif
...
#define hw_SetGreenLed()	hwGreenLed_Pin=1;hwBlueLed_Pin=1
#define hw_ClrGreenLed()	hwGreenLed_Pin=0;hwBlueLed_Pin=0
...
#else
//#define G6CTRL		0x46
#define hw_SetPanel() { mStar_WriteByte(0x00, 0x02);\
                                       mStar_WriteByte(0x46, 0x01);\
                                       mStar_WriteByte(0x00, 0x00);}

#define hw_ClrPanel() {mStar_WriteByte(0x00, 0x02);\
                                      mStar_WriteByte(0x46, 0x00); \
                                      mStar_WriteByte(0x00, 0x00);}
#endif
