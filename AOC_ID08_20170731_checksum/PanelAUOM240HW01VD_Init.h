#define PanelName					_M,_2,_4,_0,_H,_W,_0,_1,_V,_D
...
#define _PanelOffTiming2				65 // time between data & panel while turn off power
#define TurnOffDataAfterTurnOffVCC		130//47 20121204 update// time between PanelOffTiming2&VDD falls to 10%
