...
//#define hwDDC_WP_Pin	P2_2//P4_6//
#define hwEEPROM_WP		P2_3// P4_7////2006-06-01 Andy 
...
//Audio
#if (ModelName==AOC_919Vwa_Asia||ModelName==AOC_919Vwa_Europe)//Use  Q1 Power Board
...
#if ENABLE_HDCP
    #define hwHDCP_Hpd_Pin        P1_3//P1_5
