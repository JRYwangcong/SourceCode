...
#if PSAmberLEDFlashingType == Type_Breathing		//110623 Modify
#define PowerSavingLEDPWM   PWM1C
#endif

//================================================
// Detect Cable
#define hwDVICable_Pin		P1_7  //xxx
...
#define hwPanel_Pin		   	P2_4  //ok

#define hwMute_Pin		  	P1_3  //ok
#define hwStandby_Pin		P1_3
