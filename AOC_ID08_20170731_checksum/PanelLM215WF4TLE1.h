#ifndef __PANEL_LM215WF4TLE1__
 #define __PANEL_LM215WF4TLE1__
    #define PanelNumber             1800
    #define PanelName               _L,_M,_2,_1,_5,_W,_F,_4,_T,_L,_E,_1//LM215WF4TLE1
    ...
    #define PanelOnTiming1    25//15 // 0//40 // time between panel & data while turn on power
    #define PanelOnTiming2    510//300 //30 // time between data & back light while turn on power  //20050701
    #define PanelOffTiming1   220 //300 // time between back light & data while turn off power
    #define PanelOffTiming2    25//16 // time between data & panel while turn off power
    #define PanelOffTiming0 0 // time between 12V - 3.3V
    #define PanelHSyncWidth   24//15//22//24
    #define PanelHSyncBackPorch  31//39
    #define PanelVSyncWidth			3
    #define PanelVSyncBackPorch   13//21 // 46
    #define PanelHStart   (PanelHSyncWidth+PanelHSyncBackPorch)
    #define PanelVStart   (PanelVSyncWidth+PanelVSyncBackPorch)
    #define PanelWidth    1920
    #define PanelHeight   1080
    #define PanelHTotal   2176//2200//2120
    #define PanelVTotal   1100//1125//1120
    #define PanelMaxHTotal     2320//4094
    #define PanelMinHTotal    2036// 2100//2068
    #define PanelMaxVTotal     1160//2047
    #define PanelMinVTotal    1090//1088
    #define PanelDCLK            144//149//150
    #define PanelMaxDCLK          175//196//180
    #define PanelMinDCLK          115//117//80
