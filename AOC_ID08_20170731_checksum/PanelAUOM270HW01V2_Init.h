#define PanelName					_M,_2,_7,_0,_H,_W,_0,_1,_V,_2
...
#define  TURNOFF_PANEL_BEFORE_DISABLE_LVDS_OUTPUT
...
#define _PanelOffTiming2				60 // time between data & panel while turn off power
#define TurnOffDataAfterTurnOffVCC		29
