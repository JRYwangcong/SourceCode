    ...
    #define hwDSUBCable_Pin		P1_5 //P69
    //================================================
    // Led
    ...
    #define hwPanel_Pin		P1_3//   P2_7
    #define hwPanel12V_Pin		P1_3   
    #define hwAudio_Pin		 P1_4 // P1_3   
    #define hwMute_Pin		       P1_4 //     P1_3
    #define hwStandby_Pin		P1_4 //  P1_4 
    //================================================
    // mStar I2C
    ...
    #define hwDDC_WP_Pin		P2_2 //2006-06-01 Andy P2_2    
    #define hwEEPROM_WP               P2_3 //2006-06-01 Andy 
