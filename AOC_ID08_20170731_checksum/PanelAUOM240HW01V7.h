#define PanelName	_M,_2,_4,_0,_H,_W,_0,_1,_V,_7 // auo
...
#define PanelOnTiming1		10// T2 <= 20ms // time between panel & data while turn on power
#define PanelOnTiming2		350// T3 >= 200ms // time between data & back light while turn on power
#define PanelOffTiming1		250// T4 >= 200ms // time between back light & data while turn off power 
#define PanelOffTiming2		16// T5 <= 50ms // time between data & panel while turn off power 
