...
//#define hwPanel_Pin			P2_5
#define hwPanel12V_Pin		P0_4  
#define hwAudio_Pin		 	P1_4    

//#define hwMute_Pin		       P1_7 //     P1_3
#define hwStandby_Pin		P1_7 //  P1_4 
...
//#define hwPanel_Pin        (P4 & BIT4)     // Annie 2006.8.21// Annie 2006.8.14  BIT5
//#define hw_SetPanel()     (P4 &= (~BIT4))  // Annie 2006.9.1 (P4 |= BIT4) // hwHDCP_Hpd_Pin=0  // 1 
//#define hw_ClrPanel()      (P4 |= BIT4) // Annie 2006.9.1 (P4 &= (~BIT4)) //  hwHDCP_Hpd_Pin=1  // 0 
