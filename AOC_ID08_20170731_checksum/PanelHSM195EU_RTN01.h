...
#define PanelOnTiming1		   		35//100  // 20  // time between panel & data while turn on power
#define PanelOnTiming2		  		350//400  //250 // 255 // time between data & back light while turn on power
#define PanelOffTiming1		  		100//300// 500 // time between back light & data while turn off power
...
#define PanelHTotal		2160//2112 
#define PanelVTotal		934 

#define PanelMaxHTotal		2300//2144 
#define PanelMinHTotal		1960//2080

#define PanelMaxVTotal		1564//942 
#define PanelMinVTotal		912//929 

#define PanelDCLK			121//118 
#define PanelMaxDCLK		153//151
#define PanelMinDCLK			90//97 
