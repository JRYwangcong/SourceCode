...
//================================================
// Detect Cable
#define hwDVICable_Pin	       P1_6  //xxx
...
// I2C
#define hwI2C_SCL_Pin		P1_6  //ok
#define hwI2C_SDA_Pin		P1_6  //ok
#define hwI2C_WP_Pin             P1_6

#define hwDDC_WP_Pin		     P2_2 //ok
...
#define hw_SetFlashWP()		 P2_4=0
#define hw_ClrFlashWP()		 P2_4=1
