...
#endif
#if ENABLE_HDCP
#define hwHDCP_Hpd_Pin        P4&BIT0////101227 Modify     // Annie 2006.8.21// Annie 2006.8.14  BIT5
#define hw_Set_HdcpHpd()     (P4 |= BIT0)  // Annie 2006.9.1 (P4 |= BIT4) // hwHDCP_Hpd_Pin=0  // 1
#define hw_Clr_HdcpHpd()     (P4 &= (~BIT0)) // Annie 2006.9.1 (P4 &= (~BIT4)) //  hwHDCP_Hpd_Pin=1  // 0
#endif

#ifdef ENABLE_NECSUPERRESOLUTION  // Rex 100714 code test
#define hw_NECReset_Pin     P0_4
#define hw_Set_NECReset()   hw_NECReset_Pin = 0
#define hw_Clr_NECReset()   hw_NECReset_Pin = 1

#define SCALAR_IO
#define hw_INTB_Pin     (Get_GPIO10(11))
#endif
