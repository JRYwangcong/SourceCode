...
#define PanelName	 _C,_L,_A,_A,_1,_5,_6,_W,_B,_1,_1,_A
...
#if (MainBoardType==MainBoard_715G2904_B)
#define PanelSwapPort   			0xFF
#else
#define PanelSwapPort   			0
#endif

#define _PanelOutputControl1	0x00//0x10 TIMODE
...
#define _PanelOnTiming2    		250//250 // 300//300 //30 // time between data & back light while turn on power  //20050701
#define _PanelOffTiming1 			250//250 // 300 // time between back light & data while turn off power
...
#define _PanelMaxHTotal 	1667 // 070410
#define _PanelMinHTotal     1512//1900//1960 // 070410 //1790 // 1820 // 1860// 1800 // 1880
#define _PanelMaxVTotal   	870
#define _PanelMinVTotal    	800 // 070410 // 1065 //
#define _PanelDCLK           	75  // 070410 modified
#define _PanelMaxDCLK          80 // 070410 modified
#define _PanelMinDCLK          72 // 070410 modified


#define _DefBurstModeFreq		200
