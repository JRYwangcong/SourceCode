#ifndef _PanelINNN173FGE_E23_DP_INIT_H_
#define _PanelINNN173FGE_E23_DP_INIT_H_

#define PanelTpye_1366
#define PanelName                   _L,_P,_1,_5,_6,_W,_H,_B
...
#define _PanelOnTiming2    		    350 // time between data & back light while turn on power  //20050701
#define _PanelOffTiming1 			350// time between back light & data while turn off power
...
#define _PanelHTotal   		        1580
#define _PanelVTotal   		        806 

#define _PanelMaxHTotal 	        1640    //we calculate MaxHotal by : (1366+B)*(768+A)*60 < 80MHz 
#define _PanelMinHTotal             1416

#define _PanelMaxVTotal   	        810    //768+A we set MaxVTotal to 810 refer to other 156 panel
#define _PanelMinVTotal    	        788

#define _PanelDCLK                  72
#define _PanelMaxDCLK               80
#define _PanelMinDCLK               67
